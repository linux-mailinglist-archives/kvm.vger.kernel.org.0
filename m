...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1718875A665
	for <lists+kvm@lfdr.de>; Thu, 20 Jul 2023 08:28:49 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230331AbjGTG2r (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Thu, 20 Jul 2023 02:28:47 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38452 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230232AbjGTG2f (ORCPT <rfc822;kvm@vger.kernel.org>);
        Thu, 20 Jul 2023 02:28:35 -0400
Received: from mail.loongson.cn (mail.loongson.cn [114.242.206.163])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id ADED92130;
        Wed, 19 Jul 2023 23:28:25 -0700 (PDT)
Received: from loongson.cn (unknown [10.2.5.185])
        by gateway (Coremail) with SMTP id _____8CxbesD1Lhkho0HAA--.16708S3;
        Thu, 20 Jul 2023 14:28:19 +0800 (CST)
Received: from localhost.localdomain (unknown [10.2.5.185])
        by localhost.localdomain (Coremail) with SMTP id AQAAf8CxvM7907hkHU81AA--.16059S16;
...
Subject: [PATCH v17 14/30] LoongArch: KVM: Implement vcpu load and vcpu put operations
Date:   Thu, 20 Jul 2023 14:27:57 +0800
Message-Id: <20230720062813.4126751-15-zhaotianrui@loongson.cn>
...
X-CM-TRANSID: AQAAf8CxvM7907hkHU81AA--.16059S16
...
index 49dc2ff24d7d..8ce84ae6b841 100644
--- a/arch/loongarch/kvm/vcpu.c
+++ b/arch/loongarch/kvm/vcpu.c
@@ -592,6 +592,202 @@ void kvm_arch_vcpu_destroy(struct kvm_vcpu *vcpu)
 	}
 }
