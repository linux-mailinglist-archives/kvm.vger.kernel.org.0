Return-Path: <kvm+bounces-5805-lists+kvm=lfdr.de@vger.kernel.org>
X-Original-To: lists+kvm@lfdr.de
Delivered-To: lists+kvm@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 509AB826EF6
	for <lists+kvm@lfdr.de>; Mon,  8 Jan 2024 13:51:55 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 67E851C22682
	for <lists+kvm@lfdr.de>; Mon,  8 Jan 2024 12:51:54 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 677EE46546;
	Mon,  8 Jan 2024 12:47:49 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="G3f2l6vU"
X-Original-To: kvm@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 9254945C00
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	...
	bh=oOFqlZVrLlGDG/YLQAqfrpoQqQ5hi/u6WSZ8KvNknAM=;
	b=G3f2l6vUTQb5Wuu0fva7MLbMMlwwFcvVmoCSzDXgmh5hht3MtGYGBAQPkdWAOi4oNuGBBC
	QZVFyH66GY6H6JXsBp0q6oGyLD62rxebmOEuTpBcVRzTqN/JnubiSTaAJZg+wwabKkW+6N
	jFKLZRKO3oiLdnGQflQLsNc9nFWs820=
Received: from mimecast-mx02.redhat.com (mx-ext.redhat.com [66.187.233.73])
 by relay.mimecast.com with ESMTP with STARTTLS (version=TLSv1.3,
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-65-cTMbl7JoOKmReeXZ535YlA-1; Mon,
 08 Jan 2024 07:47:42 -0500
X-MC-Unique: cTMbl7JoOKmReeXZ535YlA-1
Received: from smtp.corp.redhat.com (int-mx01.intmail.prod.int.rdu2.redhat.com [10.11.54.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 23FA33C2AF64;
	Mon,  8 Jan 2024 12:47:42 +0000 (UTC)
Received: from virtlab701.virt.lab.eng.bos.redhat.com (virtlab701.virt.lab.eng.bos.redhat.com [10.19.152.228])
	by smtp.corp.redhat.com (Postfix) with ESMTP id E4F0F3C39;
...
Cc: ajones@ventanamicro.com,
	...
	x86@kernel.org,
	kbingham@kernel.org
Subject: [PATCH v2 4/5] x86, vfio, gdb: replace CONFIG_HAVE_KVM with IS_ENABLED(CONFIG_KVM)
Date: Mon,  8 Jan 2024 07:47:39 -0500
Message-Id: <20240108124740.114453-5-pbonzini@redhat.com>
...
Architectures always "have" KVM, so for example checking CONFIG_HAVE_KVM
in x86 code is pointless, but if KVM is disabled in a specific build,
there is no need for support code.
...
thing to do.  And likewise there is no need to include code that uses
symbol_get in VFIO as that symbol_get would always fail.
