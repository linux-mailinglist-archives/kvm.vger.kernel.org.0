...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id EE0C4101E6D
	for <lists+kvm@lfdr.de>; Tue, 19 Nov 2019 09:48:30 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727495AbfKSIsM (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Tue, 19 Nov 2019 03:48:12 -0500
Received: from mga17.intel.com ([192.55.52.151]:26340 "EHLO mga17.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727407AbfKSIsL (ORCPT <rfc822;kvm@vger.kernel.org>);
        Tue, 19 Nov 2019 03:48:11 -0500
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga007.jf.intel.com ([10.7.209.58])
  by fmsmga107.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384; 19 Nov 2019 00:48:09 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.68,322,1569308400"; 
   d="scan'208";a="196427099"
Received: from unknown (HELO local-michael-cet-test.sh.intel.com) ([10.239.159.128])
  by orsmga007.jf.intel.com with ESMTP; 19 Nov 2019 00:48:05 -0800
...
Subject: [PATCH v7 6/9] vmx: spp: Set up SPP paging table at vmentry/vmexit
Date:   Tue, 19 Nov 2019 16:49:46 +0800
Message-Id: <20191119084949.15471-7-weijiang.yang@intel.com>
...
index b5327faf512e..0ff23b97970a 100644
...
index af296a290173..5eb8830c459a 100644
...
@@ -5333,6 +5340,89 @@ static int handle_monitor_trap(struct kvm_vcpu *vcpu)
 	return 1;
 }
...
+			for (; gfn <= gfn_max; gfn++) {
+				if (!gfn_to_memslot(vcpu->kvm, gfn))
+					continue;
...
@@ -5547,6 +5637,7 @@ static int (*kvm_vmx_exit_handlers[])(struct kvm_vcpu *vcpu) = {
...
@@ -5781,6 +5872,9 @@ void dump_vmcs(void)
