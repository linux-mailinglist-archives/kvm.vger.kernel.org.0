Return-Path: <kvm+bounces-70236-lists+kvm=lfdr.de@vger.kernel.org>
Delivered-To: lists+kvm@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id cJYuG/Jlg2nAmAMAu9opvQ
	(envelope-from <kvm+bounces-70236-lists+kvm=lfdr.de@vger.kernel.org>)
	for <lists+kvm@lfdr.de>; Wed, 04 Feb 2026 16:29:54 +0100
X-Original-To: lists+kvm@lfdr.de
Received: from sin.lore.kernel.org (sin.lore.kernel.org [104.64.211.4])
	by mail.lfdr.de (Postfix) with ESMTPS id 8E38CE8B55
	for <lists+kvm@lfdr.de>; Wed, 04 Feb 2026 16:29:52 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sin.lore.kernel.org (Postfix) with ESMTP id 46BFF303BB50
	for <lists+kvm@lfdr.de>; Wed,  4 Feb 2026 15:09:26 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 5164741B375;
	Wed,  4 Feb 2026 15:03:26 +0000 (UTC)
...
X-Spamd-Result: default: False [-0.66 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-70236-lists,kvm=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	TO_DN_NONE(0.00)[];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[ste.tt:url,pgste.zero:url,pud.cr:url,p4d.tl:url,rtte.tt:url,pgd.tt:url,fpf.sk:url,sin.lore.kernel.org:helo,sin.lore.kernel.org:rdns,rste.tt:url,pmd.tt:url,fc1.sd:url,fc0.tl:url,pgd.tf:url,p4d.tt:url,rtte.cr:url,s.sd:url,rfte.tl:url,rfte.tf:url,rste.tl:url,pud.tt:url,linux.ibm.com:mid,fc0.tf:url,vaddr.sx:url,pgd.tl:url,rste.tf:url];
	DKIM_TRACE(0.00)[ibm.com:+];
	TAGGED_RCPT(0.00)[kvm];
	ASN(0.00)[asn:63949, ipnet:104.64.192.0/19, country:SG];
	RCPT_COUNT_TWELVE(0.00)[16];
	RCVD_COUNT_SEVEN(0.00)[11]
X-Rspamd-Queue-Id: 8E38CE8B55
