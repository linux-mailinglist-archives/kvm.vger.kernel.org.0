...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 48C3847B1E3
	for <lists+kvm@lfdr.de>; Mon, 20 Dec 2021 18:10:53 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S240070AbhLTRKv (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Mon, 20 Dec 2021 12:10:51 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39342 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235610AbhLTRKv (ORCPT <rfc822;kvm@vger.kernel.org>);
        Mon, 20 Dec 2021 12:10:51 -0500
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C559EC061574;
        Mon, 20 Dec 2021 09:10:50 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        d=infradead.org; s=bombadil.20210309; h=MIME-Version:Content-Type:References:
        In-Reply-To:Date:Cc:To:From:Subject:Message-ID:Sender:Reply-To:
        Content-Transfer-Encoding:Content-ID:Content-Description;
        bh=Ek1pVHJcSntoa6J3bvk4oR7i5coze9qvsW0Q0B5p5kI=; b=wk12GQ17Ed/g/x5uIziTH7Gkdf
        ;
Received: from [2001:8b0:10b:1::3ae] (helo=u3832b3a9db3152.ant.amazon.com)
        by bombadil.infradead.org with esmtpsa (Exim 4.94.2 #2 (Red Hat Linux))
        id 1mzMB7-003TpJ-S2; Mon, 20 Dec 2021 17:10:26 +0000
Message-ID: <d4cde50b4aab24612823714dfcbe69bc4bb63b60.camel@infradead.org>
...
Date:   Mon, 20 Dec 2021 17:10:21 +0000
...
@@ -1337,7 +1337,7 @@ int native_cpu_up(unsigned int cpu, struct task_struc=
t *tidle)
        int ret;
=20
        /* If parallel AP bringup isn't enabled, perform the first steps no=
w. */
...
+       if (1 || !do_parallel_bringup) {
                ...
                if (ret)
                        return ret;
@@ -1366,7 +1366,8 @@ int native_cpu_up(unsigned int cpu, struct task_struc=
t *tidle)
...
MjIwMTcxMDIxWjAvBgkqhkiG9w0BCQQxIgQg8tKd9RMjjJtebWYGU2SWtMGbD21ME+OeiPEJKdI8
9L8wgb4GCSsGAQQBgjcQBDGBsDCBrTCBlzELMAkGA1UEBhMCR0IxGzAZBgNVBAgTEkdyZWF0ZXIg
...

