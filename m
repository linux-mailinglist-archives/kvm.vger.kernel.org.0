...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 4F2AD7CAEC3
	for <lists+kvm@lfdr.de>; Mon, 16 Oct 2023 18:17:13 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233984AbjJPQRI (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Mon, 16 Oct 2023 12:17:08 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51444 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233899AbjJPQRA (ORCPT <rfc822;kvm@vger.kernel.org>);
        Mon, 16 Oct 2023 12:17:00 -0400
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.136])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 5031FEA;
        Mon, 16 Oct 2023 09:16:48 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1697473008; x=1729009008;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=vWw9F/HadmopWBLaZdCn3q3A/3DSr0WyS86SWmL7Lsk=;
  b=YKjLbObPJPVpgPhYI2jHiF8lgqcbe7qrF28adZC5zEGsjGaeQ+/ceZDG
   piQSUOL+HC8fn3Am/PIapk8tE+MqVyfIbpffyRsPWhswMoIZwVY+MVDYw
   tG0oa7Upg4S6Csn3l8vJsxgcMw8oNfOsgKzw+T5my3IpCVMjEDJfFC48+
   a1rdB4UBIeExSQrWtHaGRfwT5XC5Yqd9xv1qD17fhkS1B0b/dY9a/Gnjj
   PVmRWmNrEZj1bcUBXqhWYO5YsdkoqZGo52skmafr2TcHhBD+0X5QfciNu
   n8lz76b7KTnndgI2BYOJsBRUnlBXE633mh56FmSMqPW3eiW4WGFNNNIhY
   Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10865"; a="364921762"
X-IronPort-AV: E=Sophos;i="6.03,229,1694761200"; 
   d="scan'208";a="364921762"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
  by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 16 Oct 2023 09:15:42 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10865"; a="846448113"
X-IronPort-AV: E=Sophos;i="6.03,229,1694761200"; 
   d="scan'208";a="846448113"
...
Subject: [PATCH v16 046/116] KVM: x86/tdp_mmu: Support TDX private mapping for TDP MMU
Date:   Mon, 16 Oct 2023 09:13:58 -0700
Message-Id: <66f49b85cc57cf2bb3a3c9d4ad579b359cb58073.1697471314.git.isaku.yamahata@intel.com>
...
index 432b94a61ab1..8e6bcafd947b 100644
--- a/arch/x86/include/asm/kvm_host.h
+++ b/arch/x86/include/asm/kvm_host.h
@@ -476,6 +476,7 @@ struct kvm_mmu {
...
@@ -1719,6 +1720,16 @@ struct kvm_x86_ops {
...
index eb45bd2ca706..0ae59d680145 100644
