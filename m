Return-Path: <kvm+bounces-69669-lists+kvm=lfdr.de@vger.kernel.org>
Delivered-To: lists+kvm@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id qAK5ChBGfGnfLgIAu9opvQ
	(envelope-from <kvm+bounces-69669-lists+kvm=lfdr.de@vger.kernel.org>)
	for <lists+kvm@lfdr.de>; Fri, 30 Jan 2026 06:48:00 +0100
X-Original-To: lists+kvm@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 7E7F7B76BF
	for <lists+kvm@lfdr.de>; Fri, 30 Jan 2026 06:47:59 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id BE389301983F
	for <lists+kvm@lfdr.de>; Fri, 30 Jan 2026 05:47:32 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B6E5B374169;
	Fri, 30 Jan 2026 05:47:31 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b="KVjNBkHv"
X-Original-To: kvm@vger.kernel.org
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 446EA2EBBB9
	for <kvm@vger.kernel.org>; Fri, 30 Jan 2026 05:47:29 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=170.10.133.124
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1769752051; cv=none; b=A7RMeT9sdkw9XMpJqxDMKJUBjiY/unqawixdzyND4mzdOzhisb/hoUQb1BtYOr1Pz/3/kqzKG+4UeeDLlbMhIgIkT2p6ZATvrqlCZV99eVwOytUy91V/lm58n3BmnR2jmgijuNpmniO/Wpl2cKQFm0eqrkvxmMGpTk2z4gn44z8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1769752051; c=relaxed/simple;
	bh=C25KFxs057vuRonVgcVm7CuOgHK0AKBRAZJAF9dsJLI=;
	h=From:To:Cc:Subject:Date:Message-ID:Content-Type:MIME-Version; b=EpT1jb/mZxlnkIa/p9HR1Q6Sepco1rvlmr3qMOHZHvfkojA/aJXmlfhnRWM3LWlY7ys+zFo2s4YFdnRrDG8e5OERxvTUBGl9QwV0kjfm/JIzEeXjlnR4oiiYT+Um48zvAznyB2iHb0bGGyzMcKmQRAeWyqGYXrH+YGtQ2t1TLyM=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com; spf=pass smtp.mailfrom=redhat.com; dkim=pass (1024-bit key) header.d=redhat.com header.i=@redhat.com header.b=KVjNBkHv; arc=none smtp.client-ip=170.10.133.124
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=redhat.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=redhat.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
	s=mimecast20190719; t=1769752048;
	h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
	 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding;
	bh=B4TVuQqCjTXuRjb89AktgM7cWmpF/NlrHYzi+O2BAe0=;
	b=KVjNBkHvACQ117tnTa2A0UggZsfNicdgE7DLJ6XSssmyGSLQ8N/aZ90RzEaqzU5fxcpdAS
	KHdRqPHGskJ7m+CYCmuyUIM6u0p098abZgBajuG5k4Ij02IgQK375+QHs9D3RlbmaR+rjp
	UMlz5hat/JehgJbZvYKG1Ln6kAPo+Eo=
Received: from mx-prod-mc-05.mail-002.prod.us-west-2.aws.redhat.com
 (ec2-54-186-198-63.us-west-2.compute.amazonaws.com [54.186.198.63]) by
 relay.mimecast.com with ESMTP with STARTTLS (version=TLSv1.3,
 cipher=TLS_AES_256_GCM_SHA384) id us-mta-664-qSIRxCZgM9Opo4djQfMp7Q-1; Fri,
 30 Jan 2026 00:47:24 -0500
X-MC-Unique: qSIRxCZgM9Opo4djQfMp7Q-1
X-Mimecast-MFC-AGG-ID: qSIRxCZgM9Opo4djQfMp7Q_1769752043
Received: from mx-prod-int-03.mail-002.prod.us-west-2.aws.redhat.com (mx-prod-int-03.mail-002.prod.us-west-2.aws.redhat.com [10.30.177.12])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	by mx-prod-mc-05.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTPS id B433C19560AA;
	Fri, 30 Jan 2026 05:47:22 +0000 (UTC)
Received: from osteffen-thinkpadx1carbongen12.rmtde.csb (unknown [10.45.226.150])
	by mx-prod-int-03.mail-002.prod.us-west-2.aws.redhat.com (Postfix) with ESMTP id 01A8F19560A2;
	Fri, 30 Jan 2026 05:47:16 +0000 (UTC)
...
Subject: [PATCH v6 0/9] igvm: Supply MADT via IGVM parameter
Date: Fri, 30 Jan 2026 06:47:05 +0100
Message-ID: <20260130054714.715928-1-osteffen@redhat.com>
...
X-Spamd-Result: default: False [0.34 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-69669-lists,kvm=lfdr.de];
	MIME_TRACE(0.00)[0:+];
	RCVD_TLS_LAST(0.00)[];
...
v6:
- Fix errors on non-i386 architectures
  - Only build IGVM stubs file if feature is enabled.
  - Move IGVM-related struct definitions to an internal header
  - Move IGVM parameter handler for MADT to i386 code and stub it for other
    architectures
- Reuse existing ACPI checksum function instead of adding a new one
...
- Refactor: Extract common code for finding IGVM parameter from IGVM parameter
  handlers
...
Oliver Steffen (9):
 ...
 include/system/igvm-internal.h |  49 +++++++
