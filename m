Return-Path: <kvm+bounces-308-lists+kvm=lfdr.de@vger.kernel.org>
X-Original-To: lists+kvm@lfdr.de
Delivered-To: lists+kvm@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 0A2B17DE11D
	for <lists+kvm@lfdr.de>; Wed,  1 Nov 2023 13:51:17 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 8F37DB211EC
	for <lists+kvm@lfdr.de>; Wed,  1 Nov 2023 12:51:14 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id EF56012B75;
	Wed,  1 Nov 2023 12:51:06 +0000 (UTC)
...
Received: from lindbergh.monkeyblade.net (lindbergh.monkeyblade.net [23.128.96.19])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A674E2F31
	for <kvm@vger.kernel.org>; Wed,  1 Nov 2023 12:51:04 +0000 (UTC)
Received: from mail-qv1-xf2d.google.com (mail-qv1-xf2d.google.com [IPv6:2607:f8b0:4864:20::f2d])
	by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 57C46FC
	for <kvm@vger.kernel.org>; Wed,  1 Nov 2023 05:51:03 -0700 (PDT)
Received: by mail-qv1-xf2d.google.com with SMTP id 6a1803df08f44-66d264e67d8so43189696d6.1
        for <kvm@vger.kernel.org>; Wed, 01 Nov 2023 05:51:03 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=DytdUoCbq8poGHKLHOEtAO0D5dohgKyWvCysCxFt+wY=;
        b=
X-Gm-Message-State: AOJu0YwgjpuSh8KlHipSTBoFMGzRI0NURTpUyjhoBoW58UcReQQqXBbu
	DRYAlVPEnv6j+XkebP2sYTH5f6Jp2fVYRXCRiZxaMQ==
