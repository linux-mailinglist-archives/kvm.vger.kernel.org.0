...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 60DBB6AA133
	for <lists+kvm@lfdr.de>; Fri,  3 Mar 2023 22:30:29 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231749AbjCCVa2 (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Fri, 3 Mar 2023 16:30:28 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40522 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231738AbjCCVa0 (ORCPT <rfc822;kvm@vger.kernel.org>);
        Fri, 3 Mar 2023 16:30:26 -0500
Received: from raptorengineering.com (mail.raptorengineering.com [23.155.224.40])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 70D2FCA25
        for <kvm@vger.kernel.org>; Fri,  3 Mar 2023 13:30:24 -0800 (PST)
Received: from localhost (localhost [127.0.0.1])
        by mail.rptsys.com (Postfix) with ESMTP id 8BF8F37E2A825E
        for <kvm@vger.kernel.org>; Fri,  3 Mar 2023 15:30:23 -0600 (CST)
Received: from mail.rptsys.com ([127.0.0.1])
        by localhost (vali.starlink.edu [127.0.0.1]) (amavisd-new, port 10032)
        with ESMTP id B6WjO_95jPzQ for <kvm@vger.kernel.org>;
        Fri,  3 Mar 2023 15:30:21 -0600 (CST)
Received: from localhost (localhost [127.0.0.1])
        by mail.rptsys.com (Postfix) with ESMTP id 3549137E2A825B
        for <kvm@vger.kernel.org>; Fri,  3 Mar 2023 15:30:21 -0600 (CST)
DKIM-Filter: OpenDKIM Filter v2.10.3 mail.rptsys.com 3549137E2A825B
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=raptorengineering.com; s=B8E824E6-0BE2-11E6-931D-288C65937AAD;
        t=1677879021; bh=r7EV6+aB6YhHzsFlehpR+Kr4tc6yh5V+2pzyDL+8j5M=;
        h=Date:From:To:Message-ID:MIME-Version;
        b=PgtKADnBe1nQov65a41yNDAwPIZR1yDxpEJViLnjFQ9fxQhZgCrV+TqejNNXgj3Nk
         3OquP3oQqcGqDCSqR1xFTiPFux4Ejg9fWVsjVQfy3vn0B3xfr+no+1fyTrnXBrWoGJ
         96pLNLwXvsZHSTRpWiOsNHMIHVAV1PC5CtaD86SI=
X-Virus-Scanned: amavisd-new at rptsys.com
Received: from mail.rptsys.com ([127.0.0.1])
        by localhost (vali.starlink.edu [127.0.0.1]) (amavisd-new, port 10026)
        with ESMTP id dqsthdCGcHfW for <kvm@vger.kernel.org>;
        Fri,  3 Mar 2023 15:30:21 -0600 (CST)
Received: from vali.starlink.edu (localhost [127.0.0.1])
        by mail.rptsys.com (Postfix) with ESMTP id 1678837E2A8258
        for <kvm@vger.kernel.org>; Fri,  3 Mar 2023 15:30:21 -0600 (CST)
Date:   Fri, 3 Mar 2023 15:30:21 -0600 (CST)
From:   Timothy Pearson <tpearson@raptorengineering.com>
To:     kvm <kvm@vger.kernel.org>
Message-ID: <41528182.16281476.1677879021033.JavaMail.zimbra@raptorengineeringinc.com>
Subject: [PATCH 4/5] powerpc/iommu: Add iommu_ops to report capabilities and
MIME-Version: 1.0
Content-Type: text/plain; charset=utf-8
Content-Transfer-Encoding: 7bit
X-Mailer: Zimbra 8.5.0_GA_3042 (ZimbraWebClient - GC110 (Linux)/8.5.0_GA_3042)
Thread-Index: XEO/vNpuI4Bosfc5S8t+rGOiLE5OTw==
