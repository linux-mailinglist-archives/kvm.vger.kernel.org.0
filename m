...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id E1DD02D943C
	for <lists+kvm@lfdr.de>; Mon, 14 Dec 2020 09:41:59 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2439368AbgLNIkU (ORCPT <rfc822;lists+kvm@lfdr.de>);
...
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        ...
        bh=tBq69FrBfo3FGfDE8wAnuLV0cMI+RANBkpZW+oLWxTs=; b=BToOYupfZcPtfGpfOo4aOFGNTc
...
Cc:     Paolo Bonzini <pbonzini@redhat.com>,
        ...
        fandree@amazon.com
Subject: [PATCH v3 06/17] KVM: x86/xen: latch long_mode when hypercall page is set up
