...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 1EEED391F7E
	for <lists+kvm@lfdr.de>; Wed, 26 May 2021 20:47:10 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235702AbhEZSsi (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Wed, 26 May 2021 14:48:38 -0400
Received: from smtp-fw-9102.amazon.com ([207.171.184.29]:38611 "EHLO
        smtp-fw-9102.amazon.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233597AbhEZSsi (ORCPT <rfc822;kvm@vger.kernel.org>);
        Wed, 26 May 2021 14:48:38 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
  d=amazon.com; i=@amazon.com; q=dns/txt; s=amazon201209;
  t=1622054827; x=1653590827;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version;
  bh=0tdpKVaxueVFi3JekWVHP4zb9TllD/q+HSeKSzNqIuM=;
  b=i+NIh4DYQav+pJECOwSlPBp9HYZGNiuxbhC+mO2YydlGGuzpaXIHu1c8
   cDSklaldlpgUFiXxaoWs7M3hHBlsZe27eYyLVJSAF03Y9isG49OlYoM9a
   7NudjU5WsJcgyzmWFuJWfE7Vl99rotUu0TUA4RiRFn0/2GIYcTsRSktLm
   U=;
X-IronPort-AV: E=Sophos;i="5.82,331,1613433600"; 
   d="scan'208";a="137030046"
Received: from pdx4-co-svc-p1-lb2-vlan2.amazon.com (HELO email-inbound-relay-1d-38ae4ad2.us-east-1.amazon.com) ([10.25.36.210])
  by smtp-border-fw-9102.sea19.amazon.com with ESMTP; 26 May 2021 18:47:05 +0000
Received: from EX13MTAUEE001.ant.amazon.com (iad55-ws-svc-p15-lb9-vlan2.iad.amazon.com [10.40.159.162])
        by email-inbound-relay-1d-38ae4ad2.us-east-1.amazon.com (Postfix) with ESMTPS id 380F6A1D5C;
        Wed, 26 May 2021 18:47:04 +0000 (UTC)
Received: from EX13D08UEE004.ant.amazon.com (10.43.62.182) by
 EX13MTAUEE001.ant.amazon.com (10.43.62.200) with Microsoft SMTP Server (TLS)
 id 15.0.1497.18; Wed, 26 May 2021 18:46:45 +0000
Received: from EX13MTAUEA001.ant.amazon.com (10.43.61.82) by
 EX13D08UEE004.ant.amazon.com (10.43.62.182) with Microsoft SMTP Server (TLS)
 id 15.0.1497.18; Wed, 26 May 2021 18:46:45 +0000
Received: from uae075a0dfd4c51.ant.amazon.com (10.106.82.24) by
 mail-relay.amazon.com (10.43.61.243) with Microsoft SMTP Server id
 15.0.1497.18 via Frontend Transport; Wed, 26 May 2021 18:46:43 +0000
...
CC:     <mlevitsk@redhat.com>, <seanjc@google.com>, <vkuznets@redhat.com>,
        ...
        <ilstam@amazon.com>
Subject: [PATCH v4 08/11] KVM: X86: Move write_l1_tsc_offset() logic to common code and rename it
