...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 6E9D53B7D26
	for <lists+kvm@lfdr.de>; Wed, 30 Jun 2021 08:08:24 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232278AbhF3GKq (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Wed, 30 Jun 2021 02:10:46 -0400
Received: from mga02.intel.com ([134.134.136.20]:46946 "EHLO mga02.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S231791AbhF3GKo (ORCPT <rfc822;kvm@vger.kernel.org>);
        Wed, 30 Jun 2021 02:10:44 -0400
X-IronPort-AV: E=McAfee;i="6200,9189,10030"; a="195448548"
X-IronPort-AV: E=Sophos;i="5.83,311,1616482800"; 
   d="scan'208";a="195448548"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 29 Jun 2021 23:08:14 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.83,311,1616482800"; 
   d="scan'208";a="455156480"
...
Subject: [PATCH v6 01/26] x86/fpu/xstate: Modify the initialization helper to handle both static and dynamic buffers
Date:   Tue, 29 Jun 2021 23:02:01 -0700
Message-Id: <20210630060226.24652-2-chang.seok.bae@intel.com>
...
index 7ada7bd03a32..d0c16f5a9aeb 100644
...
-
 ...
 {
 	fx->cwd = 0x37f;
@@ -229,8 +220,25 @@ static inline void fpstate_init_fstate(struct fregs_state *fp)
 	fp->fos = 0xffff0000u;
 }
...
+
 	if (!static_cpu_has(X86_FEATURE_FPU)) {
 		...
 		return;
@@ -239,7 +247,7 @@ void fpstate_init(union fpregs_state *state)
...
index 8ee7add0e763..3c3a52f6d490 100644
--- a/arch/x86/kvm/x86.c
+++ b/arch/x86/kvm/x86.c
@@ -10273,7 +10273,7 @@ static void fx_init(struct kvm_vcpu *vcpu)
