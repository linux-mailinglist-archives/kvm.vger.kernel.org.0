...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 7D7376F1833
	for <lists+kvm@lfdr.de>; Fri, 28 Apr 2023 14:41:19 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1346084AbjD1MlR (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Fri, 28 Apr 2023 08:41:17 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:41680 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1346039AbjD1MlO (ORCPT <rfc822;kvm@vger.kernel.org>);
        Fri, 28 Apr 2023 08:41:14 -0400
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.133.124])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id AE2214497
        for <kvm@vger.kernel.org>; Fri, 28 Apr 2023 05:40:25 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1682685624;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=n9hx8swNthm3d9dHaInRN+HJ/JBUo8h7dHzzksYBthw=;
        b=eXWILgR9GIlrZSXQRmM9Urf69nSC02JOjjZT5WB2CsIMF/ziQCXpl4jLoeU/RiQlIPV03d
        ijvceBchNwASO9+ODZtW2QyzpEhxuBSfpuz0AJs6ePw1NVyIinbPXSmeYfBNO5ijZvTrmC
        x9/WRqiRl3JP3F1qQul2OgFAyVqYl5E=
Received: from mimecast-mx02.redhat.com (mx3-rdu2.redhat.com
 [66.187.233.73]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-636-dN8BKPE_O1W573ABrpvVdw-1; Fri, 28 Apr 2023 08:40:21 -0400
X-MC-Unique: dN8BKPE_O1W573ABrpvVdw-1
Received: from smtp.corp.redhat.com (int-mx04.intmail.prod.int.rdu2.redhat.com [10.11.54.4])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 159253C0E44F;
        Fri, 28 Apr 2023 12:40:21 +0000 (UTC)
Received: from localhost (unknown [10.39.192.223])
        by smtp.corp.redhat.com (Postfix) with ESMTP id 248EF2027043;
        Fri, 28 Apr 2023 12:40:19 +0000 (UTC)
...
Subject: [PULL 09/17] file-posix: add tracking of the zone write pointers
Date:   Fri, 28 Apr 2023 08:39:46 -0400
Message-Id: <20230428123954.179035-10-stefanha@redhat.com>
...
index 701acddbca..e7ad6bb4e7 100644
...
+    qemu_co_mutex_init(&bs->wps->colock);
 ...
 static void raw_refresh_zoned_limits(BlockDriverState *bs, struct stat *st,
@@ -2065,7 +2166,7 @@ static int handle_aiocb_zone_mgmt(void *opaque)
...
+
     ...
     case BLK_ZO_OPEN:
         op_name = "BLKOPENZONE";
@@ -3342,7 +3492,27 @@ static int coroutine_fn raw_co_zone_mgmt(BlockDriverState *bs, BlockZoneOp op,
