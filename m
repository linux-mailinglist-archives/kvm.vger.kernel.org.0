...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 6B79758BD55
	for <lists+kvm@lfdr.de>; Mon,  8 Aug 2022 00:06:52 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231890AbiHGWEG (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Sun, 7 Aug 2022 18:04:06 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:48264 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234605AbiHGWCv (ORCPT <rfc822;kvm@vger.kernel.org>);
        Sun, 7 Aug 2022 18:02:51 -0400
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 243606540;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  bh=tptwOkb+wtZVdyN37aV1+FrW4HrO9AQbWyMWGNwZ9qQ=;
  b=aSNki+ZF0DTu2OqmYi2+nsmCWx5sfHUOwW3yzNcnyOmXisKiZ5fIeTzu
   UOhDm8ulXD44qzIkM9S/xDcIhs+3y2VePSuZjnRafExL+JOC3fW9hoZR9
   OPhHUCUFD88l0tBUGOwVps3y+x0O1d/mx7mZPnrRdUPEzJ6MhWDhvaNZJ
   Fd3IHfOHh5yZ1zUmSbpHVAfbq6CurRmjcLTVsxjP5WZrh0ms8SfqonBZq
   6nz7uJl7mGFm6fUvjyYDPEzDLbxpeaWj2gKLljkBhWNRlsaLKG/oGYyRP
   mlhPugv2lkck6ryNmaYXWdSNDrRCn0EyWGr0xjPN2usvul5suW/xnpbxz
   A==;
X-IronPort-AV: E=McAfee;i="6400,9594,10432"; a="291695690"
X-IronPort-AV: E=Sophos;i="5.93,220,1654585200"; 
   d="scan'208";a="291695690"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
  by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 07 Aug 2022 15:02:37 -0700
X-IronPort-AV: E=Sophos;i="5.93,220,1654585200"; 
   d="scan'208";a="663682613"
...
Subject: [PATCH v8 052/103] KVM: x86/VMX: introduce vmx tlb_remote_flush and tlb_remote_flush_with_range
Date:   Sun,  7 Aug 2022 15:01:37 -0700
Message-Id: <86d6033a99fdf6378cd47cca4f8b2a1e47a9ac48.1659854790.git.isaku.yamahata@intel.com>
...
index d4cf185ba8c0..27deaf44ee80 100644
...
index db33c2808e0e..afe7d85ac427 100644
--- a/arch/x86/kvm/vmx/vmx.c
+++ b/arch/x86/kvm/vmx/vmx.c
@@ -3076,6 +3076,33 @@ void vmx_flush_tlb_current(struct kvm_vcpu *vcpu)
...
index 185481ee5f2f..b8d92fc061ff 100644
--- a/arch/x86/kvm/vmx/x86_ops.h
+++ b/arch/x86/kvm/vmx/x86_ops.h
@@ -91,6 +91,9 @@ void vmx_set_rflags(struct kvm_vcpu *vcpu, unsigned long rflags);
