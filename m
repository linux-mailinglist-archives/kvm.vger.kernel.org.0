...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 93B9B4D42A0
	for <lists+kvm@lfdr.de>; Thu, 10 Mar 2022 09:34:31 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S240436AbiCJIfW (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Thu, 10 Mar 2022 03:35:22 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57768 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S240412AbiCJIfU (ORCPT <rfc822;kvm@vger.kernel.org>);
        Thu, 10 Mar 2022 03:35:20 -0500
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 631CC62A04;
        Thu, 10 Mar 2022 00:34:12 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1646901253; x=1678437253;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references;
  bh=DWVZtFKjUeeEv4thjgP8+H/mD8hLBx/zQSbR5DAmhUk=;
  b=cXxydHShqbuQXMEttmEFNStkDNOxGLD0RjJi3V4SmRDHeBkNvYkbToq0
   esTU7sYk9akgDhMJ+ZdJKvvBw7rcwzrdbsyH5iEfwc7M4jZItcApiVa29
   MzGONLjwXAvAEOI3JL1dP+8Nek0uCromjvtUqqsCqS3fD/FmtTF4udfcu
   JT8op9rPjDoEXJsMFmdpU5yDDbPX0nSTwtgQSOTmde/O0lQYVou74wCPO
   juq0RXPCft/D617HHHFFB+MaR599FjcmLI8B+osl97PwtETZ9wTNrY+Pv
   flb3I0TJwPKFchEYMDd/MpLPC7nY7k4ay5XWU5bC63UV/CI37sWkOFd7P
   A==;
X-IronPort-AV: E=McAfee;i="6200,9189,10281"; a="235800144"
X-IronPort-AV: E=Sophos;i="5.90,169,1643702400"; 
   d="scan'208";a="235800144"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
  by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 10 Mar 2022 00:34:12 -0800
X-IronPort-AV: E=Sophos;i="5.90,169,1643702400"; 
   d="scan'208";a="513891457"
Received: from chenyi-pc.sh.intel.com ([10.239.159.73])
  by orsmga006-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 10 Mar 2022 00:34:09 -0800
...
Subject: [PATCH v4 2/3] KVM: VMX: Enable Notify VM exit
Date:   Thu, 10 Mar 2022 16:40:00 +0800
Message-Id: <20220310084001.10235-3-chenyi.qiang@intel.com>
...
which can make it more flexible to utilize the feature.
...
@@ -6052,6 +6058,13 @@ int kvm_vm_ioctl_enable_cap(struct kvm *kvm,
 		}
...
+		break;
 	default:
 		r = -EINVAL;
 		break;
@@ -11646,6 +11659,8 @@ int kvm_arch_init_vm(struct kvm *kvm, unsigned long type)
