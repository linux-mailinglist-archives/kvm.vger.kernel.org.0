...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D258E782C8E
	for <lists+kvm@lfdr.de>; Mon, 21 Aug 2023 16:48:11 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236165AbjHUOsL (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Mon, 21 Aug 2023 10:48:11 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44470 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236151AbjHUOsJ (ORCPT <rfc822;kvm@vger.kernel.org>);
        Mon, 21 Aug 2023 10:48:09 -0400
Received: from smtp-out1.suse.de (smtp-out1.suse.de [195.135.220.28])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C0657EE
        for <kvm@vger.kernel.org>; Mon, 21 Aug 2023 07:48:03 -0700 (PDT)
Received: from relay2.suse.de (relay2.suse.de [149.44.160.134])
        by smtp-out1.suse.de (Postfix) with ESMTP id 7A93922C3F;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.de; s=susede2_rsa;
        ...
        bh=4gAymOfgU4CvfLe1YUakUqUJeSJm/ySB8EY/+aS/98c=;
        b=J7ajbh9HApxIADKdC1BbvIOhYwVphDSDtTj59QT724PaH4UOxe0gFwvfgGtpRZ4N+cvkvP
        Rk9aYqV+z2jKObSpRz+KDXU4uCdNGiinU0kIPj3qSkd1VBUB3Tkj5AksWhRJVE5ZJEvnET
        /Rrz6FmkyCBSNmw47CcMqFMWssB6z04=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=suse.de;
        ...
        h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:cc:
         ...
         in-reply-to:in-reply-to:references:references;
        bh=4gAymOfgU4CvfLe1YUakUqUJeSJm/ySB8EY/+aS/98c=;
        b=lFGhiYIuHIsPdmXomTbXj/qYde84zpg5j3XVoKH4nnYRLHB0M/J6qWIKyyVuTkUulUwXUC
        +ixni8GCubUI8JBg==
Received: from vasant-suse.fritz.box (vkarasulli.udp.ovpn1.nue.suse.de [10.163.24.134])
        by relay2.suse.de (Postfix) with ESMTP id 01A5A2C145;
...
Subject: [kvm-unit-tests PATCH v5 04/11] lib: x86: Import insn decoder from Linux
Date:   Mon, 21 Aug 2023 16:47:44 +0200
Message-Id: <20230821144751.22557-5-vkarasulli@suse.de>
...
+
+The following files were taken as-is from Linux@b320441c04 and
...
+#
+# kvm-unit-tests origin: Linux@b320441c04
