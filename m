...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 899CE682940
	for <lists+kvm@lfdr.de>; Tue, 31 Jan 2023 10:43:51 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232710AbjAaJnt (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Tue, 31 Jan 2023 04:43:49 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:42314 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232657AbjAaJnT (ORCPT <rfc822;kvm@vger.kernel.org>);
        Tue, 31 Jan 2023 04:43:19 -0500
Received: from ams.source.kernel.org (ams.source.kernel.org [145.40.68.75])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E88D24AA4E
        for <kvm@vger.kernel.org>; Tue, 31 Jan 2023 01:42:50 -0800 (PST)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by ams.source.kernel.org (Postfix) with ESMTPS id 2AF7AB81ACC
        for <kvm@vger.kernel.org>; Tue, 31 Jan 2023 09:41:55 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 92DE7C433D2;
        Tue, 31 Jan 2023 09:41:53 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1675158113;
        bh=QZ9sfbCZ9IRXc9MzUR105iVsSLjIPandL0TtmB8/Q1E=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
...
Subject: [PATCH v8 42/69] KVM: arm64: nv: Trap and emulate TLBI instructions from virtual EL2
Date:   Tue, 31 Jan 2023 09:24:37 +0000
Message-Id: <20230131092504.2880505-43-maz@kernel.org>
...
index 9c718f4af944..35147f369336 100644
...
index 6dc82b0384ce..4680a703847b 100644
...
index 66a379baf8c7..40215710ede2 100644
--- a/arch/arm64/kvm/sys_regs.c
+++ b/arch/arm64/kvm/sys_regs.c
@@ -2603,6 +2603,205 @@ static bool handle_s12w(struct kvm_vcpu *vcpu, struct sys_reg_params *p,
