...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 7C1EA359712
	for <lists+kvm@lfdr.de>; Fri,  9 Apr 2021 10:03:11 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232170AbhDIIDV (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Fri, 9 Apr 2021 04:03:21 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55960 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231371AbhDIIDT (ORCPT <rfc822;kvm@vger.kernel.org>);
        Fri, 9 Apr 2021 04:03:19 -0400
Received: from mail-ej1-x633.google.com (mail-ej1-x633.google.com [IPv6:2a00:1450:4864:20::633])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 787BBC061761
        for <kvm@vger.kernel.org>; Fri,  9 Apr 2021 01:03:06 -0700 (PDT)
Received: by mail-ej1-x633.google.com with SMTP id l4so7192017ejc.10
        for <kvm@vger.kernel.org>; Fri, 09 Apr 2021 01:03:06 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=bytedance-com.20150623.gappssmtp.com; s=20150623;
        h=mime-version:references:in-reply-to:from:date:message-id:subject:to
         :cc:content-transfer-encoding;
        bh=moAOShAs1/0ccGCjbKZUu3qXrE6BKadhX/0ynwJHw1w=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=moAOShAs1/0ccGCjbKZUu3qXrE6BKadhX/0ynwJHw1w=;
        b=
X-Gm-Message-State: AOAM532QXn8Ft6eRo8QHlkG08ub0AQsibJUY8CI/e7vX4Dmha2tJx46A
        o7BKwrjbzfTrzVFA9pxp+5vGgp5YBXZIfd/XA9Uu
X-Google-Smtp-Source: ABdhPJx4m8e5Uq2rc9J79HldvJR6CvepR6fw/MgFJTQ1XOXmxRFPaX+Ov9WD97+cfmSnElaLZw3kGcMGoGMbo0gdhg4=
X-Received: by 2002:a17:907:1749:: with SMTP id lf9mr14841870ejc.174.1617955384906;
 Fri, 09 Apr 2021 01:03:04 -0700 (PDT)
MIME-Version: 1.0
...
In-Reply-To: <091dde74-449b-385c-0ec9-11e4847c6c4c@redhat.com>
From:   Yongji Xie <xieyongji@bytedance.com>
Date:   Fri, 9 Apr 2021 16:02:53 +0800
Message-ID: <CACycT3vwATp4+Ao0fjuyeeLQN+xHH=dXF+JUyuitkn4k8hELnA@mail.gmail.com>
...
>
>
> =E5=9C=A8 2021/4/8 =E4=B8=8B=E5=8D=885:36, Yongji Xie =E5=86=99=E9=81=93:
> > On Thu, Apr 8, 2021 at 2:57 PM Jason Wang <jasowang@redhat.com> wrote:
> >>
> >> =E5=9C=A8 2021/3/31 =E4=B8=8B=E5=8D=884:05, Xie Yongji =E5=86=99=E9=81=
=93:
...
> >>> +             return 0;
> >>
> >> Do we allow the userspace to switch kickfd here? If yes, we need to de=
al
> >> with that.
> >>
> > Do you mean the case that eventfd->fd > 0? I think we have dealt with i=
t.
>
>
...
Oh, yes. I think we need eventfd->fd >=3D 0 here.
...
> >>> +     VDUSE_GET_CONFIG,
> >>> +     /* Notify userspace to update the memory mapping in device IOTL=
B */
> >>> +     VDUSE_UPDATE_IOTLB,
> >>> +};
> >>> +
...
> >>> +     __u8 data[VDUSE_CONFIG_DATA_LEN]; /* data buffer used to read/w=
rite */
> >>
> >> Note that since VDUSE_CONFIG_DATA_LEN is part of uAPI it means we can
> >> not change it in the future.
> >>
> >> So this might suffcient for future features or all type of virtio devi=
ces.
> >>
...
> >>> +             __u32 padding[16]; /* padding */
> >>
> >> So it looks to me this padding doesn't work since vduse_dev_config_dat=
a
> >> is larger than it.
> >>
...
/vduse/<name>) */
> >>> +#define VDUSE_CREATE_DEV     _IOW(VDUSE_BASE, 0x02, struct vduse_dev=
_config)
> >>> +
> >>> +/* Destroy a vduse device. Make sure there are no references to the =
char device */
> >>> +#define VDUSE_DESTROY_DEV    _IOW(VDUSE_BASE, 0x03, char[VDUSE_NAME_=
MAX])
> >>> +
> >>> +/*
...
> >>> + */
> >>> +#define VDUSE_IOTLB_GET_FD   _IOWR(VDUSE_BASE, 0x04, struct vduse_io=
tlb_entry)
> >>> +
> >>> +/* Setup an eventfd to receive kick for virtqueue */
> >>> +#define VDUSE_VQ_SETUP_KICKFD        _IOW(VDUSE_BASE, 0x05, struct v=
duse_vq_eventfd)
> >>> +
