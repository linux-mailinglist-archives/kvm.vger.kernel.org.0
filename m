...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id BFF581F6823
	for <lists+kvm@lfdr.de>; Thu, 11 Jun 2020 14:48:21 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726540AbgFKMsC (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Thu, 11 Jun 2020 08:48:02 -0400
Received: from mga18.intel.com ([134.134.136.126]:58110 "EHLO mga18.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726513AbgFKMsB (ORCPT <rfc822;kvm@vger.kernel.org>);
        Thu, 11 Jun 2020 08:48:01 -0400
IronPort-SDR: wAW/bsyx+ElH1oUtxZBj3WhR4+J7Gc6hr1804h0epF6yReoPqC3eso208clEdRNLGUGW5/zWvS
 xMFGorwG7jvA==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga005.jf.intel.com ([10.7.209.41])
  by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 11 Jun 2020 05:47:59 -0700
IronPort-SDR: lk6KLvqbkYmBaL2XtTvcxhd1PwCDiZIXd965AqcG9tDB5O3pwp0gW68qf5a9OmsRWXQzvJ8Bll
 GM2tIHHU7ULw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,499,1583222400"; 
   d="scan'208";a="447911223"
...
Subject: [RFC v6 03/25] hw/pci: modify pci_setup_iommu() to set PCIIOMMUOps
Date:   Thu, 11 Jun 2020 05:54:02 -0700
Message-Id: <1591880064-30638-4-git-send-email-yi.l.liu@intel.com>
...
index 70c6696..e44d2a2 100644
--- a/hw/pci/pci.c
+++ b/hw/pci/pci.c
@@ -2647,7 +2647,13 @@ AddressSpace *pci_device_iommu_address_space(PCIDevice *dev)
...
+           iommu_bus->parent_dev) {
         ...
         /*
@@ -2686,15 +2692,17 @@ AddressSpace *pci_device_iommu_address_space(PCIDevice *dev)
...
@@ -1905,7 +1909,7 @@ static void spapr_phb_realize(DeviceState *dev, Error **errp)
