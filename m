...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 76721391F7A
	for <lists+kvm@lfdr.de>; Wed, 26 May 2021 20:46:46 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235682AbhEZSsP (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Wed, 26 May 2021 14:48:15 -0400
Received: from smtp-fw-4101.amazon.com ([72.21.198.25]:31421 "EHLO
        smtp-fw-4101.amazon.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235678AbhEZSsL (ORCPT <rfc822;kvm@vger.kernel.org>);
        Wed, 26 May 2021 14:48:11 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
  d=amazon.com; i=@amazon.com; q=dns/txt; s=amazon201209;
  t=1622054800; x=1653590800;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version;
  bh=cBNFRnm6DX+K2H63iYa/NoPlzc1E532/cGr8KUxE1BU=;
  b=Ok2h3DlGSBiagg2c+V8tjazTeLCiXhTG7yL4gL9MaEkOBDS+7Uaq0hE0
   90OyNTPJY4O3lHDu86isQbM5Qdo0yKr/XaAY/yI8KqHcjoqrzybq/XBMT
   D937QaYN4WPBkJHnJciAGbj0L+bmJ68LuLZKuYtsvyppvYFMq5K+cFxEG
   U=;
X-IronPort-AV: E=Sophos;i="5.82,331,1613433600"; 
   d="scan'208";a="110382438"
Received: from iad12-co-svc-p1-lb1-vlan3.amazon.com (HELO email-inbound-relay-1e-42f764a0.us-east-1.amazon.com) ([10.43.8.6])
  by smtp-border-fw-4101.iad4.amazon.com with ESMTP; 26 May 2021 18:46:39 +0000
Received: from EX13MTAUEE001.ant.amazon.com (iad55-ws-svc-p15-lb9-vlan3.iad.amazon.com [10.40.159.166])
        by email-inbound-relay-1e-42f764a0.us-east-1.amazon.com (Postfix) with ESMTPS id 32A24A70B2;
        Wed, 26 May 2021 18:46:36 +0000 (UTC)
Received: from EX13D08UEE004.ant.amazon.com (10.43.62.182) by
 EX13MTAUEE001.ant.amazon.com (10.43.62.200) with Microsoft SMTP Server (TLS)
 id 15.0.1497.18; Wed, 26 May 2021 18:46:35 +0000
Received: from EX13MTAUEA001.ant.amazon.com (10.43.61.82) by
 EX13D08UEE004.ant.amazon.com (10.43.62.182) with Microsoft SMTP Server (TLS)
 id 15.0.1497.18; Wed, 26 May 2021 18:46:35 +0000
Received: from uae075a0dfd4c51.ant.amazon.com (10.106.82.24) by
 mail-relay.amazon.com (10.43.61.243) with Microsoft SMTP Server id
 15.0.1497.18 via Frontend Transport; Wed, 26 May 2021 18:46:33 +0000
...
CC:     <mlevitsk@redhat.com>, <seanjc@google.com>, <vkuznets@redhat.com>,
        ...
        <ilstam@amazon.com>
Subject: [PATCH v4 07/11] KVM: X86: Add functions that calculate the nested TSC fields
