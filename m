...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 25829E16F9
	for <lists+kvm@lfdr.de>; Wed, 23 Oct 2019 11:58:12 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2404100AbfJWJ6B (ORCPT <rfc822;lists+kvm@lfdr.de>);
...
@@ -125,6 +111,7 @@ int virtio_transport_notify_send_pre_enqueue(struct vso=
ck_sock *vsk,
...
@@ -1368,6 +1378,23 @@ static int vsock_listen(struct socket *sock, int bac=
klog)
 =09return err;
 }
=20
...
@@ -1405,17 +1432,19 @@ static int vsock_stream_setsockopt(struct socket *s=
ock,
 =09switch (optname) {
...
@@ -1456,7 +1485,6 @@ static int vsock_stream_getsockopt(struct socket *soc=
k,
 =09int len;
 =09struct sock *sk;
 =09struct vsock_sock *vsk;
...
@@ -1480,21 +1508,20 @@ static int vsock_stream_getsockopt(struct socket *s=
ock,
 =09err =3D 0;
 =09sk =3D sock->sk;
