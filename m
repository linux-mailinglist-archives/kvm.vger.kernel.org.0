...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 65E7A76DE11
	for <lists+kvm@lfdr.de>; Thu,  3 Aug 2023 04:23:36 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232875AbjHCCXb (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Wed, 2 Aug 2023 22:23:31 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44562 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233022AbjHCCWg (ORCPT <rfc822;kvm@vger.kernel.org>);
        Wed, 2 Aug 2023 22:22:36 -0400
Received: from mail.loongson.cn (mail.loongson.cn [114.242.206.163])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id 7C8A435B5;
        Wed,  2 Aug 2023 19:22:04 -0700 (PDT)
Received: from loongson.cn (unknown [10.2.5.185])
        by gateway (Coremail) with SMTP id _____8Cx7+tJD8tkNWkPAA--.34910S3;
        Thu, 03 Aug 2023 10:22:01 +0800 (CST)
Received: from localhost.localdomain (unknown [10.2.5.185])
        by localhost.localdomain (Coremail) with SMTP id AQAAf8Cx_c4yD8tk8oNGAA--.51268S14;
...
Subject: [PATCH v18 12/30] LoongArch: KVM: Implement vcpu interrupt operations
Date:   Thu,  3 Aug 2023 10:21:20 +0800
Message-Id: <20230803022138.2736430-13-zhaotianrui@loongson.cn>
...
X-CM-TRANSID: AQAAf8Cx_c4yD8tk8oNGAA--.51268S14
...
index 30326aa02a6e..4065a4a910a4 100644
--- a/arch/loongarch/kvm/vcpu.c
+++ b/arch/loongarch/kvm/vcpu.c
@@ -297,6 +297,43 @@ void kvm_lose_fpu(struct kvm_vcpu *vcpu)
 	preempt_enable();
 }
