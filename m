...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E3CF250D025
	for <lists+kvm@lfdr.de>; Sun, 24 Apr 2022 09:04:06 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S238458AbiDXHFV (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Sun, 24 Apr 2022 03:05:21 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46802 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233814AbiDXHFP (ORCPT <rfc822;kvm@vger.kernel.org>);
        Sun, 24 Apr 2022 03:05:15 -0400
Received: from out0-152.mail.aliyun.com (out0-152.mail.aliyun.com [140.205.0.152])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id EAE87167D3
        for <kvm@vger.kernel.org>; Sun, 24 Apr 2022 00:02:15 -0700 (PDT)
X-Alimail-AntiSpam: AC=PASS;BC=-1|-1;BR=01201311R101e4;CH=green;DM=||false|;DS=||;FP=0|-1|-1|-1|0|-1|-1|-1;HT=ay29a033018047211;MF=darcy.sh@antgroup.com;NM=1;PH=DS;RN=5;SR=0;TI=SMTPD_---.NWmk5tx_1650783733;
Received: from localhost(mailfrom:darcy.sh@antgroup.com fp:SMTPD_---.NWmk5tx_1650783733)
          by smtp.aliyun-inc.com(127.0.0.1);
          Sun, 24 Apr 2022 15:02:13 +0800
...
Subject: [PATCH 2/2] x86: replace `int 0x20` with `syscall`
Date:   Sun, 24 Apr 2022 15:02:07 +0800
Message-Id: <20220424070207.123597-2-darcy.sh@antgroup.com>
X-Mailer: git-send-email 2.32.0.3.g01195cf9f
In-Reply-To: <20220424070207.123597-1-darcy.sh@antgroup.com>
References: <20220424070207.123597-1-darcy.sh@antgroup.com>
MIME-Version: 1.0
