...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 4E1697625D3
	for <lists+kvm@lfdr.de>; Wed, 26 Jul 2023 00:16:17 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231840AbjGYWPy (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Tue, 25 Jul 2023 18:15:54 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:32890 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230484AbjGYWPl (ORCPT <rfc822;kvm@vger.kernel.org>);
...
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
  by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 25 Jul 2023 15:15:15 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10782"; a="1056938765"
X-IronPort-AV: E=Sophos;i="6.01,231,1684825200"; 
   d="scan'208";a="1056938765"
Received: from ls.sc.intel.com (HELO localhost) ([172.25.112.31])
  by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 25 Jul 2023 15:15:14 -0700
...
Subject: [PATCH v15 001/115] KVM: VMX: Move out vmx_x86_ops to 'main.c' to wrap VMX and TDX
Date:   Tue, 25 Jul 2023 15:13:12 -0700
Message-Id: <86ae27e0addd06a245a1f72aaa5d8a7d08dda03b.1690322424.git.isaku.yamahata@intel.com>
...
+int vmx_set_msr(struct kvm_vcpu *vcpu, struct msr_data *msr_info)
 {
 	struct vcpu_vmx *vmx = to_vmx(vcpu);
 	struct vmx_uret_msr *msr;
@@ -2442,7 +2440,7 @@ static int vmx_set_msr(struct kvm_vcpu *vcpu, struct msr_data *msr_info)
 	return ret;
 }
...
@@ -3156,7 +3154,7 @@ static inline int vmx_get_current_vpid(struct kvm_vcpu *vcpu)
...
@@ -3172,7 +3170,7 @@ static void vmx_flush_tlb_current(struct kvm_vcpu *vcpu)
...
@@ -3181,7 +3179,7 @@ static void vmx_flush_tlb_gva(struct kvm_vcpu *vcpu, gva_t addr)
...
@@ -3336,8 +3334,7 @@ u64 construct_eptp(struct kvm_vcpu *vcpu, hpa_t root_hpa, int root_level)
 	return eptp;
 }
...
@@ -3365,8 +3362,7 @@ static void vmx_load_mmu_pgd(struct kvm_vcpu *vcpu, hpa_t root_hpa,
...
@@ -3482,7 +3478,7 @@ void vmx_get_segment(struct kvm_vcpu *vcpu, struct kvm_segment *var, int seg)
 	var->g = (ar >> 15) & 1;
 }
...
@@ -3559,14 +3555,14 @@ void __vmx_set_segment(struct kvm_vcpu *vcpu, struct kvm_segment *var, int seg)
...
@@ -3574,25 +3570,25 @@ static void vmx_get_cs_db_l_bits(struct kvm_vcpu *vcpu, int *db, int *l)
 	*l = (ar >> 13) & 1;
 }
...
@@ -4064,7 +4060,7 @@ void pt_update_intercept_for_msr(struct kvm_vcpu *vcpu)
 	}
 }
...
+bool vmx_guest_apic_has_interrupt(struct kvm_vcpu *vcpu)
 {
 	struct vcpu_vmx *vmx = to_vmx(vcpu);
 	void *vapic_page;
@@ -4084,7 +4080,7 @@ static bool vmx_guest_apic_has_interrupt(struct kvm_vcpu *vcpu)
...
+void vmx_msr_filter_changed(struct kvm_vcpu *vcpu)
 {
 	struct vcpu_vmx *vmx = to_vmx(vcpu);
 	u32 i;
@@ -4225,8 +4221,8 @@ static int vmx_deliver_posted_interrupt(struct kvm_vcpu *vcpu, int vector)
 	return 0;
 }
...
@@ -4870,12 +4866,12 @@ static void vmx_vcpu_reset(struct kvm_vcpu *vcpu, bool init_event)
...
@@ -4886,7 +4882,7 @@ static void vmx_enable_nmi_window(struct kvm_vcpu *vcpu)
...
+void vmx_inject_irq(struct kvm_vcpu *vcpu, bool reinjected)
 {
 	struct vcpu_vmx *vmx = to_vmx(vcpu);
 	uint32_t intr;
@@ -4914,7 +4910,7 @@ static void vmx_inject_irq(struct kvm_vcpu *vcpu, bool reinjected)
 	vmx_clear_hlt(vcpu);
 }
...
+int vmx_interrupt_allowed(struct kvm_vcpu *vcpu, bool for_injection)
 {
 	if (to_vmx(vcpu)->nested.nested_run_pending)
 		return -EBUSY;
@@ -5029,7 +5025,7 @@ static int vmx_interrupt_allowed(struct kvm_vcpu *vcpu, bool for_injection)
...
@@ -5049,7 +5045,7 @@ static int vmx_set_tss_addr(struct kvm *kvm, unsigned int addr)
...
@@ -5571,7 +5566,7 @@ static void vmx_sync_dirty_debug_regs(struct kvm_vcpu *vcpu)
...
@@ -5842,7 +5837,7 @@ static int handle_invalid_guest_state(struct kvm_vcpu *vcpu)
 	return 1;
 }
...
@@ -6106,9 +6101,8 @@ static int (*kvm_vmx_exit_handlers[])(struct kvm_vcpu *vcpu) = {
...
@@ -6551,7 +6545,7 @@ static int __vmx_handle_exit(struct kvm_vcpu *vcpu, fastpath_t exit_fastpath)
 	return 0;
 }
...
@@ -6639,7 +6633,7 @@ static noinstr void vmx_l1d_flush(struct kvm_vcpu *vcpu)
 		: "eax", "ebx", "ecx", "edx");
 }
...
@@ -6944,7 +6938,7 @@ static void handle_external_interrupt_irqoff(struct kvm_vcpu *vcpu)
...
@@ -6961,7 +6955,7 @@ static void vmx_handle_exit_irqoff(struct kvm_vcpu *vcpu)
...
@@ -7084,7 +7078,7 @@ static void vmx_complete_interrupts(struct vcpu_vmx *vmx)
...
@@ -7231,7 +7225,7 @@ static noinstr void vmx_vcpu_enter_exit(struct kvm_vcpu *vcpu,
...
@@ -7520,7 +7514,7 @@ static bool vmx_is_vm_type_supported(unsigned long type)
...
@@ -7907,10 +7901,10 @@ static int vmx_check_intercept_io(struct kvm_vcpu *vcpu,
...
@@ -7990,8 +7984,8 @@ static inline int u64_shl_div_u64(u64 a, unsigned int shift,
 	return 0;
 }
...
@@ -8030,13 +8024,13 @@ static int vmx_set_hv_timer(struct kvm_vcpu *vcpu, u64 guest_deadline_tsc,
 	return 0;
 }
...
@@ -8065,7 +8059,7 @@ void vmx_update_cpu_dirty_logging(struct kvm_vcpu *vcpu)
...
+int vmx_smi_allowed(struct kvm_vcpu *vcpu, bool for_injection)
 {
 	...
 	if (to_vmx(vcpu)->nested.nested_run_pending)
@@ -8084,7 +8078,7 @@ static int vmx_smi_allowed(struct kvm_vcpu *vcpu, bool for_injection)
 	return !is_smm(vcpu);
 }
...
@@ -8105,7 +8099,7 @@ static int vmx_enter_smm(struct kvm_vcpu *vcpu, union kvm_smram *smram)
 	return 0;
 }
...
+int vmx_leave_smm(struct kvm_vcpu *vcpu, const union kvm_smram *smram)
 {
 	struct vcpu_vmx *vmx = to_vmx(vcpu);
 	int ret;
@@ -8126,18 +8120,18 @@ static int vmx_leave_smm(struct kvm_vcpu *vcpu, const union kvm_smram *smram)
 	return 0;
 }
