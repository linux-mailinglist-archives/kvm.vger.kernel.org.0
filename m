...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id AA29344E444
	for <lists+kvm@lfdr.de>; Fri, 12 Nov 2021 10:54:38 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234853AbhKLJ5Y (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Fri, 12 Nov 2021 04:57:24 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:34728 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234815AbhKLJ5W (ORCPT <rfc822;kvm@vger.kernel.org>);
        Fri, 12 Nov 2021 04:57:22 -0500
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 7ACC0C061766
        for <kvm@vger.kernel.org>; Fri, 12 Nov 2021 01:54:32 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        d=infradead.org; s=bombadil.20210309; h=MIME-Version:Content-Type:References:
        In-Reply-To:Date:Cc:To:From:Subject:Message-ID:Sender:Reply-To:
        Content-Transfer-Encoding:Content-ID:Content-Description;
        bh=67R3ABBpqPGyBDNu+YKvNdtiKXyulrXBMxIPlAehjFs=; b=x9gOvcaCTeD7gW2RW5OxtgaMAF
        ;
Received: from [2001:8b0:10b:1::3ae] (helo=u3832b3a9db3152.ant.amazon.com)
        by bombadil.infradead.org with esmtpsa (Exim 4.94.2 #2 (Red Hat Linux))
        id 1mlTGI-009uZo-Lr; Fri, 12 Nov 2021 09:54:23 +0000
Message-ID: <2b400dbb16818da49fb599b9182788ff9896dcda.camel@infradead.org>
...
Date:   Fri, 12 Nov 2021 09:54:18 +0000
...
> > https://lore.kernel.org/kvm/55a5d4e3fbd29dd55e276b97eeaefd0411b3290b.ca=
mel@infradead.org/
> >=20
> > in which I said I'd be a whole lot happier with that if we could do it
> > with RCU instead of an rwlock =E2=80=94 but I don't think we can becaus=
e we'd
...
address is actually written to the VMCS02, isn't it?=20
...
actually *fixes* the bugs that already exist elsewhere =E2=80=94 at least n=
ot
...
MTEyMDk1NDE4WjAvBgkqhkiG9w0BCQQxIgQgLnB7h9G/HEMGX1pDyh1u4ajKlUNTo4ikfVFnvFxC
JcAwgb4GCSsGAQQBgjcQBDGBsDCBrTCBlzELMAkGA1UEBhMCR0IxGzAZBgNVBAgTEkdyZWF0ZXIg
...

