...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id C179D51C740
	for <lists+kvm@lfdr.de>; Thu,  5 May 2022 20:22:39 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234315AbiEESXW (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Thu, 5 May 2022 14:23:22 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:36454 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1345363AbiEESTr (ORCPT <rfc822;kvm@vger.kernel.org>);
...
Subject: [RFC PATCH v6 102/104] Documentation/virtual/kvm: Document on Trust Domain Extensions(TDX)
Date:   Thu,  5 May 2022 11:15:36 -0700
Message-Id: <1c17b8e6988911d754e319156cfb6a44acd2cb05.1651774251.git.isaku.yamahata@intel.com>
...
@@ -1394,6 +1394,9 @@ It is recommended to use this API instead of the KVM_SET_MEMORY_REGION ioctl.
...
@@ -4637,6 +4640,10 @@ Currently, this ioctl is used for issuing Secure Encrypted Virtualization
