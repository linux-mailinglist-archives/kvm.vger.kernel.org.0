...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 23C0B3D1DB2
	for <lists+kvm@lfdr.de>; Thu, 22 Jul 2021 07:45:15 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231249AbhGVFDo (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Thu, 22 Jul 2021 01:03:44 -0400
Received: from mga06.intel.com ([134.134.136.31]:24089 "EHLO mga06.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S230137AbhGVFDi (ORCPT <rfc822;kvm@vger.kernel.org>);
        Thu, 22 Jul 2021 01:03:38 -0400
X-IronPort-AV: E=McAfee;i="6200,9189,10052"; a="272687002"
X-IronPort-AV: E=Sophos;i="5.84,260,1620716400"; 
   d="scan'208";a="272687002"
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
  by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 21 Jul 2021 22:43:29 -0700
X-IronPort-AV: E=Sophos;i="5.84,260,1620716400"; 
   d="scan'208";a="512372609"
Received: from vmm_a4_icx.sh.intel.com (HELO localhost.localdomain) ([10.239.53.245])
  by fmsmga002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 21 Jul 2021 22:43:24 -0700
...
Subject: [PATCH V9 15/18] KVM: x86/pmu: Disable guest PEBS temporarily in two rare situations
Date:   Thu, 22 Jul 2021 13:41:56 +0800
Message-Id: <20210722054159.4459-16-lingshan.zhu@intel.com>
...
index 71622bf4c4dd..8a467f7fdfb2 100644
--- a/arch/x86/events/intel/core.c
+++ b/arch/x86/events/intel/core.c
@@ -3972,8 +3972,15 @@ static struct perf_guest_switch_msr *intel_guest_get_msrs(int *nr, void *data)
...
index 3979a947933a..f8343cb18f37 100644
