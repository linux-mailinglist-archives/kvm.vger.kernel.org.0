...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 53D716797BC
	for <lists+kvm@lfdr.de>; Tue, 24 Jan 2023 13:21:10 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233797AbjAXMVJ (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Tue, 24 Jan 2023 07:21:09 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59188 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233796AbjAXMVB (ORCPT <rfc822;kvm@vger.kernel.org>);
        Tue, 24 Jan 2023 07:21:01 -0500
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E24FD457E9
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        ...
        bh=2mvtR8plaSUEm2KLp1UCDV8gkGDz70/i5jrg9kpI5Lw=;
        b=XrUF5aAIlwdHGL2AtiPESBfLfpXKnxpKnO8AakG3NvAXD3i3rQEOy2ftwCMW5ZMiiV1hv1
        VdIvBQXBSBJG+4FKg8AIbthi1jOqnN3Lf3T+ILYBVrmqswAzr1m4YmfnS04eyISK+9lGqd
        nCA0/J8mtbKtC7QLZ8hzZYAzbPiCgl4=
Received: from mimecast-mx02.redhat.com (mimecast-mx02.redhat.com
 [66.187.233.88]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-581-rEFbz2xPNCunNFiF2wLnYw-1; Tue, 24 Jan 2023 07:19:51 -0500
X-MC-Unique: rEFbz2xPNCunNFiF2wLnYw-1
Received: from smtp.corp.redhat.com (int-mx08.intmail.prod.int.rdu2.redhat.com [10.11.54.8])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 3250718A6472;
        Tue, 24 Jan 2023 12:19:51 +0000 (UTC)
Received: from blackfin.pond.sub.org (unknown [10.39.192.70])
        by smtp.corp.redhat.com (Postfix) with ESMTPS id 89E9BC15BA0;
        Tue, 24 Jan 2023 12:19:50 +0000 (UTC)
Received: by blackfin.pond.sub.org (Postfix, from userid 1000)
        id B476621E691B; Tue, 24 Jan 2023 13:19:46 +0100 (CET)
...
Subject: [PATCH 17/32] migration: Move HMP commands from monitor/ to migration/
Date:   Tue, 24 Jan 2023 13:19:31 +0100
...
---
 ...
 monitor/hmp-cmds.c             | 703 ----------------------------
 monitor/misc.c                 |  82 ----
 migration/meson.build          |   1 +
 4 files changed, 808 insertions(+), 785 deletions(-)
 create mode 100644 migration/migration-hmp-cmds.c

diff --git a/migration/migration-hmp-cmds.c b/migration/migration-hmp-cmds.c
new file mode 100644
index 0000000000..ef25bc8929
--- /dev/null
...
index b059af7abd..4da6b7cccc 100644
...
-#include "migration/misc.h"
 ...
 {
@@ -111,324 +101,6 @@ void hmp_info_status(Monitor *mon, const QDict *qdict)
...
@@ -571,305 +243,6 @@ void hmp_cont(Monitor *mon, const QDict *qdict)
     hmp_handle_error(mon, err);
 }
...
@@ -891,82 +264,6 @@ void hmp_change(Monitor *mon, const QDict *qdict)
     hmp_handle_error(mon, err);
 }
...
index 77a76b2b5f..780f2a6b04 100644
--- a/monitor/misc.c
+++ b/monitor/misc.c
@@ -41,7 +41,6 @@
 #include "monitor/hmp.h"
...
-#include "block/qapi.h"
 ...
 #include "qapi/qapi-commands-control.h"
 #include "qapi/qapi-commands-migration.h"
@@ -1362,87 +1361,6 @@ void watchdog_action_completion(ReadLineState *rs, int nb_args, const char *str)
     }
 }
...
index 690487cf1a..a9e7e18793 100644
