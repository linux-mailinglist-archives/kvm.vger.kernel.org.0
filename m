Return-Path: <kvm+bounces-65339-lists+kvm=lfdr.de@vger.kernel.org>
X-Original-To: lists+kvm@lfdr.de
Delivered-To: lists+kvm@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [172.105.105.114])
	by mail.lfdr.de (Postfix) with ESMTPS id F06B1CA706E
	for <lists+kvm@lfdr.de>; Fri, 05 Dec 2025 10:56:38 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id CD4D139A9232
	for <lists+kvm@lfdr.de>; Fri,  5 Dec 2025 08:40:57 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 2BBF732860E;
	Fri,  5 Dec 2025 08:15:26 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b="KMhpbnK1"
X-Original-To: kvm@vger.kernel.org
Received: from mail-pj1-f74.google.com (mail-pj1-f74.google.com [209.85.216.74])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A72CE1D5CEA
	for <kvm@vger.kernel.org>; Fri,  5 Dec 2025 08:14:56 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.216.74
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1764922512; cv=none; b=iB0d32+eDx6is2MmxuHbDxlAT28JkkeyoBW3fQhcn1Rpn1fMNG1VcMizqSTQivI8M1v/LBMJjZoeTHtvFinAcaQ0gWOrfIgkZ7zVhcoC6YUNazyex1vmH7Ac4EHhWLbyqUpr7fiMzdHorOjWx20iEk5rwqcCiq6da03fgg2g3vA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1764922512; c=relaxed/simple;
	bh=Igfr9FW+KmyTlZ9iAwlpuwagrbjJS3n7xHM51/mhOTo=;
	h=Date:In-Reply-To:Mime-Version:References:Message-ID:Subject:From:
	 To:Cc:Content-Type; b=hA1Rwt8T+Jj8LNK48CLLqoEsGWvuSvqTcK43cpNlEOXBgnSt19Jtfz7p3lT6xne0UwrCFLg8c1gwkX6TFzcwYM03/08HgHZOzcvJ8M8h4x7Ki/4fZ4Xyd4RD4kT+9bEBGMLRQ3xcGwcxwmfMD3SCi9TpqibH3fr6oOjmo0eC1yQ=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com; spf=pass smtp.mailfrom=flex--chengkev.bounces.google.com; dkim=pass (2048-bit key) header.d=google.com header.i=@google.com header.b=KMhpbnK1; arc=none smtp.client-ip=209.85.216.74
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=google.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=flex--chengkev.bounces.google.com
Received: by mail-pj1-f74.google.com with SMTP id 98e67ed59e1d1-3438744f12fso4703344a91.2
        for <kvm@vger.kernel.org>; Fri, 05 Dec 2025 00:14:56 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1764922493; x=1765527293; darn=vger.kernel.org;
        h=cc:to:from:subject:message-id:references:mime-version:in-reply-to
         :date:from:to:cc:subject:date:message-id:reply-to;
        bh=IUvvvCBHNNoC1LgckOuWigEL11VxlQY1p2ZyqITLXPM=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1764922493; x=1765527293;
        h=cc:to:from:subject:message-id:references:mime-version:in-reply-to
         :date:x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=IUvvvCBHNNoC1LgckOuWigEL11VxlQY1p2ZyqITLXPM=;
        b=
X-Gm-Message-State: AOJu0Yzsvp8IbaE9fVnOURvmAIjdJAkr3HDXX86WN0KkxP1UK4Art74v
	ivqtRrPYauorvl6fhKEqHWcRmlPXJHIWe/9hEmWhsyiHNwcMvVMRDlnl2JHJRvYZ0fvFcMqVO6K
	ANAEBLi2akyfr2KmERZK/uyJcn6LcRokQUv5Zwb5QL49+AwhdQO7gMUOPH7lQKwACHMULJusJ1w
	9lZWUR+35HcXqwUzzwP+v2/Z6Pxwq8rIJVslCiQNARLPE=
X-Google-Smtp-Source: AGHT+IELNGiiAxvTyAKqtuxUPNS5jOotHIdXjBp3cnhLzYURkdjEfRAzndlBCfFaY8uYQVEXF0sLVcVpn50Ekw==
X-Received: from pjoo5.prod.google.com ([2002:a17:90b:5825:b0:340:bc7b:2b2f])
 (user=chengkev job=prod-delivery.src-stubby-dispatcher) by
 2002:a17:90b:4c0a:b0:340:e517:4e05 with SMTP id 98e67ed59e1d1-34947d88b0bmr7030775a91.12.1764922492841;
 Fri, 05 Dec 2025 00:14:52 -0800 (PST)
Date: Fri,  5 Dec 2025 08:14:47 +0000
...
Message-ID: <20251205081448.4062096-2-chengkev@google.com>
Subject: [kvm-unit-tests PATCH 1/2] x86/svm: Add missing svm intercepts
...
+	u32 saved_intercept = vmcb->control.intercept[INTERCEPT_WORD3];
...
+	vmcb->control.intercept[INTERCEPT_WORD3] = saved_intercept;
 }
 
 /*
@@ -2811,7 +2810,7 @@ static void vmload_vmsave_guest_main(struct svm_test *test)
 
 static void svm_vmload_vmsave(void)
 {
-	u32 intercept_saved = vmcb->control.intercept;
+	u32 intercept_saved = vmcb->control.intercept[INTERCEPT_WORD4];
...
+	vmcb->control.intercept[INTERCEPT_WORD4] = intercept_saved;
 }
...
@@ -3472,7 +3471,7 @@ static void svm_intr_intercept_mix_smi_guest(struct svm_test *test)
