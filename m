...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 85A396AFE52
	for <lists+kvm@lfdr.de>; Wed,  8 Mar 2023 06:25:38 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229730AbjCHFZg (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Wed, 8 Mar 2023 00:25:36 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:37158 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229755AbjCHFZ1 (ORCPT <rfc822;kvm@vger.kernel.org>);
        Wed, 8 Mar 2023 00:25:27 -0500
Received: from NAM12-MW2-obe.outbound.protection.outlook.com (mail-mw2nam12on2071.outbound.protection.outlook.com [40.107.244.71])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id F0B8B99BC8;
        Tue,  7 Mar 2023 21:25:15 -0800 (PST)
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=u5duFGoDm8NjWwNX8zQrLCukkTjU9/LtFDSdoIw6A5o=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=amd.com; s=selector1;
 ...
 bh=u5duFGoDm8NjWwNX8zQrLCukkTjU9/LtFDSdoIw6A5o=;
 b=ycvZFopN0QLRnyH1kRvADRrH4W29diZ6YjG5BCIh3q8vsosg8nSzQ8WVda9dlsKwK7A7ITgqaCnMNPSKtjzlGcc3maSn+0oS/uE8eqXe2opebD2TJbOyActJ2LijQCsAWtnLj7Rugn2qIlr0eqwOFRBMz9+/L6IfZuRMrTJC5/4=
...
Received: from BN8NAM11FT106.eop-nam11.prod.protection.outlook.com
 (2603:10b6:408:fd:cafe::b0) by BN9PR03CA0106.outlook.office365.com
 ...
 Transport; Wed, 8 Mar 2023 05:25:12 +0000
...
Received: from SATLEXMB04.amd.com (165.204.84.17) by
 ...
 15.20.6178.17 via Frontend Transport; Wed, 8 Mar 2023 05:25:12 +0000
...
CC:     <brett.creeley@amd.com>, <shannon.nelson@amd.com>,
        <drivers@pensando.io>
Subject: [RFC PATCH v4 4/7] vfio/pds: Add VFIO live migration support
Date:   Tue, 7 Mar 2023 21:24:47 -0800
Message-ID: <20230308052450.13421-5-brett.creeley@amd.com>
...
X-MS-TrafficTypeDiagnostic: BN8NAM11FT106:EE_|MN2PR12MB4375:EE_
X-MS-Office365-Filtering-Correlation-Id: a6ea30fc-afdb-48ad-20ce-08db1f957dc8
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-Forefront-Antispam-Report: CIP:165.204.84.17;CTRY:US;LANG:en;SCL:1;SRV:;IPV:CAL;SFV:NSPM;H:SATLEXMB04.amd.com;PTR:InfoDomainNonexistent;CAT:NONE;SFS:(13230025)(4636009)(39860400002)(136003)(346002)(376002)(396003)(451199018)(46966006)(36840700001)(40470700004)(36756003)(316002)(110136005)(336012)(54906003)(83380400001)(40480700001)(82310400005)(86362001)(70206006)(186003)(16526019)(41300700001)(70586007)(44832011)(5660300002)(26005)(30864003)(2906002)(36860700001)(8676002)(4326008)(478600001)(6666004)(1076003)(426003)(2616005)(8936002)(47076005)(82740400003)(81166007)(356005)(40460700003)(36900700001);DIR:OUT;SFP:1101;
X-OriginatorOrg: amd.com
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 08 Mar 2023 05:25:12.3444
 (UTC)
X-MS-Exchange-CrossTenant-Network-Message-Id: a6ea30fc-afdb-48ad-20ce-08db1f957dc8
...
index e30ecea91e09..3acf859123f4 100644
...
+			       &cmd, resp, !!(flags & PDS_AQ_FLAG_FASTPOLL));
+	if (err && err != -EAGAIN)
...
+
 ...
 {
@@ -64,3 +93,296 @@ pds_vfio_unregister_client_cmd(struct pds_vfio_pci_device *pds_vfio)
...
index 5efc54a7b9b9..87307a306961 100644
--- a/drivers/vfio/pci/pds/cmds.h
+++ b/drivers/vfio/pci/pds/cmds.h
@@ -8,5 +8,11 @@ struct pds_vfio_pci_device;
...
index 000000000000..ebfc5dad351d
--- /dev/null
...
new file mode 100644
index 000000000000..e31f64eaa842
--- /dev/null
...
index b1e5ea854200..ec741613f46b 100644
--- a/drivers/vfio/pci/pds/pci_drv.c
+++ b/drivers/vfio/pci/pds/pci_drv.c
@@ -33,6 +33,7 @@ pds_vfio_pci_probe(struct pci_dev *pdev,
...
@@ -70,12 +71,27 @@ pds_vfio_pci_table[] = {
 };
...
index 592b10a279f0..6d2d6d5f9012 100644
...
index 614640194c36..5ca2443e2d41 100644
