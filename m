 mm24-20020a056a209f9800b0019eca3a612bmr21003803pzb.54.1708523993603; Wed, 21
 Feb 2024 05:59:53 -0800 (PST)
Precedence: bulk
...
Date: Wed, 21 Feb 2024 21:59:42 +0800
Message-ID: <CABOYnLzuvvsiaWTp=6PaAwBcpV2JDG0wa66tQqgMynVRuFi93g@mail.gmail.com>
Subject: Re: [syzbot] [kvm?] KMSAN: uninit-value in em_ret_near_imm
To: syzbot+c9aca2253922f806a75a@syzkaller.appspotmail.com
...
kernel version: 0f1dd5e91e2ba3990143645faff2bcce2d99778e
...
static void setup_syscall_msrs(int cpufd,
                               uint16_t sel_cs,
...
static void setup_32bit_idt(struct kvm_sregs* sregs,
                            char* host_mem,
                            uintptr_t guest_mem) {
...
static void setup_64bit_idt(struct kvm_sregs* sregs,
                            char* host_mem,
                            uintptr_t guest_mem) {
  sregs->idt.base = guest_mem + ADDR_VAR_IDT;
  sregs->idt.limit = 0x1ff;
...
static volatile long syz_kvm_setup_cpu(volatile long a0,
                                       volatile long a1,
                                       volatile long a2,
                                       volatile long a3,
                                       volatile long a4,
...
void execute_one(void) {
  ...
  *(uint64_t*)0x20000198 = 0x20000000;
  syscall(__NR_ioctl, /*fd=*/r[1], /*cmd=*/0x4020ae46, /*arg=*/0x20000180ul);
  *(uint32_t*)0x20000640 = 0;
  *(uint32_t*)0x20000644 = 3;
  *(uint64_t*)0x20000648 = 0x20000040;
  memcpy((void*)0x20000040, "\xa6\x13\xee\xc2", 4);
  ...
  *(uint64_t*)0x200016d0 = 0;
  syz_kvm_setup_cpu(/*fd=*/-1, /*cpufd=*/r[2], /*usermem=*/0x20fe7000,
                    /*text=*/0x200016c0, /*ntext=*/1, /*flags=*/0, /*opts=*/0,
                    /*nopt=*/0);
...
bpf$PROG_LOAD(0x5, &(0x7f0000000640)={0x0, 0x3,
&(0x7f0000000040)=ANY=[@ANYBLOB="a613eec2"], 0x0}, 0x90)
syz_kvm_setup_cpu$x86(0xffffffffffffffff, r2,
&(0x7f0000fe7000/0x18000)=nil, &(0x7f00000016c0)=[@text16={0x10,
0x0}], 0x1, 0x0, 0x0, 0x0)
ioctl$KVM_RUN(r2, 0xae80, 0x0)
ioctl$KVM_RUN(r2, 0xae80, 0x0)

and see also in
https://gist.github.com/xrivendell7/2f06246914a2b279ebed56e7cb7a4449.
