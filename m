...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id E4F0A2C5D9F
	for <lists+kvm@lfdr.de>; Thu, 26 Nov 2020 22:49:21 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2387747AbgKZVso (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Thu, 26 Nov 2020 16:48:44 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49200 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726178AbgKZVsn (ORCPT <rfc822;kvm@vger.kernel.org>);
        Thu, 26 Nov 2020 16:48:43 -0500
Received: from merlin.infradead.org (merlin.infradead.org [IPv6:2001:8b0:10b:1231::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 7525EC0613D4
        for <kvm@vger.kernel.org>; Thu, 26 Nov 2020 13:48:43 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        d=infradead.org; s=merlin.20170209; h=Mime-Version:Content-Type:References:
        In-Reply-To:Date:Cc:To:From:Subject:Message-ID:Sender:Reply-To:
        Content-Transfer-Encoding:Content-ID:Content-Description;
        bh=2NxskwwXj6JKO6WeYrz+qbTBn3wJ/RAiu2A7wUf1Cik=; b=QWrduoImx9XhhSRvZmzDMATE3J
        ;
Received: from [54.239.6.185] (helo=freeip.amazon.com)
        by merlin.infradead.org with esmtpsa (Exim 4.92.3 #3 (Red Hat Linux))
        id 1kiP7w-00047k-Ok; Thu, 26 Nov 2020 21:48:33 +0000
Message-ID: <6e7060415fe321a3969a76330b643116a5ab44d1.camel@infradead.org>
...
Date:   Thu, 26 Nov 2020 21:48:29 +0000
...
> > > > LAPIC should be irrelevant when deciding to exit to userspace.  Not=
e, the
> > > > reinjection check covers vcpu->arch.interrupt.injected for the case=
 where LAPIC
> > > > is in userspace.
> > > >=20
> > > >           return kvm_arch_interrupt_allowed(vcpu) &&
> > > >                  (!lapic_in_kernel(vcpu) || !kvm_cpu_has_extint(vcp=
u)) &&
...
'clearcpuid=3D450'. That's clearing the ARAT bit to force it to use the
HPET+MSI for timers.

The earlier one that had failed was 'noapic clearcpuid=3D450'. So that
...
> !kvm_cpu_has_injectable_intr(vcpu) boils down (assuming no nested virt) t=
o
>=20
...
>=20
> But it turns out that with some more inlining and Boolean algebra, we=20
> can actually figure out what the code does. :)  I had just finished=20
...
MTI2MjE0ODI5WjAvBgkqhkiG9w0BCQQxIgQgRLMXMh9I82c8k9enykSGEH7mzwUcp7ISQhhtocYO
tr8wgb4GCSsGAQQBgjcQBDGBsDCBrTCBlzELMAkGA1UEBhMCR0IxGzAZBgNVBAgTEkdyZWF0ZXIg
...

