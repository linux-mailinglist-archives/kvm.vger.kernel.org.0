...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 4398757EADD
	for <lists+kvm@lfdr.de>; Sat, 23 Jul 2022 02:53:41 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S237098AbiGWAxj (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Fri, 22 Jul 2022 20:53:39 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57784 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236941AbiGWAxO (ORCPT <rfc822;kvm@vger.kernel.org>);
        Fri, 22 Jul 2022 20:53:14 -0400
Received: from mail-yw1-x114a.google.com (mail-yw1-x114a.google.com [IPv6:2607:f8b0:4864:20::114a])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E17E389AB4
        for <kvm@vger.kernel.org>; Fri, 22 Jul 2022 17:52:23 -0700 (PDT)
Received: by mail-yw1-x114a.google.com with SMTP id 00721157ae682-31e559f6840so50446577b3.6
        for <kvm@vger.kernel.org>; Fri, 22 Jul 2022 17:52:23 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20210112;
        h=reply-to:date:in-reply-to:message-id:mime-version:references
         :subject:from:to:cc;
        bh=D4NuN+fMqTWypgZwou/P67mZqvTtL5kh4ARQwWI8a1M=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=D4NuN+fMqTWypgZwou/P67mZqvTtL5kh4ARQwWI8a1M=;
        b=
X-Gm-Message-State: AJIora9PKmg7Ko/H12mWjXb912mz1MCmyWQemetBYTMUu+TF9Qbw4Kp1
        ygKBLOxl+G7ArJ0vlNtXLQ0qYXPJ8Xs=
X-Google-Smtp-Source: AGRyM1svvl2VJUNIIVrGAaMYT0m5YnUBDYXYYWy6fttZVngBOHPKelquCkGj2S7rjfvS0JIjahcwVGVX7M8=
X-Received: from zagreus.c.googlers.com ([fda3:e722:ac3:cc00:7f:e700:c0a8:5c37])
 (user=seanjc job=sendgmr) by 2002:a0d:d904:0:b0:31e:6072:3a94 with SMTP id
 b4-20020a0dd904000000b0031e60723a94mr2136619ywe.214.1658537532327; Fri, 22
 Jul 2022 17:52:12 -0700 (PDT)
Reply-To: Sean Christopherson <seanjc@google.com>
Date:   Sat, 23 Jul 2022 00:51:32 +0000
In-Reply-To: <20220723005137.1649592-1-seanjc@google.com>
Message-Id: <20220723005137.1649592-20-seanjc@google.com>
Mime-Version: 1.0
References: <20220723005137.1649592-1-seanjc@google.com>
X-Mailer: git-send-email 2.37.1.359.gd136c6c3e2-goog
Subject: [PATCH v4 19/24] KVM: x86: Morph pending exceptions to pending
...
@@ -4067,13 +4047,18 @@ static int vmx_check_nested_events(struct kvm_vcpu *vcpu)
 		return 0;
 	}
...
@@ -6946,8 +6931,8 @@ __init int nested_vmx_hardware_setup(int (*exit_handlers[])(struct kvm_vcpu *))
...
index 4cfe6646476b..cf8877c545ce 100644
...
+	WARN_ON(kvm_is_exception_pending(vcpu));
 ...
 out:
@@ -10852,6 +10896,7 @@ static void kvm_put_guest_fpu(struct kvm_vcpu *vcpu)
...
@@ -10910,6 +10955,21 @@ int kvm_arch_vcpu_ioctl_run(struct kvm_vcpu *vcpu)
 		}
 	}
...
@@ -11016,6 +11076,7 @@ static void __set_regs(struct kvm_vcpu *vcpu, struct kvm_regs *regs)
...
@@ -11383,7 +11444,7 @@ int kvm_arch_vcpu_ioctl_set_guest_debug(struct kvm_vcpu *vcpu,
