Return-Path: <kvm+bounces-43957-lists+kvm=lfdr.de@vger.kernel.org>
X-Original-To: lists+kvm@lfdr.de
Delivered-To: lists+kvm@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 9142FA9917F
	for <lists+kvm@lfdr.de>; Wed, 23 Apr 2025 17:31:34 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id CA0041BA3DF7
	for <lists+kvm@lfdr.de>; Wed, 23 Apr 2025 15:23:05 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 67A0629A3ED;
	Wed, 23 Apr 2025 15:15:18 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="J2cvUbvV"
X-Original-To: kvm@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8DD692989AE;
	Wed, 23 Apr 2025 15:15:17 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1745421317; cv=none; b=QOzbiGAcyGvyeZxGI7RJamYsmMM3LdqF259XPFOn29F157rsxCstG3NRYV0je2a1GGlOkclVM957RR/Iu1InwK6S6fcfbNAbZDk9cU2ypXi4RAgkJqITzdOZqMr85ZBOixfpxMuMJOGUVTzsHTCvSdgf8D1H0Ksw22DED5lY//0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1745421317; c=relaxed/simple;
	bh=VfeX1dAcpI36M47Ggd6Q5nFJUQWZ4sAyBeCDM32vqgw=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=blXqDJJM0221a4UlpWYffO7wo4k1Ukc/LI4auykY8w3OKq5LwGjWm4kx+TxX3nx/PFSLWKJ/UWUU8PZo2S0rXBvllzr99uFwL4gkrgFcB44CBBF4hJbB9mrlCBe0YGKHhDg932xg6f6LuCZNVlo/Omee9+V7BpeyFVzB8ZviLQI=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=J2cvUbvV; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 42DC0C4CEE8;
	Wed, 23 Apr 2025 15:15:17 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1745421317;
	bh=VfeX1dAcpI36M47Ggd6Q5nFJUQWZ4sAyBeCDM32vqgw=;
	h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
	b=
...
Subject: [PATCH v3 09/17] KVM: arm64: nv: Handle VNCR_EL2-triggered faults
Date: Wed, 23 Apr 2025 16:15:00 +0100
Message-Id: <20250423151508.2961768-10-maz@kernel.org>
...
index 810aa668e1f3a..c97e4119d81ad 100644
--- a/arch/arm64/kvm/nested.c
+++ b/arch/arm64/kvm/nested.c
@@ -882,6 +882,165 @@ int kvm_vcpu_allocate_vncr_tlb(struct kvm_vcpu *vcpu)
 	return 0;
 }
