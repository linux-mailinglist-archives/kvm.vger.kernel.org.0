...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id D27E310D909
	for <lists+kvm@lfdr.de>; Fri, 29 Nov 2019 18:26:41 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727493AbfK2R0h (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Fri, 29 Nov 2019 12:26:37 -0500
Received: from mga14.intel.com ([192.55.52.115]:64172 "EHLO mga14.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727175AbfK2RZe (ORCPT <rfc822;kvm@vger.kernel.org>);
        Fri, 29 Nov 2019 12:25:34 -0500
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
  by fmsmga103.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384; 29 Nov 2019 09:25:34 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.69,257,1571727600"; 
   d="scan'208";a="241108982"
Received: from unknown (HELO local-michael-cet-test.sh.intel.com) ([10.239.159.128])
  by fmsmga002.fm.intel.com with ESMTP; 29 Nov 2019 09:25:33 -0800
...
Subject: [PATCH v8 04/10] mmu: spp: Add functions to operate SPP access bitmap
Date:   Sat, 30 Nov 2019 01:27:03 +0800
Message-Id: <20191129172709.11347-5-weijiang.yang@intel.com>
...
index 7713f34dcc8d..c06831b9027a 100644
...
+
 ...
 {
@@ -220,6 +231,279 @@ int kvm_spp_setup_structure(struct kvm_vcpu *vcpu,
 }
...
+				if (kvm_spp_mark_protection(kvm, gfn, access_map[i]) < 0)
+					return -EFAULT;
+				break;
+			} else if (is_large_pte(*iterator.sptep)) {
+				count = kvm_spp_zap_entry(kvm, gfn, gfn_max,
+							  iterator.sptep,
+							  iterator.level);
+				if (count >= npages)
+					goto out;
...
index 5e3f12d5359e..8d59848b3451 100644
