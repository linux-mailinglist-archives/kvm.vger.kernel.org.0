Return-Path: <kvm+bounces-4886-lists+kvm=lfdr.de@vger.kernel.org>
X-Original-To: lists+kvm@lfdr.de
Delivered-To: lists+kvm@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id C3E6281964B
	for <lists+kvm@lfdr.de>; Wed, 20 Dec 2023 02:32:17 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 3896FB245AD
	for <lists+kvm@lfdr.de>; Wed, 20 Dec 2023 01:32:15 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id DFA101F922;
	Wed, 20 Dec 2023 01:29:13 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="cRLkuRHu"
X-Original-To: kvm@vger.kernel.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.10])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 0005D1EA73;
	Wed, 20 Dec 2023 01:29:10 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=none smtp.mailfrom=linux.intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1703035751; x=1734571751;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=wdvw7IYhSwip0Duj/qh5CupDu3Fu4nGKXEerFiQKvSU=;
  b=cRLkuRHu8C+7VZNiFljZKiYaDLRI9WVTYP3qeBtsmrrrcnHAbFu5QRSy
   zlERYq1rx3yljwVTkix099U0j128cPMPT/D6bnHexY5bplNy5MIFSjX2v
   bOybLjo7Lw+sl9GfMcL7vHOKN/06FfPWtCfIDe8Oo+cH2/jzHuNy6wwqh
   VeKH/e3BfpWaL2xrj1tJO5jPVWVjdS+xZ7a8l+nRFZb4SwAhR30QB+MVU
   TkH1kvJctf1R9ZRqrY4Ut3pUes6KyR/V+qEOG9o8A5enzIBMswFpJTqI4
   CuJMflYSBbxJA1xYxNN5V5BUizpdmhC2RgGa0A8gWNP9KPthn66dRI3FZ
   A==;
X-IronPort-AV: E=McAfee;i="6600,9927,10929"; a="2965832"
X-IronPort-AV: E=Sophos;i="6.04,290,1695711600"; 
   d="scan'208";a="2965832"
Received: from fmsmga006.fm.intel.com ([10.253.24.20])
  by fmvoesa104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 19 Dec 2023 17:29:10 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10929"; a="1023319185"
X-IronPort-AV: E=Sophos;i="6.04,290,1695711600"; 
   d="scan'208";a="1023319185"
Received: from allen-box.sh.intel.com ([10.239.159.127])
  by fmsmga006.fm.intel.com with ESMTP; 19 Dec 2023 17:29:06 -0800
...
Subject: [PATCH v9 10/14] iommu: Separate SVA and IOPF
Date: Wed, 20 Dec 2023 09:23:28 +0800
Message-Id: <20231220012332.168188-11-baolu.lu@linux.intel.com>
...
index d90168d635cd..dbad2cb9eca2 100644
--- a/include/linux/iommu.h
+++ b/include/linux/iommu.h
@@ -733,10 +733,6 @@ extern struct iommu_group *iommu_group_get(struct device *dev);
...
@@ -952,8 +948,6 @@ bool iommu_group_dma_owner_claimed(struct iommu_group *group);
...
@@ -1142,18 +1136,6 @@ static inline void iommu_group_put(struct iommu_group *group)
 {
 }
...
-
 ...
 {
 	return -ENODEV;
@@ -1302,12 +1284,6 @@ static inline int iommu_device_claim_dma_owner(struct device *dev, void *owner)
 	return -ENODEV;
 }
...
-
 static inline int iommu_attach_device_pasid(struct iommu_domain *domain,
 					    struct device *dev, ioasid_t pasid)
 {
@@ -1447,6 +1423,8 @@ struct iommu_sva *iommu_sva_bind_device(struct device *dev,
 					struct mm_struct *mm);
...
@@ -1471,6 +1449,78 @@ static inline u32 mm_get_enqcmd_pasid(struct mm_struct *mm)
 }
