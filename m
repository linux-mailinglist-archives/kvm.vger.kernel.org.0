...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id B0CADE9704
	for <lists+kvm@lfdr.de>; Wed, 30 Oct 2019 08:08:17 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726269AbfJ3HIM (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Wed, 30 Oct 2019 03:08:12 -0400
Received: from us-smtp-delivery-1.mimecast.com ([205.139.110.120]:29371 "EHLO
        us-smtp-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
        with ESMTP id S1726177AbfJ3HIL (ORCPT <rfc822;kvm@vger.kernel.org>);
        Wed, 30 Oct 2019 03:08:11 -0400
...
References: <20191029100734.9861-1-tiwei.bie@intel.com>
 <e653058c-d480-2195-8915-7bf7378ac76e@redhat.com> <20191030055228.GA9578@___>
...
On 2019/10/30 =E4=B8=8B=E5=8D=881:52, Tiwei Bie wrote:
...
>>>  {
>>>  =09return &mdev->dev;
>>> diff --git a/drivers/vfio/mdev/mdev_private.h b/drivers/vfio/mdev/mdev_=
private.h
...
ev);
>>> +=09const struct virtio_mdev_device_ops *ops =3D mdev_get_vhost_ops(m->=
mdev);
>>> +
...
>>> +=09const struct virtio_mdev_device_ops *ops =3D mdev_get_vhost_ops(mde=
v);
>>> +
...
>>> =20
>>> @@ -133,6 +137,7 @@ struct mdev_device *mdev_from_dev(struct device *de=
v);
>>>  enum {
...
>>> +#define VHOST_MDEV_GET_CONFIG=09=09_IOR(VHOST_VIRTIO, 0x73, struct vho=
st_mdev_config)
>>> +#define VHOST_MDEV_SET_CONFIG=09=09_IOW(VHOST_VIRTIO, 0x74, struct vho=
st_mdev_config)
