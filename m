...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 5948F76679F
	for <lists+kvm@lfdr.de>; Fri, 28 Jul 2023 10:47:23 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235135AbjG1IrV (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Fri, 28 Jul 2023 04:47:21 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44426 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235126AbjG1IrE (ORCPT <rfc822;kvm@vger.kernel.org>);
        Fri, 28 Jul 2023 04:47:04 -0400
Received: from dfw.source.kernel.org (dfw.source.kernel.org [IPv6:2604:1380:4641:c500::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 16A9E3A9A
        for <kvm@vger.kernel.org>; Fri, 28 Jul 2023 01:47:00 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (2048 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id 1AAFC62066
        for <kvm@vger.kernel.org>; Fri, 28 Jul 2023 08:47:00 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 5CCACC433C8;
        Fri, 28 Jul 2023 08:46:59 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1690534019;
        bh=bHpj6N/FEODPnzUn8xF8qOZdPGfMa2Al1EJQuyeqD7A=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
...
Subject: [PATCH v2 17/26] KVM: arm64: nv: Add trap forwarding for MDCR_EL2
Date:   Fri, 28 Jul 2023 09:29:43 +0100
Message-Id: <20230728082952.959212-18-maz@kernel.org>
...
index 094534aa0f72..339976764ac5 100644
...
@@ -256,6 +273,72 @@ static const struct trap_bits coarse_trap_bits[] = {
 		.mask		= HCR_TTLBOS,
...
+	},
 ...
 #define MCB(id, ...)					\
@@ -273,6 +356,11 @@ static const enum trap_group *coarse_control_combo[] = {
...
@@ -605,6 +693,183 @@ static const struct encoding_to_trap_config encoding_to_cgt[] __initconst = {
