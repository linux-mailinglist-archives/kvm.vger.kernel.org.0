...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 9DB421591FC
	for <lists+kvm@lfdr.de>; Tue, 11 Feb 2020 15:31:48 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730055AbgBKObq (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Tue, 11 Feb 2020 09:31:46 -0500
Received: from us-smtp-2.mimecast.com ([207.211.31.81]:21820 "EHLO
        us-smtp-delivery-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S1728339AbgBKObp (ORCPT
        <rfc822;kvm@vger.kernel.org>); Tue, 11 Feb 2020 09:31:45 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1581431504;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references:autocrypt:autocrypt;
        bh=VvTMaGNXyf8PVkEC7Q2RBDrj54WT59+BDG8zsIYgTMU=;
        b=JXrvc2GYaCfbz4UZ3Qx+tAZsIzewidmcXY0u+PgpA8L1VefsPCBnp9Ro2Nz7Ej8bE5LOBY
        2AcWbPbZCpd57ROGQZMvXY42AmEKcR65ATeKUeSjevpicgIO0QNjpsUS9DYsY8VbwurbHg
        zGXUUtBsH6uCgYQCObgA/PdMJOgp+DE=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-137-aBbwiHPRO7u15LvJOCrgdQ-1; Tue, 11 Feb 2020 09:31:37 -0500
X-MC-Unique: aBbwiHPRO7u15LvJOCrgdQ-1
Received: from smtp.corp.redhat.com (int-mx08.intmail.prod.int.phx2.redhat.com [10.5.11.23])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id DC124107ACCA;
        Tue, 11 Feb 2020 14:31:34 +0000 (UTC)
Received: from [10.36.117.14] (ovpn-117-14.ams2.redhat.com [10.36.117.14])
        by smtp.corp.redhat.com (Postfix) with ESMTP id 8882926FD7;
        Tue, 11 Feb 2020 14:31:19 +0000 (UTC)
...
>>>> Michael? I think free page reporting is special and shall be left al=
one.
>>>
...
>>
>>>
>>>> VIRTIO_BALLOON_F_REPORTING is nothing but a more advanced inflate, r=
ight
...
> Spec also says:
> The device is driven either by the receipt of a configuration change no=
tification, or by changing guest memory
> needs, such as performing memory compaction or responding to out of mem=
ory conditions.
>=20
> so ignoring compaction/oom (later is under-specified, not a good exampl=
e
