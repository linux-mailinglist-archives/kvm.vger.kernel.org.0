...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0376835764F
	for <lists+kvm@lfdr.de>; Wed,  7 Apr 2021 22:50:36 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231281AbhDGUuo (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Wed, 7 Apr 2021 16:50:44 -0400
Received: from mga05.intel.com ([192.55.52.43]:47246 "EHLO mga05.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S231420AbhDGUuf (ORCPT <rfc822;kvm@vger.kernel.org>);
        Wed, 7 Apr 2021 16:50:35 -0400
IronPort-SDR: Bsid/O0GXGDJypJdoBBNx80eQOpEIg7Yu/x2MOCATKP9y6aDOIn7YshNIjsdv3TgWqMT2rCKI/
 6d8JjsLJiWQg==
X-IronPort-AV: E=McAfee;i="6000,8403,9947"; a="278660391"
X-IronPort-AV: E=Sophos;i="5.82,204,1613462400"; 
   d="scan'208";a="278660391"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
  by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 07 Apr 2021 13:50:24 -0700
IronPort-SDR: unI81cQmwBh6e//jtVLqA2sgPHfSEW3JQvxFclwTWPj1sWYj0ah3dRonNoYbbKOc5pKaTt1XR1
 ZG+Mg3P2Dhpg==
X-IronPort-AV: E=Sophos;i="5.82,204,1613462400"; 
   d="scan'208";a="415437465"
Received: from tkokeray-mobl.amr.corp.intel.com (HELO khuang2-desk.gar.corp.intel.com) ([10.254.113.100])
  by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 07 Apr 2021 13:50:21 -0700
...
Subject: [PATCH v4 08/11] KVM: VMX: Add emulation of SGX Launch Control LE hash MSRs
Date:   Thu,  8 Apr 2021 08:49:32 +1200
Message-Id: <ebe348a4bbc15d2014183165c8ccac26db5be543.1617825858.git.kai.huang@intel.com>
...
index b74537be7fe8..fb729e5c6949 100644
...
@@ -322,3 +325,35 @@ int handle_encls(struct kvm_vcpu *vcpu)
 	}
 	return 1;
 }
+
