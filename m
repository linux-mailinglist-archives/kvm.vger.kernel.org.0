...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 36E5AE18A7
	for <lists+kvm@lfdr.de>; Wed, 23 Oct 2019 13:19:51 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2404738AbfJWLT3 (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Wed, 23 Oct 2019 07:19:29 -0400
Received: from us-smtp-1.mimecast.com ([205.139.110.61]:40303 "EHLO
        us-smtp-delivery-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S2404726AbfJWLT2 (ORCPT
        <rfc822;kvm@vger.kernel.org>); Wed, 23 Oct 2019 07:19:28 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1571829566;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references:openpgp:openpgp:autocrypt:autocrypt;
        bh=DawaJQYhTc5IZN3WtxjmGKDYG0/NgBBZfNt/GkYPSxY=;
        b=VU8+Zk4hNKwPSKcaFDSxxI1KvzO/1GONnamvxXr1GaXFjFPzX6X0rciMJRQM6Yv6ZlzTTK
        xcOfeLyvHVIOrbigtUDqW45wUEMAI2Pi5F9oQdyl+B5yreA8jomOR14lTto61jpOEj1gpb
        6eYZs5eOm/T3vNgmA2M/t6hnUrcM0ZQ=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-348-sJN9wUWPPW-BUW6mLOrjNA-1; Wed, 23 Oct 2019 07:19:23 -0400
Received: from smtp.corp.redhat.com (int-mx02.intmail.prod.int.phx2.redhat.com [10.5.11.12])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 3176B8017CC;
        Wed, 23 Oct 2019 11:19:21 +0000 (UTC)
Received: from [10.18.17.163] (dhcp-17-163.bos.redhat.com [10.18.17.163])
        by smtp.corp.redhat.com (Postfix) with ESMTPS id 3A5AC60C5D;
        Wed, 23 Oct 2019 11:19:09 +0000 (UTC)
Subject: Re: [PATCH v12 0/6] mm / virtio: Provide support for unused page
 reporting
To:     Alexander Duyck <alexander.h.duyck@linux.intel.com>,
        Andrew Morton <akpm@linux-foundation.org>,
        Alexander Duyck <alexander.duyck@gmail.com>, david@redhat.com
...
References: <20191022221223.17338.5860.stgit@localhost.localdomain>
 ...
 <03b350f7de4b8f75cc3579e6c43f36aa09fd16b2.camel@linux.intel.com>
...
X-MC-Unique: sJN9wUWPPW-BUW6mLOrjNA-1
...
>> On Tue, 22 Oct 2019 15:27:52 -0700 Alexander Duyck <alexander.duyck@gmai=
l.com> wrote:
>>
[...]
...
>>> appreciate it if we could keep this patch set the focus of any discussi=
on
>>> on this thread.
>> Actually, the rest of us would be interested in a comparison ;) =20
...
As we last discussed I was going to try implementing Michal Hock's suggesti=
on of
using page-isolation APIs. To do that I have replaced __isolate_free_page()=
 with
