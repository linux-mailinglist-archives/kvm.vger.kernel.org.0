...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 4F3717625E5
	for <lists+kvm@lfdr.de>; Wed, 26 Jul 2023 00:16:45 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230291AbjGYWQf (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Tue, 25 Jul 2023 18:16:35 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33250 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231768AbjGYWPx (ORCPT <rfc822;kvm@vger.kernel.org>);
...
Message-Id: <265c9c5821d020ffa28bf7734d73380f56a23722.1690322424.git.isaku.yamahata@intel.com>
...
@@ -47,6 +48,270 @@ int tdx_vm_enable_cap(struct kvm *kvm, struct kvm_enable_cap *cap)
 	return r;
 }
...
@@ -107,6 +372,167 @@ static int tdx_get_capabilities(struct kvm_tdx_cmd *cmd)
 	return ret;
 }
...
@@ -195,13 +623,27 @@ int __init tdx_hardware_setup(struct kvm_x86_ops *x86_ops)
...
+
 	if (!zalloc_cpumask_var(&vmx_tdx.vmx_enabled, GFP_KERNEL)) {
 		r = -ENOMEM;
 		goto out;
@@ -222,3 +664,9 @@ int __init tdx_hardware_setup(struct kvm_x86_ops *x86_ops)
 out:
 	return r;
 }
+
