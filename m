...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id AA6F45A71B9
	for <lists+kvm@lfdr.de>; Wed, 31 Aug 2022 01:19:55 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232252AbiH3XTy (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Tue, 30 Aug 2022 19:19:54 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40552 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232078AbiH3XSo (ORCPT <rfc822;kvm@vger.kernel.org>);
        Tue, 30 Aug 2022 19:18:44 -0400
Received: from mail-pg1-x549.google.com (mail-pg1-x549.google.com [IPv6:2607:f8b0:4864:20::549])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 9FBDEA3D01
        for <kvm@vger.kernel.org>; Tue, 30 Aug 2022 16:16:59 -0700 (PDT)
Received: by mail-pg1-x549.google.com with SMTP id q128-20020a632a86000000b0042fadb61e4aso1228043pgq.3
        for <kvm@vger.kernel.org>; Tue, 30 Aug 2022 16:16:58 -0700 (PDT)
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=aMc/vE+XiBR2Oiw5L9bgN3TIa9Sbnj+nwomUXVp1aCQ=;
        b=
X-Gm-Message-State: ACgBeo0fweVwO17WjR8emqOC575uKsEBNrsRoOcG/4H83OGY4t3Dui78
        c2ZZMykQMGW2tV3YM7aJIlw4CtqkGIs=
X-Google-Smtp-Source: AA6agR7HxBGr3Oa//v/JJfKZT8O8weiZesrG2teu7QeB727GaiPdaNL0iTsPUzDbESF8rNmLszMC7Yb2RAQ=
...
@@ -8155,18 +8193,17 @@ static void toggle_interruptibility(struct kvm_vcpu *vcpu, u32 mask)
 	}
 }
...
@@ -8801,8 +8838,7 @@ int x86_emulate_instruction(struct kvm_vcpu *vcpu, gpa_t cr2_or_gpa,
...
@@ -9749,7 +9785,7 @@ static int inject_pending_event(struct kvm_vcpu *vcpu, bool *req_immediate_exit)
 	 */
...
@@ -9776,6 +9812,14 @@ static int inject_pending_event(struct kvm_vcpu *vcpu, bool *req_immediate_exit)
 	if (r < 0)
 		goto out;
...
@@ -9875,7 +9919,7 @@ static int inject_pending_event(struct kvm_vcpu *vcpu, bool *req_immediate_exit)
...
@@ -11057,6 +11117,7 @@ static void __set_regs(struct kvm_vcpu *vcpu, struct kvm_regs *regs)
...
@@ -11424,7 +11485,7 @@ int kvm_arch_vcpu_ioctl_set_guest_debug(struct kvm_vcpu *vcpu,
...
@@ -12652,7 +12713,7 @@ static inline bool kvm_vcpu_has_events(struct kvm_vcpu *vcpu)
