...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id B235F7A2330
	for <lists+kvm@lfdr.de>; Fri, 15 Sep 2023 18:05:01 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234701AbjIOQEd (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Fri, 15 Sep 2023 12:04:33 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:35952 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236270AbjIOQEW (ORCPT <rfc822;kvm@vger.kernel.org>);
        Fri, 15 Sep 2023 12:04:22 -0400
Received: from mail-ot1-x34a.google.com (mail-ot1-x34a.google.com [IPv6:2607:f8b0:4864:20::34a])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 80DA3E78
        for <kvm@vger.kernel.org>; Fri, 15 Sep 2023 09:04:14 -0700 (PDT)
Received: by mail-ot1-x34a.google.com with SMTP id 46e09a7af769-6c0f3675070so3083489a34.1
        for <kvm@vger.kernel.org>; Fri, 15 Sep 2023 09:04:14 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20230601; t=1694793853; x=1695398653; darn=vger.kernel.org;
        h=cc:to:from:subject:message-id:mime-version:in-reply-to:date:from:to
         :cc:subject:date:message-id:reply-to;
        bh=D/k82VTifsGrJf4oBmVwCzq0Qe2qF8rTJOJiVu8gzJ4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1694793853; x=1695398653;
        h=cc:to:from:subject:message-id:mime-version:in-reply-to:date
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=D/k82VTifsGrJf4oBmVwCzq0Qe2qF8rTJOJiVu8gzJ4=;
        b=
X-Gm-Message-State: AOJu0YzsAbpvEW2cH+75Wzcy9KfkLstdT3voOcXobFl5CO2cKmK9NoS/
        ftadp/x5Qvi9aDGh80XB8NOPH/byI+CQRlgrog==
X-Google-Smtp-Source: AGHT+IG6FOQcknDjKRFTKxoHjviKx/JF8tCMTESB50OEcsB0JgEz7Z2m14HjbcmAJ07tD6Y99qh3fFBDjFKwZ8vVhw==
X-Received: from coltonlewis-kvm.c.googlers.com ([fda3:e722:ac3:cc00:2b:ff92:c0a8:14ce])
 (user=coltonlewis job=sendgmr) by 2002:a9d:6849:0:b0:6bd:b74:2dab with SMTP
 id c9-20020a9d6849000000b006bd0b742dabmr568744oto.2.1694793853657; Fri, 15
 Sep 2023 09:04:13 -0700 (PDT)
Date:   Fri, 15 Sep 2023 16:04:12 +0000
In-Reply-To: <20230516213731.387132-1-coltonlewis@google.com> (message from
 Colton Lewis on Tue, 16 May 2023 21:37:31 +0000)
Mime-Version: 1.0
Message-ID: <gsnt8r97ifsz.fsf@coltonlewis-kvm.c.googlers.com>
...
> +++ b/tools/testing/selftests/kvm/Makefile
> @@ -137,6 +137,7 @@ TEST_GEN_PROGS_EXTENDED_x86_64 +=  
...
> + *
> + * Note that this can hang forever, so we rely on having a timeout  
> mechanism in
