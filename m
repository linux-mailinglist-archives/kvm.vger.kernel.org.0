...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 2436039DA4B
	for <lists+kvm@lfdr.de>; Mon,  7 Jun 2021 12:55:46 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230262AbhFGK5d (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Mon, 7 Jun 2021 06:57:33 -0400
Received: from smtp-fw-6002.amazon.com ([52.95.49.90]:48047 "EHLO
        smtp-fw-6002.amazon.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230131AbhFGK5b (ORCPT <rfc822;kvm@vger.kernel.org>);
        Mon, 7 Jun 2021 06:57:31 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
  d=amazon.com; i=@amazon.com; q=dns/txt; s=amazon201209;
  t=1623063341; x=1654599341;
  h=from:to:cc:subject:date:message-id:mime-version;
  bh=h+BLrDO/u0Wd4uUnZ3dMWU47IafUVRiaJebqIt30/uw=;
  b=nbbLh2TcvdaQrcK22TpCY8ZzjXLC0OazGgHluyWiwumOloVNXGkwHO/i
   FDvz1R7XwWMk7jGLvoOmjyhGJeY+VL+IDnS+YrEd2i7/oXQgndFTPfoh0
   oHtV55A00r2wNyqgRfrg0GlxXoHpVvCk3J7+5FGX6bb2LG0dSebtncTUL
   A=;
X-IronPort-AV: E=Sophos;i="5.83,254,1616457600"; 
   d="scan'208";a="117021696"
Received: from iad12-co-svc-p1-lb1-vlan2.amazon.com (HELO email-inbound-relay-1d-474bcd9f.us-east-1.amazon.com) ([10.43.8.2])
  by smtp-border-fw-6002.iad6.amazon.com with ESMTP; 07 Jun 2021 10:55:34 +0000
Received: from EX13MTAUEE001.ant.amazon.com (iad55-ws-svc-p15-lb9-vlan3.iad.amazon.com [10.40.159.166])
        by email-inbound-relay-1d-474bcd9f.us-east-1.amazon.com (Postfix) with ESMTPS id 5A6E6A1A88;
        Mon,  7 Jun 2021 10:55:30 +0000 (UTC)
Received: from EX13D08UEB004.ant.amazon.com (10.43.60.142) by
 EX13MTAUEE001.ant.amazon.com (10.43.62.200) with Microsoft SMTP Server (TLS)
 id 15.0.1497.18; Mon, 7 Jun 2021 10:55:28 +0000
Received: from EX13MTAUWB001.ant.amazon.com (10.43.161.207) by
 EX13D08UEB004.ant.amazon.com (10.43.60.142) with Microsoft SMTP Server (TLS)
 id 15.0.1497.18; Mon, 7 Jun 2021 10:55:28 +0000
Received: from uae075a0dfd4c51.ant.amazon.com (10.106.82.27) by
 mail-relay.amazon.com (10.43.161.249) with Microsoft SMTP Server id
 15.0.1497.18 via Frontend Transport; Mon, 7 Jun 2021 10:55:23 +0000
...
CC:     <mlevitsk@redhat.com>, <seanjc@google.com>, <vkuznets@redhat.com>,
        ...
        <ilstam@amazon.com>
Subject: [PATCH v6 09/11] KVM: X86: Add vendor callbacks for writing the TSC multiplier
