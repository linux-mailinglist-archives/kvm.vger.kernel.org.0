Return-Path: <kvm+bounces-68652-lists+kvm=lfdr.de@vger.kernel.org>
Delivered-To: lists+kvm@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id cDVGMkHvb2m+UQAAu9opvQ
	(envelope-from <kvm+bounces-68652-lists+kvm=lfdr.de@vger.kernel.org>)
	for <lists+kvm@lfdr.de>; Tue, 20 Jan 2026 22:10:25 +0100
X-Original-To: lists+kvm@lfdr.de
Received: from dfw.mirrors.kernel.org (dfw.mirrors.kernel.org [142.0.200.124])
	by mail.lfdr.de (Postfix) with ESMTPS id 4AAC04C008
	for <lists+kvm@lfdr.de>; Tue, 20 Jan 2026 22:10:25 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by dfw.mirrors.kernel.org (Postfix) with ESMTPS id 6DAACA2F3A8
	for <lists+kvm@lfdr.de>; Tue, 20 Jan 2026 20:54:19 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id BDED947DFAE;
	Tue, 20 Jan 2026 20:45:11 +0000 (UTC)
...
X-Spamd-Result: default: False [0.04 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-68652-lists,kvm=lfdr.de];
	MIME_TRACE(0.00)[0:+];
	RCVD_TLS_LAST(0.00)[];
	DMARC_POLICY_ALLOW(0.00)[intel.com,none];
	DKIM_TRACE(0.00)[intel.com:+];
	DBL_BLOCKED_OPENRESOLVER(0.00)[dfw.mirrors.kernel.org:rdns,dfw.mirrors.kernel.org:helo,lstrano-desk.jf.intel.com:mid,nvidia.com:email,intel.com:dkim];
	TO_DN_SOME(0.00)[];
