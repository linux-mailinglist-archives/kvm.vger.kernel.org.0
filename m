...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 163071F6843
	for <lists+kvm@lfdr.de>; Thu, 11 Jun 2020 14:50:16 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726386AbgFKMuO (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Thu, 11 Jun 2020 08:50:14 -0400
Received: from mga18.intel.com ([134.134.136.126]:58110 "EHLO mga18.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726735AbgFKMuO (ORCPT <rfc822;kvm@vger.kernel.org>);
        Thu, 11 Jun 2020 08:50:14 -0400
IronPort-SDR: PaTXsGxG71qKSCEno41pz0MtHUrc+EyzjKPdHZl0M9k5Yz3rg1iZfKUb5iFyPX19EjOm1czuMX
 e3qGErTH2Mvw==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga005.jf.intel.com ([10.7.209.41])
  by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 11 Jun 2020 05:48:00 -0700
IronPort-SDR: gly0fJsT6fT+Vs3qB9t3pdMZZUjv5D8U0SOu1vH2wZLYtL+ipe9zttgTmnTLk7pOZVw0/ZuoQx
 ouzOJfoOPdPw==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,499,1583222400"; 
   d="scan'208";a="447911260"
...
Subject: [RFC v6 15/25] intel_iommu: add PASID cache management infrastructure
Date:   Thu, 11 Jun 2020 05:54:14 -0700
Message-Id: <1591880064-30638-16-git-send-email-yi.l.liu@intel.com>
...
@@ -4108,6 +4569,9 @@ static void vtd_realize(DeviceState *dev, Error **errp)
                                      g_free, g_free);
...
@@ -511,10 +512,29 @@ typedef struct VTDRootEntry VTDRootEntry;
...
@@ -526,6 +546,7 @@ typedef struct VTDRootEntry VTDRootEntry;
