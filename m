...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 5289D2563C3
	for <lists+kvm@lfdr.de>; Sat, 29 Aug 2020 02:48:50 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726944AbgH2Asr (ORCPT <rfc822;lists+kvm@lfdr.de>);
...
Received: from pps.filterd (userp2130.oracle.com [127.0.0.1])
        by userp2130.oracle.com (8.16.0.42/8.16.0.42) with SMTP id 07T0V1r6087293;
...
Received: from pps.filterd (aserp3020.oracle.com [127.0.0.1])
        by aserp3020.oracle.com (8.16.0.42/8.16.0.42) with SMTP id 07T0UQ8j015684;
...
Subject: [PATCH 0/3] KVM: nSVM: Add checks for CR3 and CR4 reserved bits to svm_set_nested_state() and test CR3 non-MBZ reserved bits
...
X-Proofpoint-Spam-Details: rule=notspam policy=default score=0 mlxlogscore=601 phishscore=0
