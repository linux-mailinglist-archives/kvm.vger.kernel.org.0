...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B5AA01AD89D
	for <lists+kvm@lfdr.de>; Fri, 17 Apr 2020 10:33:42 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729783AbgDQIdk (ORCPT <rfc822;lists+kvm@lfdr.de>);
...
Subject: [PATCH v2 3/6] KVM: arm: vgic: Only use the virtual state when userspace accesses enable bits
