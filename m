...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8D6803B7D2A
	for <lists+kvm@lfdr.de>; Wed, 30 Jun 2021 08:08:34 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232504AbhF3GKy (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Wed, 30 Jun 2021 02:10:54 -0400
Received: from mga02.intel.com ([134.134.136.20]:46949 "EHLO mga02.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S232241AbhF3GKq (ORCPT <rfc822;kvm@vger.kernel.org>);
        Wed, 30 Jun 2021 02:10:46 -0400
X-IronPort-AV: E=McAfee;i="6200,9189,10030"; a="195448559"
X-IronPort-AV: E=Sophos;i="5.83,311,1616482800"; 
   d="scan'208";a="195448559"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 29 Jun 2021 23:08:16 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.83,311,1616482800"; 
   d="scan'208";a="455156503"
...
Subject: [PATCH v6 07/26] x86/fpu/xstate: Convert the struct fpu 'state' field to a pointer
Date:   Tue, 29 Jun 2021 23:02:07 -0700
Message-Id: <20210630060226.24652-8-chang.seok.bae@intel.com>
...
index 461114a1460c..01eb3389d163 100644
...
@@ -237,7 +237,7 @@ void fpstate_init(struct fpu *fpu)
 	u64 mask;
...
@@ -276,6 +276,8 @@ int fpu_clone(struct task_struct *dst)
...
@@ -283,7 +285,7 @@ int fpu_clone(struct task_struct *dst)
...
@@ -292,7 +294,7 @@ int fpu_clone(struct task_struct *dst)
 	 */
 	fpregs_lock();
...
@@ -379,7 +381,7 @@ static void fpu_reset_fpstate(void)
...
@@ -406,7 +408,7 @@ void fpu__clear_user_states(struct fpu *fpu)
 	 */
...
@@ -488,11 +490,11 @@ int fpu__exception_code(struct fpu *fpu, int trap_nr)
...
+			swd = (unsigned short)fpu->state->fsave.swd;
 		...
 		err = swd & ~cwd;
@@ -506,7 +508,7 @@ int fpu__exception_code(struct fpu *fpu, int trap_nr)
...
index 6a075852b2b5..c3e4a2e3ce10 100644
--- a/arch/x86/kernel/fpu/xstate.c
+++ b/arch/x86/kernel/fpu/xstate.c
@@ -944,7 +944,7 @@ static void *__raw_xsave_addr(struct fpu *fpu, int xfeature_nr)
 	}
...
@@ -987,7 +987,7 @@ void *get_xsave_addr(struct fpu *fpu, int xfeature_nr)
...
@@ -1079,7 +1079,7 @@ void copy_xstate_to_uabi_buf(struct membuf to, struct task_struct *tsk,
...
@@ -1196,7 +1196,7 @@ static int copy_from_buffer(void *dst, unsigned int offset, unsigned int size,
...
index e415254c26d4..0228557394f5 100644
...
index fc4fb289ac55..3c8b6080a253 100644
--- a/arch/x86/kvm/x86.c
+++ b/arch/x86/kvm/x86.c
@@ -4585,7 +4585,7 @@ static int kvm_vcpu_ioctl_x86_set_debugregs(struct kvm_vcpu *vcpu,
...
@@ -4628,7 +4628,7 @@ static void fill_xsave(u8 *dest, struct kvm_vcpu *vcpu)
...
@@ -4681,7 +4681,7 @@ static void kvm_vcpu_ioctl_x86_get_xsave(struct kvm_vcpu *vcpu,
...
+			&vcpu->arch.guest_fpu->state->fxsave,
 		...
 		*(u64 *)&guest_xsave->region[XSAVE_HDR_OFFSET / sizeof(u32)] =
 			XFEATURE_MASK_FPSSE;
@@ -4715,7 +4715,7 @@ static int kvm_vcpu_ioctl_x86_set_xsave(struct kvm_vcpu *vcpu,
...
+		memcpy(&vcpu->arch.guest_fpu->state->fxsave,
 	...
 	return 0;
@@ -9638,7 +9638,7 @@ static void kvm_save_current_fpu(struct fpu *fpu)
...
@@ -9657,7 +9657,7 @@ static void kvm_load_guest_fpu(struct kvm_vcpu *vcpu)
 	 */
...
+		__restore_fpregs_from_fpstate(vcpu->arch.guest_fpu->state,
 	...
 	fpregs_mark_activate();
@@ -9678,7 +9678,7 @@ static void kvm_put_guest_fpu(struct kvm_vcpu *vcpu)
 	if (vcpu->arch.guest_fpu)
...
+	restore_fpregs_from_fpstate(vcpu->arch.user_fpu->state);
 	...
 	fpregs_mark_activate();
 	fpregs_unlock();
@@ -10194,7 +10194,7 @@ int kvm_arch_vcpu_ioctl_get_fpu(struct kvm_vcpu *vcpu, struct kvm_fpu *fpu)
...
+	fxsave = &vcpu->arch.guest_fpu->state->fxsave;
 	...
 	fpu->fcw = fxsave->cwd;
 	fpu->fsw = fxsave->swd;
@@ -10217,7 +10217,7 @@ int kvm_arch_vcpu_ioctl_set_fpu(struct kvm_vcpu *vcpu, struct kvm_fpu *fpu)
...
+	fxsave = &vcpu->arch.guest_fpu->state->fxsave;
 	...
 	fxsave->cwd = fpu->fcw;
@@ -10278,7 +10278,7 @@ static void fx_init(struct kvm_vcpu *vcpu)
...
+		vcpu->arch.guest_fpu->state->xsave.header.xcomp_bv =
 	...
 	/*
@@ -10358,6 +10358,7 @@ int kvm_arch_vcpu_create(struct kvm_vcpu *vcpu)
...
+	vcpu->arch.user_fpu->state = &vcpu->arch.user_fpu->__default_state;
 	...
 	vcpu->arch.guest_fpu = kmem_cache_zalloc(x86_fpu_cache,
 						 GFP_KERNEL_ACCOUNT);
@@ -10365,6 +10366,7 @@ int kvm_arch_vcpu_create(struct kvm_vcpu *vcpu)
