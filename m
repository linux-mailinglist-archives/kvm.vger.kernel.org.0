...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 2F669762694
	for <lists+kvm@lfdr.de>; Wed, 26 Jul 2023 00:25:09 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233000AbjGYWZE (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Tue, 25 Jul 2023 18:25:04 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40572 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233132AbjGYWXa (ORCPT <rfc822;kvm@vger.kernel.org>);
...
Subject: [PATCH v15 103/115] KVM: TDX: Add methods to ignore accesses to CPU state
Date:   Tue, 25 Jul 2023 15:14:54 -0700
Message-Id: <089bedecf9c618177745eede18d06542ba4e6938.1690322424.git.isaku.yamahata@intel.com>
...
+
 ...
 {
 	if (is_td_vcpu(vcpu))
@@ -639,29 +858,29 @@ struct kvm_x86_ops vt_x86_ops __initdata = {
...
@@ -678,7 +897,7 @@ struct kvm_x86_ops vt_x86_ops __initdata = {
...
@@ -686,11 +905,11 @@ struct kvm_x86_ops vt_x86_ops __initdata = {
...
@@ -701,13 +920,13 @@ struct kvm_x86_ops vt_x86_ops __initdata = {
...
@@ -215,6 +221,13 @@ static inline bool tdx_has_emulated_msr(u32 index, bool write) { return false; }
