...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 10CDF689261
	for <lists+kvm@lfdr.de>; Fri,  3 Feb 2023 09:34:01 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232374AbjBCId5 (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Fri, 3 Feb 2023 03:33:57 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:41634 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232377AbjBCIdz (ORCPT <rfc822;kvm@vger.kernel.org>);
        Fri, 3 Feb 2023 03:33:55 -0500
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 7D6B570D75
        for <kvm@vger.kernel.org>; Fri,  3 Feb 2023 00:33:50 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1675413232; x=1706949232;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=r+vy3TMDiXv0Bz+nfF+mbx1EGQbhvpt5NoZHh1YSg6A=;
  b=h16uxYkiY4lys1nDWgQT2ZRnquzA06FC/XDxpLu0HdEd9TSbHMAtyHQj
   CZG3TZ1tWMNDWRcduN+XAEAczIKwp79ux+D43mLnInvAYsMCB1HS4AgXo
   Z8T+g80+3UUsVpjS5mYepHUFxLIoBjFNjQQ/muFWo2kcaj0k10TSS8Zix
   4IgnFRujSYg/4STZVu4zIgL1TaxAid1d3hCsSSXNDzXTFOV89hdWZyBCL
   YIYaIQm1fcN8YUii3UnR7UjeK+tEKClhH4EB1c4aFC0F3E4CMVCL94sbc
   HjD1gUVRaECR6d/IFcFrxnpUBfafEUB2d21ci6ZpA9vL1R9uzQT9APEZ5
   Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10609"; a="391089880"
X-IronPort-AV: E=Sophos;i="5.97,269,1669104000"; 
   d="scan'208";a="391089880"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
  by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 03 Feb 2023 00:33:48 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10609"; a="667581575"
X-IronPort-AV: E=Sophos;i="5.97,269,1669104000"; 
   d="scan'208";a="667581575"
Received: from 984fee00a4c6.jf.intel.com ([10.165.58.231])
  by fmsmga007.fm.intel.com with ESMTP; 03 Feb 2023 00:33:48 -0800
...
Subject: [PATCH v2 2/2] docs: vfio: Update vfio.rst per latest interfaces
Date:   Fri,  3 Feb 2023 00:33:45 -0800
Message-Id: <20230203083345.711443-3-yi.l.liu@intel.com>
...
index c663b6f97825..f38ab4ae1244 100644
...
@@ -270,28 +272,50 @@ ready before calling it. The driver provides an ops structure for callbacks
