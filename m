...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E308669BF2E
	for <lists+kvm@lfdr.de>; Sun, 19 Feb 2023 09:40:48 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229823AbjBSIkn (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Sun, 19 Feb 2023 03:40:43 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59822 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229776AbjBSIki (ORCPT <rfc822;kvm@vger.kernel.org>);
        Sun, 19 Feb 2023 03:40:38 -0500
Received: from NAM10-DM6-obe.outbound.protection.outlook.com (mail-dm6nam10on2076.outbound.protection.outlook.com [40.107.93.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 738CB11150;
        Sun, 19 Feb 2023 00:40:12 -0800 (PST)
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=ptOLbIX1pVxx8Bt1PJqEN08hNoeWGvTozg6pJYFUdZU=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=amd.com; s=selector1;
 ...
 bh=ptOLbIX1pVxx8Bt1PJqEN08hNoeWGvTozg6pJYFUdZU=;
 b=Wa2f5VMysEIOACmYMhcIQKWX/mUmlwm8csG2+0nKP9xYBjqyd/NJCONqIfvTAbVj+rb8JCQG2NpakvneQZ2CZHxtvjjBr1ffWrNY5TwL7nHCOT9/Bj0u84/uCgtd2qlRMf7hGcOrUdAaAGk//v3ZVt/RO1/zA0bw5aenDtLzMjE=
...
Received: from CO1NAM11FT114.eop-nam11.prod.protection.outlook.com
 (2603:10b6:303:8c:cafe::70) by MW4PR03CA0149.outlook.office365.com
...
Subject: [PATCH v3 5/7] vfio/pds: Add support for dirty page tracking
Date:   Sun, 19 Feb 2023 00:39:06 -0800
Message-ID: <20230219083908.40013-6-brett.creeley@amd.com>
...
X-MS-TrafficTypeDiagnostic: CO1NAM11FT114:EE_|CH3PR12MB8402:EE_
X-MS-Office365-Filtering-Correlation-Id: 1a8ea37b-1981-440d-e529-08db1254e6ac
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-Forefront-Antispam-Report: CIP:165.204.84.17;CTRY:US;LANG:en;SCL:1;SRV:;IPV:CAL;SFV:NSPM;H:SATLEXMB04.amd.com;PTR:InfoDomainNonexistent;CAT:NONE;SFS:(13230025)(4636009)(346002)(136003)(39860400002)(396003)(376002)(451199018)(40470700004)(36840700001)(46966006)(16526019)(54906003)(316002)(110136005)(40460700003)(478600001)(1076003)(186003)(26005)(82740400003)(36860700001)(2906002)(36756003)(86362001)(356005)(82310400005)(81166007)(47076005)(70206006)(70586007)(40480700001)(426003)(336012)(2616005)(83380400001)(8936002)(30864003)(5660300002)(44832011)(4326008)(41300700001)(8676002)(14143004)(36900700001);DIR:OUT;SFP:1101;
X-OriginatorOrg: amd.com
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 19 Feb 2023 08:40:05.7981
 (UTC)
X-MS-Exchange-CrossTenant-Network-Message-Id: 1a8ea37b-1981-440d-e529-08db1254e6ac
...
index 7d927c8fa1fd..f2a388eebe86 100644
--- a/drivers/vfio/pci/pds/Makefile
+++ b/drivers/vfio/pci/pds/Makefile
@@ -6,6 +6,7 @@ obj-$(CONFIG_PDS_VFIO_PCI) += pds_vfio.o
 pds_vfio-y := \
 	aux_drv.o	\
 	cmds.o		\
+	dirty.o		\
...
index f6ae0885628a..63189e6f3a88 100644
...
index f12d41cf5423..bca5e0348406 100644
...
index 000000000000..b6bba2001dff
--- /dev/null
...
new file mode 100644
index 000000000000..75849ec44482
--- /dev/null
...
index 08f49d259c40..f46345db9a90 100644
...
index 4dfe32b07839..8d32b2a543c9 100644
...
+
 ...
 {
@@ -135,6 +143,7 @@ pds_vfio_init_device(struct vfio_device *vdev)
...
index 61651d2d1c7b..6abb52814ef0 100644
