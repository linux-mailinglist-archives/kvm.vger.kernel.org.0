...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id CD37D363AAE
	for <lists+kvm@lfdr.de>; Mon, 19 Apr 2021 06:54:31 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232671AbhDSEye (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Mon, 19 Apr 2021 00:54:34 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:60360 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231203AbhDSEyc (ORCPT <rfc822;kvm@vger.kernel.org>);
        Mon, 19 Apr 2021 00:54:32 -0400
Received: from ozlabs.org (ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id CE343C06174A
        for <kvm@vger.kernel.org>; Sun, 18 Apr 2021 21:54:02 -0700 (PDT)
Received: by ozlabs.org (Postfix, from userid 1007)
        id 4FNvbp1c4Lz9vFb; Mon, 19 Apr 2021 14:53:57 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
        d=gibson.dropbear.id.au; s=201602; t=1618808038;
        bh=aqFjJbNPDl5AnFv9o9TXEloK8Fjd/Gk6lah2ePIPKb4=;
        h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
        b=hEhqMP2g4AU+kYNnFCtWGIQPyhxUaRGS79UATh6ADEkBARXOWLwg6bDwkq3JEPqWv
         z9c9JDSbDQxaHSwZ23ejoseSyuSdn8egLQ6bsJA5yomupMswcEFLz/7EHnc0jz4Dse
         6kZATMkELoibaGTCrbJ91qKctiOx+Gdi0wKGezFk=
...
Message-ID: <YH0M1YdINJqbdqP+@yekko.fritz.box>
...
Content-Type: multipart/signed; micalg=pgp-sha256;
        protocol="application/pgp-signature"; boundary="AIZgKAWQk27KV7OG"
...
> --- a/hw/ppc/spapr.c
> +++ b/hw/ppc/spapr.c
> @@ -238,7 +238,7 @@ static void spapr_dt_pa_features(SpaprMachineState *s=
papr,
...
> @@ -279,6 +279,9 @@ static void spapr_dt_pa_features(SpaprMachineState *s=
papr,
...
>      }
>  };
> @@ -4542,6 +4546,7 @@ static void spapr_machine_class_init(ObjectClass *o=
c, void *data)
...
> +        error_append_hint(errp, "Try appending -machine cap-dawr1=3Doff\=
n");
> +    } else if (kvm_enabled()) {
...
> @@ -7765,6 +7765,20 @@ static void gen_spr_book3s_207_dbg(CPUPPCState *en=
v)
...

=O6xo
-----END PGP SIGNATURE-----
