Return-Path: <kvm+bounces-14298-lists+kvm=lfdr.de@vger.kernel.org>
X-Original-To: lists+kvm@lfdr.de
Delivered-To: lists+kvm@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id D86BC8A1DD6
	for <lists+kvm@lfdr.de>; Thu, 11 Apr 2024 20:19:49 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id DE9AD1C24BEB
	for <lists+kvm@lfdr.de>; Thu, 11 Apr 2024 18:19:48 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 69C495B691;
	Thu, 11 Apr 2024 17:30:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b="ktyGlb+M"
X-Original-To: kvm@vger.kernel.org
Received: from mail-ed1-f47.google.com (mail-ed1-f47.google.com [209.85.208.47])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2739059165
	for <kvm@vger.kernel.org>; Thu, 11 Apr 2024 17:29:57 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.208.47
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712856602; cv=none; b=eN57atnHOkDNl3jNeNDYZ+X06yY4rojecxlgQoFCK/dIAfcE378UIjQQ4vvGcYwxzcnpU+x+oJH3xCA16dC2xO3af/gY/gODDPpn/FgqOqlPM9Dd8fzYhOEwNVmGtbXN5+eKNkgGqnewerzd4Y2bmoAN+SlZmCNX4S82cimc5Q8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712856602; c=relaxed/simple;
	bh=qQLLUn7eAh3Ca0zE0JYFzmas2IVVibqaMH+Ya5pLA7Q=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=VjCQs3B76Fn7JBU7jDR0cQ8YjIInzx1Ec9apzibGjp/QwhuoSVdNNien7wVrtNf6xsEIzhcfneslBl/cmT3zcWC2qreOPbbcmdWB/6laaPBnF7mxLLOSQlDcGmB7LKGMcbVoNr/jPIriYm39T22WASWvKO+jTVtyzi6NsOkFrE0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com; spf=pass smtp.mailfrom=gmail.com; dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b=ktyGlb+M; arc=none smtp.client-ip=209.85.208.47
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmail.com
Received: by mail-ed1-f47.google.com with SMTP id 4fb4d7f45d1cf-56e6a1edecfso48270a12.1
        for <kvm@vger.kernel.org>; Thu, 11 Apr 2024 10:29:56 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1712856595; x=1713461395; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=n+d++KMRuWvgoZQRg/8k6xuzHRJiRkWArvuFioXenIM=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=n+d++KMRuWvgoZQRg/8k6xuzHRJiRkWArvuFioXenIM=;
        b=
X-Gm-Message-State: AOJu0YxXVcoIMu8iHGa9Ow67WXZ7es2/4HXhhW4vrbTD9OMAOmnKIJBl
	DdS2wIUbaB4+4CLKb6MMH0MVRR7nCHCR+QBzXBlEXHc5i3X3KP5cY5PVsgWA
X-Google-Smtp-Source: AGHT+IFU20phcLfa4xOqxyI74QaeYKwejIA3I646k6piRhYCMuFjVYJ4BwWD/BxzVbs0sECZYRXLlg==
X-Received: by 2002:a50:d656:0:b0:56c:5ab5:5fb7 with SMTP id c22-20020a50d656000000b0056c5ab55fb7mr286730edj.30.1712856593846;
        Thu, 11 Apr 2024 10:29:53 -0700 (PDT)
Received: from vasant-suse.fritz.box ([2001:9e8:ab51:1500:e6c:48bd:8b53:bc56])
        by smtp.gmail.com with ESMTPSA id j1-20020aa7de81000000b0056e62321eedsm863461edv.17.2024.04.11.10.29.52
...
Subject: [kvm-unit-tests PATCH v6 04/11] lib: x86: Import insn decoder from Linux
Date: Thu, 11 Apr 2024 19:29:37 +0200
Message-Id: <20240411172944.23089-5-vsntk18@gmail.com>
...
---
 ...
 11 files changed, 3054 insertions(+), 2 deletions(-)
...
index 2168e013..3f2df5f4 100644
--- a/.gitignore
+++ b/.gitignore
@@ -16,6 +16,8 @@ cscope.*
 *.swp
...
+
+The following files were taken as-is from Linux@e8c39d0f57f and
...
+#
+# kvm-unit-tests origin: Linux@e8c39d0f57f
...
index bc0ed2c8..25ae6f78 100644
--- a/x86/Makefile.common
+++ b/x86/Makefile.common
@@ -26,6 +26,8 @@ cflatobjs += lib/x86/pmu.o
 ifeq ($(CONFIG_EFI),y)
...
@@ -49,7 +51,14 @@ FLATLIBS = lib/libcflat.a
 ifeq ($(CONFIG_EFI),y)
 .PRECIOUS: %.efi %.so
