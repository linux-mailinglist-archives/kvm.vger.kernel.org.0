...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 171D84C2C11
	for <lists+kvm@lfdr.de>; Thu, 24 Feb 2022 13:49:32 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234552AbiBXMt0 (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Thu, 24 Feb 2022 07:49:26 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40524 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234506AbiBXMtP (ORCPT <rfc822;kvm@vger.kernel.org>);
        Thu, 24 Feb 2022 07:49:15 -0500
Received: from casper.infradead.org (casper.infradead.org [IPv6:2001:8b0:10b:1236::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 9F7B81D8AA2
        for <kvm@vger.kernel.org>; Thu, 24 Feb 2022 04:48:42 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        d=infradead.org; s=casper.20170209; h=Sender:Content-Transfer-Encoding:
        MIME-Version:References:In-Reply-To:Message-Id:Date:Subject:Cc:To:From:
        Reply-To:Content-Type:Content-ID:Content-Description;
        bh=jk7dk7NRbDgdjDP+tK/dniT4y4HaCOvGB8tB/9E/8pM=; b=IrIvzzl9OLEup+Yv4GS9vnVOgS
        ;
Received: from [2001:8b0:10b:1:85c4:81a:fb42:714d] (helo=i7.infradead.org)
        by casper.infradead.org with esmtpsa (Exim 4.94.2 #2 (Red Hat Linux))
        id 1nNDXk-004lnZ-Ku; Thu, 24 Feb 2022 12:48:24 +0000
Received: from dwoodhou by i7.infradead.org with local (Exim 4.94.2 #2 (Red Hat Linux))
        id 1nNDXj-0000u8-Fh; Thu, 24 Feb 2022 12:48:23 +0000
...
Subject: [PATCH v1 04/16] KVM: x86/xen: Use gfn_to_pfn_cache for vcpu_info
Date:   Thu, 24 Feb 2022 12:48:07 +0000
Message-Id: <20220224124819.3315-5-dwmw2@infradead.org>
...
index 8b776fdcfe0f..9147408ddb1e 100644
--- a/arch/x86/kvm/x86.c
+++ b/arch/x86/kvm/x86.c
@@ -3141,9 +3141,9 @@ static int kvm_guest_time_update(struct kvm_vcpu *v)
...
+					offsetof(struct compat_vcpu_info, time));
 	...
 	if (!v->vcpu_idx)
@@ -10328,6 +10328,9 @@ static int vcpu_run(struct kvm_vcpu *vcpu)
 			break;
...
index eb0d11f80d1d..cde98cf82def 100644
...
@@ -247,23 +248,80 @@ void kvm_xen_update_runstate_guest(struct kvm_vcpu *v, int state)
...
@@ -273,101 +331,36 @@ int __kvm_xen_has_interrupt(struct kvm_vcpu *v)
...
@@ -457,25 +450,18 @@ int kvm_xen_vcpu_set_attr(struct kvm_vcpu *vcpu, struct kvm_xen_vcpu_attr *data)
 			     offsetof(struct compat_vcpu_info, time));
...
@@ -632,7 +618,7 @@ int kvm_xen_vcpu_get_attr(struct kvm_vcpu *vcpu, struct kvm_xen_vcpu_attr *data)
...
@@ -905,16 +891,17 @@ int kvm_xen_set_evtchn_fast(struct kvm_kernel_irq_routing_entry *e,
 	if (!vcpu)
 		return -1;
...
@@ -942,17 +929,44 @@ int kvm_xen_set_evtchn_fast(struct kvm_kernel_irq_routing_entry *e,
...
@@ -1055,4 +1069,7 @@ void kvm_xen_destroy_vcpu(struct kvm_vcpu *vcpu)
 {
