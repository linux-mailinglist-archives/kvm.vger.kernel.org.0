...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id C994F439607
	for <lists+kvm@lfdr.de>; Mon, 25 Oct 2021 14:19:30 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232951AbhJYMVv (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Mon, 25 Oct 2021 08:21:51 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38246 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232524AbhJYMVr (ORCPT <rfc822;kvm@vger.kernel.org>);
        Mon, 25 Oct 2021 08:21:47 -0400
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D4D3FC061745
        for <kvm@vger.kernel.org>; Mon, 25 Oct 2021 05:19:25 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        d=infradead.org; s=bombadil.20210309; h=MIME-Version:Content-Type:References:
        In-Reply-To:Date:Cc:To:From:Subject:Message-ID:Sender:Reply-To:
        Content-Transfer-Encoding:Content-ID:Content-Description;
        bh=9kd1Fnh1DRZnZGvmhYHMhXa0Gw66BPoT6+C3VwhpJy8=; b=SzWw26tTQ+IVKjXgyU8WMKkoX8
        ;
Received: from [2001:8b0:10b:1::3ae] (helo=u3832b3a9db3152.ant.amazon.com)
        by bombadil.infradead.org with esmtpsa (Exim 4.94.2 #2 (Red Hat Linux))
        id 1meywc-00GOV8-NU; Mon, 25 Oct 2021 12:19:15 +0000
Message-ID: <2e7bcafe1077d31d8af6cc0cd120a613cc070cfb.camel@infradead.org>
...
Date:   Mon, 25 Oct 2021 13:19:11 +0100
...
operations. For delivering a given port#, we:
 ...
 =E2=80=A2 Test-and-set the corresponding port# bit in the shared info page=
.
   If it was already set, we're done.

 =E2=80=A2 Test the corresponding 'masked' bit in the shared info page. If =
it
   was already set, we're done.

 =E2=80=A2 Test-and-test the bit in the target vcpu_info 'evtchn_pending_se=
l'
   which corresponds to the *word* in which the port# resides. If it
   was already set, we're done.
=20
 =E2=80=A2 Set the 'evtchn_upcall_pending' bit in the target vcpu_info to
   trigger the vector delivery.

In Jo=C3=A3o and Ankur's original version=C2=B9 this was really simple; it =
looked
like this:
...
=C2=B9 https://lore.kernel.org/lkml/20190220201609.28290-12-joao.m.martins@=
oracle.com/
...
MDI1MTIxOTExWjAvBgkqhkiG9w0BCQQxIgQgHjfM1FKDVvxguwTZ7TrT2CgcssgFKBWU478bynbx
wo8wgb4GCSsGAQQBgjcQBDGBsDCBrTCBlzELMAkGA1UEBhMCR0IxGzAZBgNVBAgTEkdyZWF0ZXIg
...

