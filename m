...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id D42BE47D27D
	for <lists+kvm@lfdr.de>; Wed, 22 Dec 2021 13:52:27 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S244954AbhLVMw1 (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Wed, 22 Dec 2021 07:52:27 -0500
Received: from mga14.intel.com ([192.55.52.115]:12132 "EHLO mga14.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S241182AbhLVMw0 (ORCPT <rfc822;kvm@vger.kernel.org>);
        Wed, 22 Dec 2021 07:52:26 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1640177546; x=1671713546;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=CUJE1WWP8m0kRJsZa2fFCUgvyVTkdS7bH7SY7ImxqyY=;
  b=GBOfs/K7L3DSPiAUUdNOSIFfNqiW8KSVPQxi55Tq/eR8+sbd3yEFqRbB
   huYu0m8aPczzuZgQwx6g0UBshqf4afdzY4TRvP/m7ACqCZv2T32Xd0iN2
   TDB/eXS2umc3dTYc37hepSaKjdzISTkPU5IqznA3GwkgFoqG6KGQpKF5r
   Tf92/mznZ4Q/a6o/n6xVt9R+jgc9BluZaF9+BisxMJSN77ap3bQYSmfVQ
   +xTvNErj+wJlOhmJ5HLMBlVZipr5m0DgzKIKmCpKJta02y6WGo2f78V2a
   k0ZuMCTY6FOlcvZ1zR6ZJOKg1d9O+JmFee1HQ48xtxUxou/Hkt4O5sgxT
   Q==;
X-IronPort-AV: E=McAfee;i="6200,9189,10205"; a="240834746"
X-IronPort-AV: E=Sophos;i="5.88,226,1635231600"; 
   d="scan'208";a="240834746"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 22 Dec 2021 04:52:25 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.88,226,1635231600"; 
   d="scan'208";a="549315039"
Received: from icx.bj.intel.com ([10.240.192.117])
  by orsmga001.jf.intel.com with ESMTP; 22 Dec 2021 04:52:23 -0800
From:   Yang Zhong <yang.zhong@intel.com>
To:     kvm@vger.kernel.org, pbonzini@redhat.com
Cc:     seanjc@google.com, jun.nakajima@intel.com, kevin.tian@intel.com,
        jing2.liu@linux.intel.com, yang.zhong@intel.com
Subject: [PATCH v2 3/3] selftest: kvm: Support amx selftest
Date:   Wed, 22 Dec 2021 16:47:31 -0500
Message-Id: <20211222214731.2912361-4-yang.zhong@intel.com>
...
index 000000000000..a1e6c022f37c
--- /dev/null
...
+				else
+					TEST_ASSERT(ret != 0,
+					"memcmp was successful, but it should fail, ret=%d\n", ret);
+
+				kvm_x86_state_cleanup(state);
+				break;
+			case 9:
+				fprintf(stderr, "GUEST_SYNC(%ld), #NM exception\n", uc.args[1]);
+				break;
+			}
+			break;
+		case UCALL_DONE:
