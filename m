...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E8FDA762673
	for <lists+kvm@lfdr.de>; Wed, 26 Jul 2023 00:24:20 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232776AbjGYWWt (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Tue, 25 Jul 2023 18:22:49 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39946 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232539AbjGYWVx (ORCPT <rfc822;kvm@vger.kernel.org>);
...
Message-Id: <5f9b2aeed5710582b06c8e926ade6b75d19d3b13.1690322424.git.isaku.yamahata@intel.com>
...
+
 static void vt_load_mmu_pgd(struct kvm_vcpu *vcpu, hpa_t root_hpa,
 			int pgd_level)
 {
@@ -244,10 +307,10 @@ struct kvm_x86_ops vt_x86_ops __initdata = {
...
@@ -406,6 +423,266 @@ void tdx_load_mmu_pgd(struct kvm_vcpu *vcpu, hpa_t root_hpa, int pgd_level)
...
@@ -880,6 +1157,41 @@ static int tdx_td_init(struct kvm *kvm, struct kvm_tdx_cmd *cmd)
 	return ret;
 }
...
@@ -1145,8 +1457,21 @@ int __init tdx_hardware_setup(struct kvm_x86_ops *x86_ops)
...
@@ -154,6 +154,9 @@ void tdx_vcpu_reset(struct kvm_vcpu *vcpu, bool init_event);
...
@@ -177,6 +180,9 @@ static inline void tdx_vcpu_reset(struct kvm_vcpu *vcpu, bool init_event) {}
