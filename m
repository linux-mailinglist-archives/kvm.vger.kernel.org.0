Return-Path: <kvm+bounces-16579-lists+kvm=lfdr.de@vger.kernel.org>
X-Original-To: lists+kvm@lfdr.de
Delivered-To: lists+kvm@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 852538BBB46
	for <lists+kvm@lfdr.de>; Sat,  4 May 2024 14:30:29 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id F330D1F21FDC
	for <lists+kvm@lfdr.de>; Sat,  4 May 2024 12:30:28 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 2A5262E631;
	Sat,  4 May 2024 12:29:57 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b="U7Ft3AkY"
X-Original-To: kvm@vger.kernel.org
Received: from mail-oa1-f51.google.com (mail-oa1-f51.google.com [209.85.160.51])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id CE7852232B
	for <kvm@vger.kernel.org>; Sat,  4 May 2024 12:29:53 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.160.51
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714825796; cv=none; b=uzrw8mNK+2wicRmUML6czV7XgyrYPJ9YwnUiJ6/LFXult2e7K6ClDB3L3MPI1DclAJGJQPbPglbwwnNdJGDakrDjg+25v15sB+KXrqu1d62pZ33CYi3HaHx+J205zG+oSCaEg7hLgTRlzcZR66BAKqFH1u1d+xQigkeacI6ad44=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714825796; c=relaxed/simple;
	bh=0afD/A/cG/T/8ds0AKtzX/6kZJUaL0SP2L7iHn6gOOA=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=qXr4KXt3KpwYUO5nWFQYHd+CCzYBwZhnzVRB3twvr+BcU/44ThAtS5IC5yZhsWACO9CcpBK7bNRrbjv4U6mDksOcZUKxEolAr73I948lAG4vh4sHBbFVaeVgiJkHCma8VgZgjNSiqcAAZ2gWcBb7JEA0TwDOJTFqalxq8zTb2g0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com; spf=pass smtp.mailfrom=gmail.com; dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b=U7Ft3AkY; arc=none smtp.client-ip=209.85.160.51
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmail.com
Received: by mail-oa1-f51.google.com with SMTP id 586e51a60fabf-23d39e4c0d9so326791fac.0
        for <kvm@vger.kernel.org>; Sat, 04 May 2024 05:29:53 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1714825793; x=1715430593; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=QzolWM0KBX532JEr7qFaNuNRi8gLED13xIyQFP+nUXw=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1714825793; x=1715430593;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=QzolWM0KBX532JEr7qFaNuNRi8gLED13xIyQFP+nUXw=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCUcA9F7xp5MFJKeJYEZH+pc6YR9P8I0gK9cpvOZCRqoAidPodE1qCM7Uhn7G8f3K0Yh+Eo+Im/2SnePPY1CjPEygDyb
X-Gm-Message-State: AOJu0YxLWIZfa8ZTuNCRdIb4fBSyTEXLyPYjIxqsgQBLPcR966z2+80x
	lAOGeyy1DnHZYi/aC675W+qVKDZcSYWclsStuPx97uHKKx2aJ44P
X-Google-Smtp-Source: AGHT+IE8QC7TJFKIZP9hPD5VLW8/XQeIffn4e1dqGWdkXE90+KKRvi5WtGQbTqAAo+EomwthuJjD0w==
X-Received: by 2002:a05:6870:9e46:b0:22e:93a0:fcbb with SMTP id pt6-20020a0568709e4600b0022e93a0fcbbmr6675249oab.34.1714825792656;
        Sat, 04 May 2024 05:29:52 -0700 (PDT)
Received: from wheely.local0.net (220-245-239-57.tpgi.com.au. [220.245.239.57])
        by smtp.gmail.com with ESMTPSA id b16-20020a056a000a9000b006f4473daa38sm3480068pfl.128.2024.05.04.05.29.49
...
Cc: Nicholas Piggin <npiggin@gmail.com>,
	...
	kvm@vger.kernel.org
Subject: [kvm-unit-tests PATCH v9 16/31] powerpc: add SMP and IPI support
Date: Sat,  4 May 2024 22:28:22 +1000
...
---
 ...
 lib/powerpc/asm/smp.h       |  44 +++--
 lib/powerpc/io.c            |  15 +-
 lib/powerpc/processor.c     |   7 +-
 lib/powerpc/setup.c         |  90 +++++++---
 lib/powerpc/smp.c           | 337 ++++++++++++++++++++++++++++++----
 lib/ppc64/asm-offsets.c     |   9 +
 lib/ppc64/asm/atomic.h      |   6 +
 lib/ppc64/asm/barrier.h     |   2 +
 lib/ppc64/asm/opal.h        |   7 +
 powerpc/Makefile.common     |   1 +
 powerpc/cstart64.S          |  50 +++++-
 powerpc/selftest.c          |   4 +-
 powerpc/smp.c               | 348 ++++++++++++++++++++++++++++++++++++
 powerpc/tm.c                |   5 +-
 powerpc/unittests.cfg       |   8 +
 18 files changed, 875 insertions(+), 84 deletions(-)
...
index 21940b4bc..c45988bfa 100644
...
index 73ca2f931..622b99e5d 100644
...
index 3e211eba8..27b169841 100644
--- a/lib/powerpc/smp.c
+++ b/lib/powerpc/smp.c
@@ -6,58 +6,253 @@
...
+	start_core(fdtnode, datap->entry);
 ...
 /*
@@ -92,14 +282,89 @@ static void start_each_secondary(int fdtnode, u64 regval __unused, void *info)
...
index 7843a20b4..ba1a045df 100644
...
+#include <asm/smp.h>
 ...
 int main(void)
 {
@@ -50,5 +52,12 @@ int main(void)
 	DEFINE(_XER, STACK_FRAME_OVERHEAD+offsetof(struct pt_regs, xer));
 	DEFINE(_CCR, STACK_FRAME_OVERHEAD+offsetof(struct pt_regs, ccr));
 	DEFINE(_TRAP, STACK_FRAME_OVERHEAD+offsetof(struct pt_regs, trap));
+
+	DEFINE(SIZEOF_STRUCT_CPU, sizeof(struct cpu));
+	DEFINE(CPU_SERVER_NO, offsetof(struct cpu, server_no));
+	DEFINE(CPU_STACK, offsetof(struct cpu, stack));
+	DEFINE(CPU_EXCEPTION_STACK, offsetof(struct cpu, exception_stack));
...
index 76f6efa78..d2df29520 100644
...
index 6374418d2..b98f71c2f 100644
...
index 405cb0561..b4eb70696 100644
...
+
 ...
 p_toc:		.llong  tocptr
@@ -257,7 +301,8 @@ do_handle_exception_return:
 	. = \vec
...
@@ -273,7 +318,8 @@ do_handle_exception_return:
 	. = \vec
...
index d9e7f455d..507eaf492 100644
--- a/powerpc/tm.c
+++ b/powerpc/tm.c
...
index 03d7b60e5..aa707e0f3 100644
--- a/powerpc/unittests.cfg
+++ b/powerpc/unittests.cfg
@@ -69,6 +69,14 @@ file = emulator.elf
 [interrupts]
 file = interrupts.elf
