Return-Path: <kvm+bounces-8531-lists+kvm=lfdr.de@vger.kernel.org>
X-Original-To: lists+kvm@lfdr.de
Delivered-To: lists+kvm@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id BDC48850CAE
	for <lists+kvm@lfdr.de>; Mon, 12 Feb 2024 02:31:36 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id E2A621C2309E
	for <lists+kvm@lfdr.de>; Mon, 12 Feb 2024 01:31:35 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 5182413FF1;
	Mon, 12 Feb 2024 01:28:59 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="W+Brj5fx"
X-Original-To: kvm@vger.kernel.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.15])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 632ED171A5;
	Mon, 12 Feb 2024 01:28:56 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=198.175.65.15
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707701338; cv=none; b=f5l98p7ZvZlFjweo3xvFbcJjzQ0JJeSDMZirF/cVIsoDm9yUqi9filGgmP6ojzIZMjYpQkTL8otOHwASquljSUfuTIBCFaD/fD78WK+TJZqkhjEjwZ/jLTRj24vZc3x/O6oFfLf75+26tI1D6fk+2qjCRsuQcUSI5CrA0oS7Uro=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707701338; c=relaxed/simple;
	bh=CvvYvTJWqAfNu+myqSiE5clA6UN1O307hTU0+qht2lE=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=E2+ghdcU8yG3p/X7An4qy1EGT5MRzYEfoI+MZCF+pBhtQ+ebiNZDwyM42SmgRFwkNxcMihw7B9AOCrlDtte5sQZcZZan10TCnHLVQhkFI7Org/A2bYMmD0aSVW01kV/JWH5CXesiMU6GvsOFR+W1k1odLy70/o2/RtioACzRlWg=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.intel.com; spf=none smtp.mailfrom=linux.intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=W+Brj5fx; arc=none smtp.client-ip=198.175.65.15
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=none smtp.mailfrom=linux.intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1707701337; x=1739237337;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=CvvYvTJWqAfNu+myqSiE5clA6UN1O307hTU0+qht2lE=;
  b=W+Brj5fxGkQeFmDQCaJmga8V3KR994m3nMqD3TElFTTGm0aKleSqLjl8
   ld3myCD9fEB+w0z1GMm8ZI1a4uqXi1Zvzw/qziirPbGEzWy1Di8frz/gw
   95dGe7rnAYEmOlCFINlSC/Nc2Mb51wGhngnJfmjbLYg/tf1ysM09zIOEO
   3XXPcOOsjgAGCRRzpZxi/dWINCUCvyWYQwGcsmOMfmoRY0y4itNPUENCF
   2InkWWDB5XfsA9d0lYujvYkmw8H7b1WiDIsrOclp0FUYLjZ+bypQWf8Ih
   TaMDSUFVYqwvGHRD8HDSXvl1WZutqAsFSzd4f3r2gVQPh200ptEY0M910
   w==;
X-IronPort-AV: E=McAfee;i="6600,9927,10981"; a="5502158"
X-IronPort-AV: E=Sophos;i="6.05,261,1701158400"; 
   d="scan'208";a="5502158"
Received: from orviesa005.jf.intel.com ([10.64.159.145])
  by orvoesa107.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 11 Feb 2024 17:28:57 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.05,261,1701158400"; 
   d="scan'208";a="7132231"
Received: from allen-box.sh.intel.com ([10.239.159.127])
  by orviesa005.jf.intel.com with ESMTP; 11 Feb 2024 17:28:52 -0800
...
Subject: [PATCH v13 10/16] iommu: Separate SVA and IOPF
Date: Mon, 12 Feb 2024 09:22:21 +0800
Message-Id: <20240212012227.119381-11-baolu.lu@linux.intel.com>
...
index b9fdd09d7b0e..b31bfc0bc726 100644
--- a/include/linux/iommu.h
+++ b/include/linux/iommu.h
@@ -826,10 +826,6 @@ extern struct iommu_group *iommu_group_get(struct device *dev);
...
@@ -1045,8 +1041,6 @@ bool iommu_group_dma_owner_claimed(struct iommu_group *group);
...
@@ -1235,18 +1229,6 @@ static inline void iommu_group_put(struct iommu_group *group)
 {
 }
...
-
 ...
 {
 	return -ENODEV;
@@ -1395,12 +1377,6 @@ static inline int iommu_device_claim_dma_owner(struct device *dev, void *owner)
 	return -ENODEV;
 }
...
-
 static inline int iommu_attach_device_pasid(struct iommu_domain *domain,
 					    struct device *dev, ioasid_t pasid)
 {
@@ -1548,6 +1524,8 @@ struct iommu_sva *iommu_sva_bind_device(struct device *dev,
 					struct mm_struct *mm);
...
@@ -1572,6 +1550,78 @@ static inline u32 mm_get_enqcmd_pasid(struct mm_struct *mm)
 }
...
index 6c429921f219..210dc7b4c8cf 100644
...
@@ -1349,117 +1347,6 @@ void iommu_group_put(struct iommu_group *group)
 }
...
@@ -3542,26 +3429,6 @@ struct iommu_domain *iommu_get_domain_for_dev_pasid(struct device *dev,
 }
