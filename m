...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 4C3AF7BF018
	for <lists+kvm@lfdr.de>; Tue, 10 Oct 2023 03:10:51 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1379335AbjJJBKu (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Mon, 9 Oct 2023 21:10:50 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58670 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1379330AbjJJBKt (ORCPT <rfc822;kvm@vger.kernel.org>);
        Mon, 9 Oct 2023 21:10:49 -0400
Received: from out-197.mta0.migadu.com (out-197.mta0.migadu.com [IPv6:2001:41d0:1004:224b::c5])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 43F39B0
        for <kvm@vger.kernel.org>; Mon,  9 Oct 2023 18:10:42 -0700 (PDT)
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linux.dev; s=key1;
        ...
        bh=nm4CX0K6breEWnVcyIJem/cH4nxobcWFiGjrb7WNv1M=;
        b=mcNV1aYuVepbZegx61FoC7tg3o7tYa5nBwgCM+i7eCdInEbvxSnv/hRvm6uYtHDmeFSYTP
        DBbJ5M0GVKc4SGN4R0CC5mfM7t4tmBAmf66+7q4GYLHJs3hZqERVN86v2X2rEDz+yIsAKo
        X44NV1pbNyfWp6trIEJQSoQJO2g9DEA=
...
Subject: [PATCH v2 1/5] tools headers arm64: Copy sysreg-defs generation from kernel source
Date:   Tue, 10 Oct 2023 01:10:18 +0000
Message-ID: <20231010011023.2497088-2-oliver.upton@linux.dev>
...
---
 ...
 5 files changed, 2876 insertions(+)
...
new file mode 100644
index 000000000000..d4e652d072fa
--- /dev/null
...
+endif
+
+arm64_tools_dir = $(srctree)/tools/arch/arm64/tools
...
index 4314c9197850..78e8b4cd06a1 100755
