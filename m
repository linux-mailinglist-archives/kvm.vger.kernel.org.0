...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id AAF5751C6F7
	for <lists+kvm@lfdr.de>; Thu,  5 May 2022 20:17:06 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1383201AbiEESUJ (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Thu, 5 May 2022 14:20:09 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:36320 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1383080AbiEEST1 (ORCPT <rfc822;kvm@vger.kernel.org>);
...
Subject: [RFC PATCH v6 004/104] KVM: VMX: Move out vmx_x86_ops to 'main.c' to wrap VMX and TDX
Date:   Thu,  5 May 2022 11:13:58 -0700
Message-Id: <930c73f3f815500a9b3209c1a996733089ed256f.1651774250.git.isaku.yamahata@intel.com>
...
+#include "x86_ops.h"
 ...
 MODULE_LICENSE("GPL");
@@ -1307,7 +1308,7 @@ void vmx_vcpu_load_vmcs(struct kvm_vcpu *vcpu, int cpu,
...
@@ -1318,7 +1319,7 @@ static void vmx_vcpu_load(struct kvm_vcpu *vcpu, int cpu)
...
@@ -1372,7 +1373,7 @@ void vmx_set_rflags(struct kvm_vcpu *vcpu, unsigned long rflags)
...
@@ -1478,8 +1479,8 @@ static int vmx_rtit_ctl_check(struct kvm_vcpu *vcpu, u64 data)
 	return 0;
 }
...
@@ -1563,7 +1564,7 @@ static int skip_emulated_instruction(struct kvm_vcpu *vcpu)
...
+void vmx_update_emulated_instruction(struct kvm_vcpu *vcpu)
 {
 	...
 	struct vcpu_vmx *vmx = to_vmx(vcpu);
@@ -1586,7 +1587,7 @@ static void vmx_update_emulated_instruction(struct kvm_vcpu *vcpu)
...
@@ -1747,7 +1748,7 @@ static inline bool vmx_feature_control_msr_valid(struct kvm_vcpu *vcpu,
...
@@ -1767,7 +1768,7 @@ static int vmx_get_msr_feature(struct kvm_msr_entry *msr)
...
@@ -1945,7 +1946,7 @@ static u64 vcpu_supported_debugctl(struct kvm_vcpu *vcpu)
  * Returns 0 on success, non-0 otherwise.
  * Assumes vcpu_load() was already called.
  */
...
+int vmx_set_msr(struct kvm_vcpu *vcpu, struct msr_data *msr_info)
 {
 	struct vcpu_vmx *vmx = to_vmx(vcpu);
 	struct vmx_uret_msr *msr;
@@ -2258,7 +2259,7 @@ static int vmx_set_msr(struct kvm_vcpu *vcpu, struct msr_data *msr_info)
 	return ret;
 }
...
@@ -2301,12 +2302,12 @@ static void vmx_cache_reg(struct kvm_vcpu *vcpu, enum kvm_reg reg)
 	}
 }
...
@@ -2959,7 +2960,7 @@ static inline int vmx_get_current_vpid(struct kvm_vcpu *vcpu)
...
@@ -2975,7 +2976,7 @@ static void vmx_flush_tlb_current(struct kvm_vcpu *vcpu)
...
@@ -2984,7 +2985,7 @@ static void vmx_flush_tlb_gva(struct kvm_vcpu *vcpu, gva_t addr)
...
@@ -3139,8 +3140,7 @@ u64 construct_eptp(struct kvm_vcpu *vcpu, hpa_t root_hpa, int root_level)
 	return eptp;
 }
...
@@ -3168,8 +3168,7 @@ static void vmx_load_mmu_pgd(struct kvm_vcpu *vcpu, hpa_t root_hpa,
...
@@ -3285,7 +3284,7 @@ void vmx_get_segment(struct kvm_vcpu *vcpu, struct kvm_segment *var, int seg)
 	var->g = (ar >> 15) & 1;
 }
...
@@ -3365,14 +3364,14 @@ void __vmx_set_segment(struct kvm_vcpu *vcpu, struct kvm_segment *var, int seg)
...
@@ -3380,25 +3379,25 @@ static void vmx_get_cs_db_l_bits(struct kvm_vcpu *vcpu, int *db, int *l)
 	*l = (ar >> 13) & 1;
 }
...
@@ -3896,7 +3895,7 @@ void pt_update_intercept_for_msr(struct kvm_vcpu *vcpu)
 	}
 }
...
+bool vmx_guest_apic_has_interrupt(struct kvm_vcpu *vcpu)
 {
 	struct vcpu_vmx *vmx = to_vmx(vcpu);
 	void *vapic_page;
@@ -3916,7 +3915,7 @@ static bool vmx_guest_apic_has_interrupt(struct kvm_vcpu *vcpu)
...
+void vmx_msr_filter_changed(struct kvm_vcpu *vcpu)
 {
 	struct vcpu_vmx *vmx = to_vmx(vcpu);
 	u32 i;
@@ -4050,8 +4049,8 @@ static int vmx_deliver_posted_interrupt(struct kvm_vcpu *vcpu, int vector)
 	return 0;
 }
...
@@ -4637,12 +4636,12 @@ static void vmx_vcpu_reset(struct kvm_vcpu *vcpu, bool init_event)
...
@@ -4653,7 +4652,7 @@ static void vmx_enable_nmi_window(struct kvm_vcpu *vcpu)
...
+int vmx_interrupt_allowed(struct kvm_vcpu *vcpu, bool for_injection)
 {
 	if (to_vmx(vcpu)->nested.nested_run_pending)
 		return -EBUSY;
@@ -4796,7 +4795,7 @@ static int vmx_interrupt_allowed(struct kvm_vcpu *vcpu, bool for_injection)
...
@@ -4816,7 +4815,7 @@ static int vmx_set_tss_addr(struct kvm *kvm, unsigned int addr)
...
@@ -5325,7 +5323,7 @@ static void vmx_sync_dirty_debug_regs(struct kvm_vcpu *vcpu)
...
@@ -5596,7 +5594,7 @@ static int handle_invalid_guest_state(struct kvm_vcpu *vcpu)
 	return 1;
 }
...
@@ -5833,9 +5831,8 @@ static int (*kvm_vmx_exit_handlers[])(struct kvm_vcpu *vcpu) = {
...
@@ -6268,7 +6265,7 @@ static int __vmx_handle_exit(struct kvm_vcpu *vcpu, fastpath_t exit_fastpath)
 	return 0;
 }
...
@@ -6356,7 +6353,7 @@ static noinstr void vmx_l1d_flush(struct kvm_vcpu *vcpu)
 		: "eax", "ebx", "ecx", "edx");
 }
...
@@ -6454,7 +6451,7 @@ static void vmx_set_apic_access_page_addr(struct kvm_vcpu *vcpu)
 	put_page(page);
 }
...
@@ -6502,7 +6499,7 @@ static void vmx_hwapic_irr_update(struct kvm_vcpu *vcpu, int max_irr)
 		vmx_set_rvi(max_irr);
 }
...
+void vmx_load_eoi_exitmap(struct kvm_vcpu *vcpu, u64 *eoi_exit_bitmap)
 {
 	if (!kvm_vcpu_apicv_active(vcpu))
 		return;
@@ -6559,7 +6556,7 @@ static void vmx_load_eoi_exitmap(struct kvm_vcpu *vcpu, u64 *eoi_exit_bitmap)
...
@@ -6631,7 +6628,7 @@ static void handle_external_interrupt_irqoff(struct kvm_vcpu *vcpu)
...
@@ -6648,7 +6645,7 @@ static void vmx_handle_exit_irqoff(struct kvm_vcpu *vcpu)
...
@@ -6769,7 +6766,7 @@ static void vmx_complete_interrupts(struct vcpu_vmx *vmx)
...
@@ -6865,7 +6862,7 @@ static noinstr void vmx_vcpu_enter_exit(struct kvm_vcpu *vcpu,
...
@@ -7566,10 +7563,10 @@ static int vmx_check_intercept_io(struct kvm_vcpu *vcpu,
...
@@ -7634,8 +7631,8 @@ static inline int u64_shl_div_u64(u64 a, unsigned int shift,
 	return 0;
 }
...
@@ -7674,13 +7671,13 @@ static int vmx_set_hv_timer(struct kvm_vcpu *vcpu, u64 guest_deadline_tsc,
 	return 0;
 }
...
@@ -7706,7 +7703,7 @@ void vmx_update_cpu_dirty_logging(struct kvm_vcpu *vcpu)
...
+int vmx_smi_allowed(struct kvm_vcpu *vcpu, bool for_injection)
 {
 	...
 	if (to_vmx(vcpu)->nested.nested_run_pending)
@@ -7724,7 +7721,7 @@ static int vmx_smi_allowed(struct kvm_vcpu *vcpu, bool for_injection)
 	return !is_smm(vcpu);
 }
...
@@ -7738,7 +7735,7 @@ static int vmx_enter_smm(struct kvm_vcpu *vcpu, char *smstate)
 	return 0;
 }
...
+int vmx_leave_smm(struct kvm_vcpu *vcpu, const char *smstate)
 {
 	struct vcpu_vmx *vmx = to_vmx(vcpu);
 	int ret;
@@ -7759,17 +7756,17 @@ static int vmx_leave_smm(struct kvm_vcpu *vcpu, const char *smstate)
 	return 0;
 }
...
@@ -7799,151 +7796,13 @@ static bool vmx_check_apicv_inhibit_reasons(enum kvm_apicv_inhibit reason)
