...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A26807834DB
	for <lists+kvm@lfdr.de>; Mon, 21 Aug 2023 23:23:22 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230140AbjHUVXW (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Mon, 21 Aug 2023 17:23:22 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56194 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230143AbjHUVXV (ORCPT <rfc822;kvm@vger.kernel.org>);
        Mon, 21 Aug 2023 17:23:21 -0400
Received: from mail-pg1-x549.google.com (mail-pg1-x549.google.com [IPv6:2607:f8b0:4864:20::549])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C91C4199
        for <kvm@vger.kernel.org>; Mon, 21 Aug 2023 14:23:06 -0700 (PDT)
Received: by mail-pg1-x549.google.com with SMTP id 41be03b00d2f7-56385c43eaeso4030086a12.1
        for <kvm@vger.kernel.org>; Mon, 21 Aug 2023 14:23:06 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20221208; t=1692652986; x=1693257786;
        h=cc:to:from:subject:message-id:references:mime-version:in-reply-to
         :date:from:to:cc:subject:date:message-id:reply-to;
        bh=dXGylBsEheZ+Qc6klZ1bTeyDLMeqfyTwKex2+aUq2hA=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1692652986; x=1693257786;
        h=cc:to:from:subject:message-id:references:mime-version:in-reply-to
         :date:x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=dXGylBsEheZ+Qc6klZ1bTeyDLMeqfyTwKex2+aUq2hA=;
        b=
X-Gm-Message-State: AOJu0Yx6lAe6/xv1CQla7IlIFU7DEZ6Lgtl1X112wvwtZQ9xla0up/xi
        y+Mvjos+tkfMKXixsXfaotALU6MFF4ccFbYemqIIkHAUPovGzIqbkqNWjCcxrVsBESBildugC9Y
        ZBjkP4brt9K13E7wyrBLlGqOe7iQCj5AMy4o7TQHklsYCzQbDiwvtaknpNwW170i7Uw4Md/k=
X-Google-Smtp-Source: AGHT+IFSsD0R28i6Q4f3smK5dwdWxJlHQt1/Nk4RFUJVItCxr6HyvTHPepMUuhsgls0v4dilxyFHJ7Hg74GPDVZIQA==
X-Received: from jgzg.c.googlers.com ([fda3:e722:ac3:cc00:7f:e700:c0a8:1acf])
 (user=jingzhangos job=sendgmr) by 2002:a63:b51d:0:b0:565:dc04:c912 with SMTP
 id y29-20020a63b51d000000b00565dc04c912mr967567pge.5.1692652986070; Mon, 21
 Aug 2023 14:23:06 -0700 (PDT)
Date:   Mon, 21 Aug 2023 14:22:42 -0700
...
Message-ID: <20230821212243.491660-11-jingzhangos@google.com>
Subject: [PATCH v9 10/11] KVM: arm64: selftests: Import automatic system
...
index c692cc86e7da..bae87c50bddc 100644
...
@@ -255,9 +256,18 @@ $(LIBKVM_S_OBJ): $(OUTPUT)/%.o: %.S
...
index 4951ac53d1f8..9695b9d229cb 100644
...
index 637be796086f..f77893e48711 100644
...
index df10f1ffa20d..cfb7ab3d7f5d 100644
--- a/tools/testing/selftests/kvm/aarch64/page_fault_test.c
+++ b/tools/testing/selftests/kvm/aarch64/page_fault_test.c
@@ -97,14 +97,14 @@ static bool guest_check_lse(void)
...
@@ -197,7 +197,7 @@ static bool guest_set_ha(void)
 	uint64_t hadbs, tcr;
