...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id CC45651C736
	for <lists+kvm@lfdr.de>; Thu,  5 May 2022 20:22:34 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234514AbiEESVo (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Thu, 5 May 2022 14:21:44 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:36398 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1383323AbiEESTp (ORCPT <rfc822;kvm@vger.kernel.org>);
...
Subject: [RFC PATCH v6 101/104] KVM: TDX: Add methods to ignore accesses to CPU state
Date:   Thu,  5 May 2022 11:15:35 -0700
Message-Id: <db6c85edbd893c40429a52c9e1d5e1000e392849.1651774251.git.isaku.yamahata@intel.com>
...
+
 ...
 {
@@ -524,29 +901,29 @@ struct kvm_x86_ops vt_x86_ops __initdata = {
...
@@ -560,10 +937,10 @@ struct kvm_x86_ops vt_x86_ops __initdata = {
...
@@ -571,39 +948,39 @@ struct kvm_x86_ops vt_x86_ops __initdata = {
...
@@ -611,7 +988,7 @@ struct kvm_x86_ops vt_x86_ops __initdata = {
...
@@ -619,8 +996,8 @@ struct kvm_x86_ops vt_x86_ops __initdata = {
...
@@ -630,8 +1007,8 @@ struct kvm_x86_ops vt_x86_ops __initdata = {
