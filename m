Return-Path: <kvm+bounces-69663-lists+kvm=lfdr.de@vger.kernel.org>
Delivered-To: lists+kvm@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id u0E6CIEifGnJKgIAu9opvQ
	(envelope-from <kvm+bounces-69663-lists+kvm=lfdr.de@vger.kernel.org>)
	for <lists+kvm@lfdr.de>; Fri, 30 Jan 2026 04:16:17 +0100
X-Original-To: lists+kvm@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 68DBCB6C38
	for <lists+kvm@lfdr.de>; Fri, 30 Jan 2026 04:16:16 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 974A530479D6
	for <lists+kvm@lfdr.de>; Fri, 30 Jan 2026 03:14:19 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3B3EE34DCD1;
...
X-Spamd-Result: default: False [0.94 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-69663-lists,kvm=lfdr.de];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[intel.com:email,intel.com:dkim,BN9PR11MB5276.namprd11.prod.outlook.com:mid,nvidia.com:email,sea.lore.kernel.org:helo,sea.lore.kernel.org:rdns];
