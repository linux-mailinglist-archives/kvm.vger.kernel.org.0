...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 951F17168DE
	for <lists+kvm@lfdr.de>; Tue, 30 May 2023 18:11:22 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233352AbjE3QLU (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Tue, 30 May 2023 12:11:20 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57348 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233318AbjE3QLP (ORCPT <rfc822;kvm@vger.kernel.org>);
        Tue, 30 May 2023 12:11:15 -0400
Received: from foss.arm.com (foss.arm.com [217.140.110.172])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id 9F8C318B
        for <kvm@vger.kernel.org>; Tue, 30 May 2023 09:10:47 -0700 (PDT)
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
        by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 3479B1BC0;
        Tue, 30 May 2023 09:11:06 -0700 (PDT)
Received: from godel.lab.cambridge.arm.com (godel.lab.cambridge.arm.com [10.7.66.42])
        by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id DC09C3F663;
        Tue, 30 May 2023 09:10:19 -0700 (PDT)
From:   Nikos Nikoleris <nikos.nikoleris@arm.com>
To:     kvm@vger.kernel.org, kvmarm@lists.linux.dev, andrew.jones@linux.dev
Cc:     pbonzini@redhat.com, alexandru.elisei@arm.com, ricarkol@google.com,
        shahuang@redhat.com
Subject: [kvm-unit-tests PATCH v6 23/32] arm64: Add a setup sequence for systems that boot through EFI
Date:   Tue, 30 May 2023 17:09:15 +0100
Message-Id: <20230530160924.82158-24-nikos.nikoleris@arm.com>
...
index 1d34c9a0..410f0b1a 100644
--- a/lib/linux/efi.h
+++ b/lib/linux/efi.h
@@ -64,6 +64,7 @@ typedef guid_t efi_guid_t;
 	(c) & 0xff, ((c) >> 8) & 0xff, d } }
