...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D003255EC8D
	for <lists+kvm@lfdr.de>; Tue, 28 Jun 2022 20:24:46 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235393AbiF1SYp (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Tue, 28 Jun 2022 14:24:45 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33618 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231200AbiF1SYl (ORCPT <rfc822;kvm@vger.kernel.org>);
        Tue, 28 Jun 2022 14:24:41 -0400
Received: from dfw.source.kernel.org (dfw.source.kernel.org [IPv6:2604:1380:4641:c500::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D57DE20F77
        for <kvm@vger.kernel.org>; Tue, 28 Jun 2022 11:24:40 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id 796FC619C4
        for <kvm@vger.kernel.org>; Tue, 28 Jun 2022 18:24:40 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPS id D4EA5C341C6
        for <kvm@vger.kernel.org>; Tue, 28 Jun 2022 18:24:39 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1656440679;
        bh=svpnJDBVR2eZMNX1WVUjpSa2pOPRxnBzyYLXkACPhtk=;
        h=From:To:Subject:Date:In-Reply-To:References:From;
        b=
Received: by aws-us-west-2-korg-bugzilla-1.web.codeaurora.org (Postfix, from userid 48)
        id B897AC05FF5; Tue, 28 Jun 2022 18:24:39 +0000 (UTC)
From:   bugzilla-daemon@kernel.org
To:     kvm@vger.kernel.org
Subject: [Bug 216177] kvm-unit-tests vmx has about 60% of failure chance
Date:   Tue, 28 Jun 2022 18:24:39 +0000
...
Message-ID: <bug-216177-28872-vMeh4m4ydc@https.bugzilla.kernel.org/>
...
> >
> > > The failure on bare-metal that I experienced hints that this is eithe=
r a
> > test
> > > bug or (much less likely) a hardware bug. But I do not think it is li=
kely
> > to
> > > be
> > > a KVM bug.
...
Wow! Those are *huge* overruns. What is the value of MSR 0x9B on these host=
s?
