...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 0E5D74E5243
	for <lists+kvm@lfdr.de>; Wed, 23 Mar 2022 13:35:45 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S242632AbiCWMhL (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Wed, 23 Mar 2022 08:37:11 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54158 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S242271AbiCWMhJ (ORCPT <rfc822;kvm@vger.kernel.org>);
        Wed, 23 Mar 2022 08:37:09 -0400
Received: from desiato.infradead.org (desiato.infradead.org [IPv6:2001:8b0:10b:1:d65d:64ff:fe57:4e05])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E12BF70CE8
        for <kvm@vger.kernel.org>; Wed, 23 Mar 2022 05:35:37 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        d=infradead.org; s=desiato.20200630; h=MIME-Version:Content-Type:References:
        In-Reply-To:Date:Cc:To:From:Subject:Message-ID:Sender:Reply-To:
        Content-Transfer-Encoding:Content-ID:Content-Description;
        bh=h/uWF/7QB9SHdiYDQSHamNtvkTfo6FqL4YDkpcsxu8M=; b=ZkwkefxcjAUrbzKk5Rhp3I79pl
        ;
Received: from [2001:8b0:10b:1:4a2a:e3ff:fe14:8625] (helo=u3832b3a9db3152.ant.amazon.com)
        by desiato.infradead.org with esmtpsa (Exim 4.94.2 #2 (Red Hat Linux))
        id 1nX0Cu-003lGt-4D; Wed, 23 Mar 2022 12:35:20 +0000
Message-ID: <9fe6ac14df519ca8df42d3a7fd54ee0c49c58922.camel@infradead.org>
...
(or the time for the host kernel to kexec in the case of live update)=20
can be considered a suspend... but regardless of whether that makes it
mandatory to stop the clocks, I prefer to see it a different way.=20

In normal operation =E2=80=94 especially with CPU overcommit and/or throttl=
ing
=E2=80=94 there are times when none of the guest's vCPUs will be scheduled =
for
...
For live migration, the same applies =E2=80=94 we can just add a delta to t=
he
...
> > globals kept by kernel/time/ntp.c (which are visible to userspace throu=
gh
> > adjtimex(2)). In particular, `time_esterror` and `time_maxerror` should=
 get reset
...
DQEHATAcBgkqhkiG9w0BCQUxDxcNMjIwMzIzMTIzNTE3WjAvBgkqhkiG9w0BCQQxIgQgaPXJ52X/
suaHx0fF1fDcJgJ0i67DPouLi0ZnYpM5RhQwgb0GCSsGAQQBgjcQBDGBrzCBrDCBljELMAkGA1UE
...

