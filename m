...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 1600F2929D4
	for <lists+kvm@lfdr.de>; Mon, 19 Oct 2020 16:56:09 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729644AbgJSO4H (ORCPT <rfc822;lists+kvm@lfdr.de>);
...
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        ...
        bh=lHQLuEgjod4cyXYlZj/yJTiArJ/+9ZerdGqKAnA8VYo=; b=Jnu2WbahNop0HfV1fdMqGviLJ6
...
diff --git a/Documentation/virt/kvm/cpuid.rst b/Documentation/virt/kvm/cpui=
d.rst
index 9150e9d1c39b..f70b655821d5 100644
--- a/Documentation/virt/kvm/cpuid.rst
+++ b/Documentation/virt/kvm/cpuid.rst
@@ -92,6 +92,10 @@ KVM_FEATURE_ASYNC_PF_INT          14          guest chec=
ks this feature bit
                                               async pf acknowledgment msr
                                               0x4b564d07.
=20
+KVM_FEATURE_MSI_EXT_DEST_ID       15          guest checks this feature bi=
t
+                                              before using extended destin=
ation
+                                              ID bits in MSI address bits =
11-5.
+
 KVM_FEATURE_CLOCSOURCE_STABLE_BIT 24          host will warn if no guest-s=
ide
...
MDE5MTQ1NTU2WjAvBgkqhkiG9w0BCQQxIgQg1wjLjWpltKm1sjFYIhlrRpVp+Ou1aESpW7+VZIw5
Recwgb4GCSsGAQQBgjcQBDGBsDCBrTCBlzELMAkGA1UEBhMCR0IxGzAZBgNVBAgTEkdyZWF0ZXIg
...

