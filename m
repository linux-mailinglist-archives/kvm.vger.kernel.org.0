...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A17E63B0091
	for <lists+kvm@lfdr.de>; Tue, 22 Jun 2021 11:44:15 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230109AbhFVJq2 (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Tue, 22 Jun 2021 05:46:28 -0400
Received: from mga18.intel.com ([134.134.136.126]:20236 "EHLO mga18.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S230257AbhFVJqR (ORCPT <rfc822;kvm@vger.kernel.org>);
        Tue, 22 Jun 2021 05:46:17 -0400
IronPort-SDR: PcaV+TIPmjobsEf0WiikHqFkU2PehwODXywaCiFaw2L42bQIbZGA99J0PvLe6/yhUY6+N+xzb5
 WTiRwBhnJa2Q==
X-IronPort-AV: E=McAfee;i="6200,9189,10022"; a="194330983"
X-IronPort-AV: E=Sophos;i="5.83,291,1616482800"; 
   d="scan'208";a="194330983"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
  by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 22 Jun 2021 02:43:54 -0700
IronPort-SDR: SyF/W3/BWsaNngNQ6sPom24JThwSGkkCjCZiHpqi4pIVjtajMN4dXF5rdBqEE3815jnppqVvWQ
 8yOXVC+leBhQ==
X-IronPort-AV: E=Sophos;i="5.83,291,1616482800"; 
   d="scan'208";a="641600210"
Received: from vmm_a4_icx.sh.intel.com (HELO localhost.localdomain) ([10.239.53.245])
  by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 22 Jun 2021 02:43:49 -0700
...
Subject: [PATCH V7 08/18] KVM: x86/pmu: Add IA32_PEBS_ENABLE MSR emulation for extended PEBS
Date:   Tue, 22 Jun 2021 17:42:56 +0800
Message-Id: <20210622094306.8336-9-lingshan.zhu@intel.com>
...
index 9d5c415dfacd..190d8d98abf0 100644
--- a/arch/x86/events/intel/core.c
+++ b/arch/x86/events/intel/core.c
@@ -3894,33 +3894,70 @@ static int intel_pmu_hw_config(struct perf_event *event)
 	return 0;
 }
...
index e63d28fc7cd4..662a0c036ca2 100644
...
index 211ba3375ee9..57ae86ca0d86 100644
