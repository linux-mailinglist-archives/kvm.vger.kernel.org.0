...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id E4F9C2D9441
	for <lists+kvm@lfdr.de>; Mon, 14 Dec 2020 09:42:02 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2439405AbgLNIkj (ORCPT <rfc822;lists+kvm@lfdr.de>);
...
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        ...
        bh=zXcnTM/BxDT1oqD6xZCDg6AyUlQdFYvXAbZCud3KsgY=; b=a/BU/RdzGaIDDk5ABvOcRf36t1
...
Cc:     Paolo Bonzini <pbonzini@redhat.com>,
        ...
        fandree@amazon.com
Subject: [PATCH v3 04/17] KVM: x86/xen: Fix coexistence of Xen and Hyper-V hypercalls
