...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0180E326282
	for <lists+kvm@lfdr.de>; Fri, 26 Feb 2021 13:17:50 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230367AbhBZMQN (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Fri, 26 Feb 2021 07:16:13 -0500
Received: from mga07.intel.com ([134.134.136.100]:15314 "EHLO mga07.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S230267AbhBZMPr (ORCPT <rfc822;kvm@vger.kernel.org>);
        Fri, 26 Feb 2021 07:15:47 -0500
IronPort-SDR: zfU9xl64pW4vyqwr4Ga7ir9weKpJkgaxBiTQkmB0B75IK8u/PksbZPgmSycHDUE+45cBMoUabU
 zTUczJyEcaxg==
X-IronPort-AV: E=McAfee;i="6000,8403,9906"; a="249915871"
X-IronPort-AV: E=Sophos;i="5.81,208,1610438400"; 
   d="scan'208";a="249915871"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
  by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 26 Feb 2021 04:14:58 -0800
IronPort-SDR: AINuQnv9L70o+kRILYL+cI6bSmXAUjUNGk/F6+xPqJYf95jnuyki4w50fLIdUVM9HJnAjuCdDD
 5fO8YxhhEzJg==
X-IronPort-AV: E=Sophos;i="5.81,208,1610438400"; 
   d="scan'208";a="598420394"
Received: from ciparjol-mobl.amr.corp.intel.com (HELO khuang2-desk.gar.corp.intel.com) ([10.255.230.175])
  by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 26 Feb 2021 04:14:54 -0800
...
Subject: [RFC PATCH v6 05/25] x86/sgx: Introduce virtual EPC for use by KVM guests
Date:   Sat, 27 Feb 2021 01:14:31 +1300
Message-Id: <48688382f0417daf030955233a6bdacce7089f2a.1614338774.git.kai.huang@intel.com>
...
v5->v6:
 ...
 - Fixed a typo (encalve -> enclave) in commit msg catched by Dave.
 - Slight changed paragraph 4 to more explicitly call out this paragraph is
   to explain how to use /dev/sgx_vepc from userspace, which was requested
   by Jarkko.
 - Added a new line before return in __sgx_vepc_fault(), per Jarkko.
