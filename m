...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 6615635764E
	for <lists+kvm@lfdr.de>; Wed,  7 Apr 2021 22:50:35 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231486AbhDGUum (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Wed, 7 Apr 2021 16:50:42 -0400
Received: from mga05.intel.com ([192.55.52.43]:47240 "EHLO mga05.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S231380AbhDGUub (ORCPT <rfc822;kvm@vger.kernel.org>);
        Wed, 7 Apr 2021 16:50:31 -0400
IronPort-SDR: KrGEgrwS3JquugjLpi7GuZOISJETMYoC3a5HmNgeVndA5AvIJtmgjAUaDXhzlIjeyMk+bSqd81
 FEnmYTRBydpw==
X-IronPort-AV: E=McAfee;i="6000,8403,9947"; a="278660385"
X-IronPort-AV: E=Sophos;i="5.82,204,1613462400"; 
   d="scan'208";a="278660385"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
  by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 07 Apr 2021 13:50:21 -0700
IronPort-SDR: 4IcC23NQLnt0eB7YN9Pksjfaq/fmFmoPih0H6YofrMy6zZLRk/ROc9uhvCv37qftUfwqduN0MA
 CYfhbMi9ZppA==
X-IronPort-AV: E=Sophos;i="5.82,204,1613462400"; 
   d="scan'208";a="415437450"
Received: from tkokeray-mobl.amr.corp.intel.com (HELO khuang2-desk.gar.corp.intel.com) ([10.254.113.100])
  by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 07 Apr 2021 13:50:18 -0700
...
Subject: [PATCH v4 07/11] KVM: VMX: Add SGX ENCLS[ECREATE] handler to enforce CPUID restrictions
Date:   Thu,  8 Apr 2021 08:49:31 +1200
Message-Id: <963a2416333290e23773260d824a9e038aed5a53.1617825858.git.kai.huang@intel.com>
...
index f68adbe38750..b74537be7fe8 100644
...
@@ -41,6 +313,8 @@ int handle_encls(struct kvm_vcpu *vcpu)
