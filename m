...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 578CE58BDC1
	for <lists+kvm@lfdr.de>; Mon,  8 Aug 2022 00:19:04 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S242260AbiHGWKk (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Sun, 7 Aug 2022 18:10:40 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:37044 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S241926AbiHGWJh (ORCPT <rfc822;kvm@vger.kernel.org>);
        Sun, 7 Aug 2022 18:09:37 -0400
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 47152BF7D;
        Sun,  7 Aug 2022 15:03:35 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1659909815; x=1691445815;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=g+JbOOv+meRsAdgytl4Udr4ct85nY3mvsca3leQ1vIw=;
  b=T18xFV+fxEIeovg25+XYPQhiGua5LkPtq/hQ6wLnd7nXU/uZtIo0u7p9
   bYrYTBSFaTHn8oHVeajL73jbGwX4Azr0cRvRTBNqLAayS3ASgfYE1RQhB
   9ECj9tBLn63iWgi1sHQa9CklpQRcQOQKztQ7xvK+Hv7rF04d/WrHYXlMZ
   pElYMm2FXehuqjFszyDi3lpKyoqhAHbSN0P62R/g4Zd37PHTQklRtzwi3
   lg2q1D5wXnvk4lPLiRilrzz8284IY/+UjFQtwph5akRm5Dx0JfH1TES55
   pdWIAo99oFE0ZLG6hzwQgt0ZN19FjuzKDzQObNWSPr90bX2p9bB/xe4kJ
   w==;
X-IronPort-AV: E=McAfee;i="6400,9594,10432"; a="270240423"
X-IronPort-AV: E=Sophos;i="5.93,220,1654585200"; 
   d="scan'208";a="270240423"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
  by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 07 Aug 2022 15:02:45 -0700
X-IronPort-AV: E=Sophos;i="5.93,220,1654585200"; 
   d="scan'208";a="663682777"
...
Subject: [PATCH v8 101/103] KVM: TDX: Add methods to ignore accesses to CPU state
Date:   Sun,  7 Aug 2022 15:02:26 -0700
Message-Id: <d6ab02a36306f48e5fb94722e0ee854d3aa20cc2.1659854791.git.isaku.yamahata@intel.com>
...
index e74b7af1d102..98f5347afcdf 100644
...
+
 ...
 {
 	if (is_td_vcpu(vcpu))
@@ -447,6 +683,15 @@ static u32 vt_get_interrupt_shadow(struct kvm_vcpu *vcpu)
...
+
 ...
 {
 	if (is_td_vcpu(vcpu))
@@ -455,6 +700,14 @@ static void vt_inject_irq(struct kvm_vcpu *vcpu, bool reinjected)
...
+
 ...
 {
 	if (is_td_vcpu(vcpu))
@@ -487,6 +740,130 @@ static void vt_request_immediate_exit(struct kvm_vcpu *vcpu)
...
+
 ...
 {
@@ -539,29 +916,29 @@ struct kvm_x86_ops vt_x86_ops __initdata = {
...
@@ -577,10 +954,10 @@ struct kvm_x86_ops vt_x86_ops __initdata = {
...
@@ -588,39 +965,39 @@ struct kvm_x86_ops vt_x86_ops __initdata = {
...
@@ -628,7 +1005,7 @@ struct kvm_x86_ops vt_x86_ops __initdata = {
...
@@ -636,8 +1013,8 @@ struct kvm_x86_ops vt_x86_ops __initdata = {
...
@@ -647,8 +1024,8 @@ struct kvm_x86_ops vt_x86_ops __initdata = {
...
index 2f021f8468f4..5177f33cafbc 100644
...
@@ -596,8 +597,15 @@ int tdx_vcpu_create(struct kvm_vcpu *vcpu)
...
+	vcpu->arch.guest_state_protected = true;
 	...
 	tdx->pi_desc.sn = 1;
@@ -1827,6 +1835,49 @@ void tdx_enable_smi_window(struct kvm_vcpu *vcpu)
...
index 2cb28392ed2f..f86977658476 100644
--- a/arch/x86/kvm/vmx/x86_ops.h
+++ b/arch/x86/kvm/vmx/x86_ops.h
@@ -166,6 +166,14 @@ int tdx_smi_allowed(struct kvm_vcpu *vcpu, bool for_injection);
...
@@ -207,10 +215,19 @@ static inline void tdx_get_exit_info(
