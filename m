...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id F3D0121452F
	for <lists+kvm@lfdr.de>; Sat,  4 Jul 2020 13:30:30 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727889AbgGDLaT (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Sat, 4 Jul 2020 07:30:19 -0400
Received: from mga04.intel.com ([192.55.52.120]:61330 "EHLO mga04.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726738AbgGDLaQ (ORCPT <rfc822;kvm@vger.kernel.org>);
        Sat, 4 Jul 2020 07:30:16 -0400
IronPort-SDR: vAqOMQ97csBBczQgNKjX9bbHS5eHGvwT7Wow2ETaund8JRy61AVzFvOFnuIAY3s/owFX8qnSA4
 VLV3Op6rbu1A==
X-IronPort-AV: E=McAfee;i="6000,8403,9671"; a="144760854"
X-IronPort-AV: E=Sophos;i="5.75,311,1589266800"; 
   d="scan'208";a="144760854"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
  by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 04 Jul 2020 04:30:14 -0700
IronPort-SDR: 5dM0IxqjjOJHxVrpQlq9/C0w6+XURgJLDQMJovEJI4EhLh67MKg1YY5pU2kDoQD62KVfUH6FNz
 LD1DEwmlAaJA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.75,311,1589266800"; 
   d="scan'208";a="266146762"
...
Subject: [RFC v7 02/25] header file update VFIO/IOMMU vSVA APIs kernel 5.8-rc3
Date:   Sat,  4 Jul 2020 04:36:26 -0700
Message-Id: <1593862609-36135-3-git-send-email-yi.l.liu@intel.com>
...
+
 ...
 /**
@@ -1153,6 +1169,75 @@ struct vfio_iommu_type1_dirty_bitmap_get {
