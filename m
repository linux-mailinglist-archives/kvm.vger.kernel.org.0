...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id F296F6E4A73
	for <lists+kvm@lfdr.de>; Mon, 17 Apr 2023 15:59:19 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230350AbjDQN7S (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Mon, 17 Apr 2023 09:59:18 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49118 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230123AbjDQN7C (ORCPT <rfc822;kvm@vger.kernel.org>);
        Mon, 17 Apr 2023 09:59:02 -0400
Received: from imap5.colo.codethink.co.uk (imap5.colo.codethink.co.uk [78.40.148.171])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id DF8676587
...
Received: from [167.98.27.226] (helo=lawrence-thinkpad.guest.codethink.co.uk)
        ...
        id 1poPNP-0034ER-1f; Mon, 17 Apr 2023 14:58:39 +0100
...
Subject: [PATCH v2 09/17] target/riscv: Add Zvbb ISA extension support
Date:   Mon, 17 Apr 2023 14:58:13 +0100
Message-Id: <20230417135821.609964-10-lawrence.hunter@codethink.co.uk>
...
index f08d43ec5bc..1622b9a88f8 100644
...
index 0dcf4d21305..d54c21c5f7e 100644
--- a/target/riscv/insn_trans/trans_rvvk.c.inc
+++ b/target/riscv/insn_trans/trans_rvvk.c.inc
@@ -86,3 +86,191 @@ static bool vclmul_vx_check(DisasContext *s, arg_rmrr *a)
...
+GEN_OPIVX_GVEC_TRANS_CHECK(vandn_vx, andsc, zvbb_vx_check)
+
