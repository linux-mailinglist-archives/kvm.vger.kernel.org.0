...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 63EB7478FA8
	for <lists+kvm@lfdr.de>; Fri, 17 Dec 2021 16:30:06 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S238202AbhLQPaF (ORCPT <rfc822;lists+kvm@lfdr.de>);
        Fri, 17 Dec 2021 10:30:05 -0500
Received: from mga03.intel.com ([134.134.136.65]:10842 "EHLO mga03.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S238196AbhLQPaE (ORCPT <rfc822;kvm@vger.kernel.org>);
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  bh=eOjDT1d53ECluHIyuHq9Pg4thb5nT1Vxb+5HpXMsiCI=;
  b=I055sbMyPQVJBU23OKGSlrmj7rOUM1Gj3U0BZOe01L/WEIswnhG6wSR+
   jAKIaY8+4W0r3Wjkdoci9s7GlFS2qMb6F/YGWpK1Mt2iz5i00rRNEImKq
   yTIKora17Ie8KICyY9Hv11OBWlUGSxh29vnMy5vzSJFCGQLa0Rg9IcZt6
   V0bqcm9FnMx6/0bH7lYTsxs4u+QYAux7vRftxOLwvyYVtow1A2lfl3LSI
   XtUC+03nsm3ANdoEzl9smJ99C4gbOexfrmH+wvg2UyN3avuXolL4tIEOn
   aE0OuIzEfvnLK+zqnqWyqSZhk1JYmuPHY02m4TA1MbA7FA/DYOwI0I/Yc
   w==;
X-IronPort-AV: E=McAfee;i="6200,9189,10200"; a="239723426"
X-IronPort-AV: E=Sophos;i="5.88,213,1635231600"; 
   d="scan'208";a="239723426"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
  by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 17 Dec 2021 07:30:03 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.88,213,1635231600"; 
   d="scan'208";a="615588388"
...
Subject: [PATCH v2 01/23] x86/fpu: Extend fpu_xstate_prctl() with guest permissions
Date:   Fri, 17 Dec 2021 07:29:41 -0800
Message-Id: <20211217153003.1719189-2-jing2.liu@intel.com>
...
---
(To Thomas) xstate_get_guest_group_perm() is again moved from
xstate.h to api.h. Per Paolo's suggestion we also need to check
permission at KVM_GET_SUPPORTED_CPUID, which is a /dev/kvm generic
ioctl.
 ...
 arch/x86/kernel/fpu/xstate.c      | 51 +++++++++++++++++++++++--------
...
index d28829403ed0..84386603482f 100644
